...
contract Dao888Vault is Context, Ownable {
    ...
    event Changed888BNBPair(
        address indexed owner,
        address indexed dao888BNBPair
    );
    ...
    function change888BNBPair(address dao888BNBPair) external onlyOwner {
        _dao888BNBV2Pair = IPancakeSwapV2Pair(dao888BNBPair);

        emit Changed888BNBPair(_msgSender(), dao888BNBPair);
    }
