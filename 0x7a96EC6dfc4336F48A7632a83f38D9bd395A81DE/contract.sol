...
contract ANT is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x23948c64D2C6F98C4e5Ab4711a410E284B15Cf72); // Marketing Address
    ...
    string private _name = "ANT V2";
    string private _symbol = "ANT V2";
