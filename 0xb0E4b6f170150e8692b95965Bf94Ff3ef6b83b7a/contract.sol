...
contract shiba_MINER {
    ...
    function sellShiba() public {
        ...
        uint256 eggValue=calculateEggSell(hasShiba);
    ...
    function buyShiba(address ref, uint256 amount) public {
        ...
        uint256 shibaBought=calculateEggBuy(amount,SafeMath.sub(balance,amount));
    ...
    function calculateEggSell(uint256 shiba) public view returns(uint256) {
