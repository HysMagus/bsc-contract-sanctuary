...
contract OFF is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'OFF';
    string  private constant _SYMBOL = 'OFF';
    ...
    uint256 private _tTotal = 20000 * _DECIMALFACTOR;
