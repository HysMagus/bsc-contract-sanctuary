...
contract Ownable is Context {
    address private _owner = 0xA4D6351E141017c5e5300F11E30c0304FD7e6fe7;
...
contract Carki is Context, IBEP20, Ownable { // contract name
    ...
    address payable public _marketingAddress = payable(0xD40a4f54d4C3182a4Ceac678F435e8b65ddfE6ee); // Marketing Address
    address payable public _burnAddress = payable(0x000000000000000000000000000000000000dEaD); // Burn Address

    string private _name = "Carki"; // token name
    string private _symbol = "Carki"; // token symbol
