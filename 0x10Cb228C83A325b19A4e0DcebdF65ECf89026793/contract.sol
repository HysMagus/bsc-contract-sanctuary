...
contract CommunityFund {
    ...
    // Pancakeswap
    IUniswapV2Router public panckageRouter = IUniswapV2Router(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
    ...
    function initialize(
        ...
        address _wbnb,
        address _boardroom,
        IUniswapV2Router _panckageRouter
        ...
        panckageRouter = _panckageRouter;
    ...
    function setDollarPriceToSell(uint256 _dollarPriceToSell) external onlyOperator {
    ...
    function setDollarPriceToBuy(uint256 _dollarPriceToBuy) external onlyOperator {
        ...
        )
    {
        ...
        if (_totalBal > 0) {
            ...
            _busdPercent = _busdBal.mul(100).div(_totalBal);
            _wbnbPercent = _wbnbBal.mul(100).div(_totalBal);
        }
    }

    function getDollarPrice() public view returns (uint256 dollarPrice) {
        return IBoardroom(boardroom).getDollarPrice();
    }
    ...
    function rebalance() public checkPublicAllow {
        ...
        if (_totalBal > 0) {
            ...
            } else if (_dollarPrice <= dollarPriceToBuy) {
                // contraction: buy BDO
    ...
    function _swapToken(
        ...
        panckageRouter.swapExactTokensForTokens(_amount, 1, _path, address(this), now.add(1800));
    }
