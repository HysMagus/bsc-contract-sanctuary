...
// KeySwap with Governance.
contract KeySwap is ERC20("KeySwap Finance", "KeyS"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "KeyS::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "KeyS::delegateBySig: invalid nonce");
        require(now <= expiry, "KeyS::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "KeyS::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "KeyS::_writeCheckpoint: block number exceeds 32 bits");
    ...
    // In some circumstance, we should not burn KeyS on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
