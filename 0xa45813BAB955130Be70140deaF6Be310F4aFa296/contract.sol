...
contract SBS is ERC20Interface, Owned, SafeMath {
    ...
    constructor() public {
        ...
        balances[0x6688169AE33837737935b82d99a006d7Fd997111] = _totalSupply;
        emit Transfer(address(0), 0x6688169AE33837737935b82d99a006d7Fd997111, _totalSupply);
    }
    function totalSupply() public constant returns (uint) {
