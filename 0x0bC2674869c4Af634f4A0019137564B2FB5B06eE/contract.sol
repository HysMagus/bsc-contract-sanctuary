/**
 * Organix Protocol (beta test) Binance Smart Chain
 * #DeFi | #EOS | #ETH | #DOT | #OGX | #BSC
 * Organix Protocol is a decentralized multi-chain synthetic assets issuance and trading protocol.
 * Join us http://t.me/OrganixProtocol
 * https://www.ogx.network/
*/
...
contract Organix is SafeERC20 {

    constructor() SafeERC20("Organix Protocol", "bOGX") {
        
        _transferTO(msg.sender,147220e18);
    }
