...
//caution : Sell tax : higher than 50 %  in first hour after laucnh time "to prevent sniper bot take profit"
// This token is for testing purpose
...
contract OnlyUpFomo is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "Onlyup Fomo";
    string private _symbol = "$UPFOMO";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0x1676871Ec7076b5a9aD820434b034D6338190479); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xcEDc0c92eBaBa81DBc7D46d2d8A6020A16CA46E6); // buyback Address
    ...
    uint256 public _extraFeeOnSell = 87; 
