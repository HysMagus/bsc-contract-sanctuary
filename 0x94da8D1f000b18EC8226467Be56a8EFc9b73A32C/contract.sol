...
contract WDeflaCash is StandardToken {
    string public constant name = "WDeflaCash";
    string public constant symbol = "wDFC";
    uint256 public constant decimals = 18;
    uint256 public constant INITIAL_SUPPLY = 36500000 * (10**decimals);
