...
// File: contracts/JETFUEL/interfaces/thugs/IThugswapRouter.sol
...
// File: contracts/JETFUEL/interfaces/thugs/IThugswapPair.sol
...
// File: contracts/JETFUEL/interfaces/thugs/IOriginalGangster.sol
...
interface IOriginalGangster {
    ...
    function pendingDrugs(uint256 _pid, address _user)
        external
        view
        returns (uint256);
...
// File: contracts/JETFUEL/strategies/Thugs/StrategyThugsLP.sol
...
contract StrategyThugsLP is Ownable, Pausable {
     ...
     * {fuel} - JetFuel Finance token, used to send funds to the reward.
    ...
    address public constant gangster =
        address(0xb752f0cB591Ecfb1c5058a93e1332F066bf38473);
    uint8 public poolId;
     ...
     *
     * {REWARDS_FEE} - 4% goes to JETS/FUEL holders through the {rewards} pool.
    ...
    constructor(
        ...
        IERC20(drugs).safeApprove(unirouter, uint256(-1));
     ...
     * 0.5% -> Call Fee
     * 1.5% -> Treasury fee
     * 4.0% -> JETS/FUEL Holders
     */
    function chargeFees() internal {
        uint256 toWbnb = IERC20(drugs).balanceOf(address(this)).mul(6).div(100);
        IThugswapRouter(unirouter).swapExactTokensForTokens(
            toWbnb,
            0,
            drugsToWbnbRoute,
            address(this),
    ...
    function addLiquidity() internal {
        ...
        IThugswapRouter(unirouter).addLiquidity(
            lpToken0,
            lpToken1,
            lp0Bal,
            lp1Bal,
    ...
    function balanceOfPool() public view returns (uint256) {
        (uint256 _amount, ) =
            IOriginalGangster(gangster).userInfo(poolId, address(this));
        return _amount;
    }
