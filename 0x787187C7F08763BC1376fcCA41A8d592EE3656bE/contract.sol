...
contract KISHOOTER is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Kishooter";
    string private _symbol = "KSHOOTER";
    ...
    uint256 public _taxFee = 200; // 50 = 0.5%
    uint256 public _buybackv1Fee = 200; // 100 = 1.00%
    ...
    address public buybackv1Address  = 0xB5BAe775608a8919997f27BdaEA26Cb10165655b;      // BuyBackv1 Address
    address public buybackv2Address  = 0xB5BAe775608a8919997f27BdaEA26Cb10165655b;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0xB5BAe775608a8919997f27BdaEA26Cb10165655b;      // SMarketing Address
