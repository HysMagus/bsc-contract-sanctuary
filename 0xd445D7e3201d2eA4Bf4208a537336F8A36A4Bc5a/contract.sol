...
contract Bitrub is Context, IERC20, Ownable {
    ...
    string private constant _name = 'Bitrub';
    string private constant _symbol = 'BRUB';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x5b23ff52E0A7f778Dd450261fd2D1A58fAa43027, 'We can not exclude router.');
