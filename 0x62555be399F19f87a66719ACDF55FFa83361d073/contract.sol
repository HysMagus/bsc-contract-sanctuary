...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    uint256 public constant pid = 11; // pid of pool in farmContractAddress
    address public constant wantAddress = 0x1B96B92314C44b159149f7E0303511fB2Fc4774f;//WBNB-BUSD LP
