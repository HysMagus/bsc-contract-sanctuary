...
/*
   ...
   Welcome to Frunk'D Up Floki
   
   This is a community token. If you want to create a telegram I suggest to name it to @FrunkDupFlokii
   ...
   Can you make #Frunk'D Up Floki 10000X? 
...
contract FrunkDUpFloki is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x0163f4A276A342cb8fF17083d79138C4F10F11CF); // Marketing Address
    ...
    string private _name = "FrunkD'UpFloki";
    string private _symbol = "FrunkDUPFloki";
