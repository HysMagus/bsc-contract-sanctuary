...
contract ZOC_FINANCE is ERC20 {
    ...
    constructor() public {
        uint256 companyFund = 99819e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 100 BNB or more and get 2% more ZOC of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 100 BNB or more and get 1% more ZOC of round 2
