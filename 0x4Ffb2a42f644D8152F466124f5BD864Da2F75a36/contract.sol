...
// File: contracts/interfaces/ISOTEMaster.sol
...
contract MasterAware is IMasterAware {
  ...
  function changeMasterAddress(address masterAddress) public onlyMaster {
    master = ISOTEMaster(masterAddress);
  }
}
...
// File: contracts/abstract/SOTEToken.sol
...
contract PooledStaking is MasterAware {
  ...
  uint public MIN_STAKE=2e19;         // Minimum allowed stake per contract
  uint public MAX_EXPOSURE=10;      // Stakes sum must be less than the deposit amount times this
  uint public MIN_UNSTAKE=2e19;       // Forbid unstake of small amounts to prevent spam
  uint public UNSTAKE_LOCK_TIME=7776000; // Lock period in seconds before unstaking takes place
  ...
  function changeDependentContractAddress() public {
    ...
    token = SOTEToken(master.tokenAddress());
  ...
  bytes32 private constant MIGRATION_LAST_ID_POSITION = keccak256("soteria.pooledstaking.MIGRATION_LAST_ID_POINTER");
