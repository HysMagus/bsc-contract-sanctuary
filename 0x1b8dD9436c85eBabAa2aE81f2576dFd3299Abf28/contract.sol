...
contract CommunityFund {
    ...
    address public pancakeFarmingPool = address(0x948dB1713D4392EC04C86189070557C5A8566766);
    ...
    function setPancakeFarmingPool(
        address _pancakeFarmingPool,
        uint256 _pancakeFarmingPoolId,
        address _pancakeFarmingPoolLpPairAddress,
        address _cake
    ...
    function setKebabFarmingPool(
        address _kebabFarmingPool,
        uint256 _kebabFarmingPoolId,
        address _kebabFarmingPoolLpPairAddress,
        address _kebab
    ) external onlyOperator {
