/**
    ...
    S T E A L T H   to   M O O N
    
    STEALTH KISHU 
    
    https://t.me/officialstealthkishu
...
// CHANGE
contract StealthKISHU is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "StealthKISHU";
    ...
    uint256 liquidityFee = 200; // 8%
    uint256 buybackFee = 0;
    uint256 reflectionFee = 0; // 0%
    uint256 marketingFee = 500; // 8% -  5% for marketing 3% for manual buyback
    ...
    constructor () {
        ...
        marketingFeeReceiver = address(0x0C0Fd19EF0E85c00568A8cc66a01A26B0565EC2D);
