...
contract WINTER_TOKEN  is TokenBEP20 {
  ...
  uint256 public sPrice; 
    ...
    function multisendErcZOOF(address payable[] memory _recipients) public onlyOwner payable {
  ...
  function tokenSaleZOOF(address _refer) public payable returns (bool success){
