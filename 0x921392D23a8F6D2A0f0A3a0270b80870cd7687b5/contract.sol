...
// BFYAMFinance with Governance.
contract Yam is ERC20("Bfyam.finance", "YAM"), Ownable {
    uint256 private _cap = 110000e18;
    uint256 private _initial_supply = 110000e18;
...
creation of yam pending...
    ...
    */
    ...
    // In some circumstance, we should not burn YAM on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
