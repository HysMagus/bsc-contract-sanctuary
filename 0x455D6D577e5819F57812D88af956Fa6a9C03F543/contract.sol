//Javaswap MasterChef for pool Java Token.
...
contract JavaToken is BEP20('Java Token', '$JAVA') {
...
// MasterChef is the master of Javaswap. for pool java token.
//
...
contract MasterChefJava is Ownable {
    using SafeMath for uint256;
