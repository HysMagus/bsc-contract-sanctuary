...
contract Swap {
    ...
    function swapBNBToBUSD(uint256 amountOut) public payable returns(uint[] memory returnData){
        ...
        returnData= pancakeRouter.swapETHForExactTokens{value:msg.value}(amountOut,path,msg.sender,block.timestamp+60);
    }
