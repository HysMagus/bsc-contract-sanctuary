...
// change "name1" into ur name
    contract AppleStar is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

//change "name1" and "symbol"
    string private _name = "AppleStar";
    string private _symbol = "ASTAR";
    ...
    uint256 internal _tokenTotal = 690_000_000e8;
    ...
    constructor() public {
        ...
        marketingWallet = 0x63AfFDFFbd496f07a9Da830427cC7448a65E24C4;
        //paste the wallet ^^^^^^^^^^^^^^^^^^^^^ adress, that earns the marketingFee here
