...
contract SCBNFT is ERC1155Tradable {
    constructor(address _proxyRegistryAddress) public ERC1155Tradable("SpaceCowBoy NFT", "SCBNFT", _proxyRegistryAddress) {
        _setBaseMetadataURI("http://api.oxbull.tech/");
    }
