...
contract Master is Ownable {
    ...
    IGalaxy public galaxy;

    // Market oracle provides the GALAXY/USD exchange rate as an 18 decimal fixed point number.
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = galaxy.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && galaxy.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(galaxy.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return galaxy.totalSupply().toInt256Safe()
