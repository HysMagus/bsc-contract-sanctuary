...
/*
    ...
    GMRFloki is powerful and evolved Floki who has learnt through all the recent events. 
    Making a comeback now more resilient than ever before.

    GMRFloki’s aim is to create a complete metaverse of RPG gaming which allows millions of peoples to join the NFT & Blockchain-Based gaming world in an easy, 
...
contract GMRFloki is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "GMRFloki";
