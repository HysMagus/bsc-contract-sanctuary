...
/// @title Lockable with exceptions
/// @dev Standard burnable ERC20 token modified with pausable transfers.
abstract contract Lockable is Ownable, ERC20Burnable {
    ...
    function setTradeException(address sender, bool tradeAllowed) external onlyOwner {
        require(sender != address(0), "XCL: Invalid address");
    ...
    modifier whenNotLocked() {
        require(canTrade(msg.sender), "XCL: Currently locked");
        _;
    }
