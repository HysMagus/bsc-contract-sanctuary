/**
   written by luckylotterytoken.xyz team
   No embezzlement
*/
...
contract LuckyLotteryToken is Context, IERC20, Ownable {
    ...
    string private _name = 'LuckyLotteryToken';
    string private _symbol = 'LLT';
    uint8 private _decimals = 9;
    uint256  _maxTxAmount = 10000000 * 10**9;
    uint256 lotteryNum;
    ...
    constructor(address devAddr,address marketAddr) public payable{
