...
contract UnityToken is BEP20('Unity Token', 'UNI') {
    ...
    /**
     * @notice Constructs the Unity Token BEP-20 contract.
     */
    constructor(address _treasury) public {
        // Mints 2500 Unity Token to treasury, 2000 for airdrop and 500 for meme contest
        treasury = _treasury;
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying UNI (not scaled);
