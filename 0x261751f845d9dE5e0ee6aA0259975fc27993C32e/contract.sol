...
library Constants {
    ...
    /* Oracle */
    address private constant DAI = address(
        0x6B175474E89094C44Da98b954EedeAC495271d0F
    ); // Anywhere the term DAI is refernenced, consider that as "peg", really
...
contract Getters is State {
    ...
    function name() public view returns (string memory) {
        return "Binance Agile Set Dai Stake";
    }
...
/*
    Copyright 2020 BASD Devs, in the shadow of the Empty Set Squad <basd@programmer.net>
