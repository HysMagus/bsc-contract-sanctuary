...
BitcoinForever - Rebase + Reward Tokenomic
...
Every 1 hour BitcoinForever will do a price rebase that will increase the price 10%.

Telegram: t.me/BitcoinForeverOfficial
Website: BitcoinForever.xyz
...
contract BitcoinForeverDividendTracker is IDividendDistributor {
...
contract BitcoinForever is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "BitcoinForever";
    string _symbol = "BitcoinForever";
    ...
    BitcoinForeverDividendTracker dividendTracker;
    ...
    constructor() {
        ...
        dividendTracker = new BitcoinForeverDividendTracker();
