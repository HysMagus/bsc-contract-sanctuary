...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x8FbA8C1F92210f24fb277b588541ac1952e1aAC8);
...
contract MiniGravitX is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x8FbA8C1F92210f24fb277b588541ac1952e1aAC8;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

        string constant _name = "MiniGravitX";
    string constant _symbol = "MGRVX";
