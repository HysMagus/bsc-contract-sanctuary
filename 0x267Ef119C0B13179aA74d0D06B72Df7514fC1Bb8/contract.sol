...
contract AutoFarm is Ownable {
    ...
    address AUTO = address(0x4508ABB72232271e452258530D4Ed799C685eccb); // 1:1 migration to AUTOv2
    address AUTOv2 = address(0x09750927D289131D40D6E5ff34D431432BFDaFF0);
    ...
    function migrateToAUTOv2(uint256 _inputAmt) public {
        require(IERC20(AUTOv2).totalSupply() < AUTOMaxSupply, "sry. too late.");
