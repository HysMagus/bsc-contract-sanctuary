...
//
//
// Every 12 hours, the supply will expand or contract to 
// reach the target price of $3.00. You can earn additional 
// SLINK rewards by staking through the Ser-Geyser.
...
contract Slink is Context, IERC20, Ownable {
    ...
    string private _name = 'LITTLELINK.FINANCE';
    ...
    function Rebase() public returns(uint256) {
        ...
        _transfer(address(this), _msgSender(), _rebase_caller_fee);
    ...
    function updateRebaseCallerFee(uint256 rebase_caller_fee) public onlyOwner {
        _rebase_caller_fee = rebase_caller_fee;
    }
