...
contract BLTEST is ERC20, Ownable {
    /*
    ...
    */
    function _transfer(
        ...
        if(from != owner() && to != owner()) {
            ...
            if((from == uniswapV2Pair || to == uniswapV2Pair) && !tradingEnable)
    ...
    */
    ...
    function updateMaxTokensPerTx(uint256 _maxTokensPerTx)
        ...
        onlyOwner
    {
        require(_maxTokensPerTx > uint256(100).mul(10**18), 'maxTokensPerTx should be greater than 100 * 10^18');
