...
contract DTEST is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'DTEST';
    string  private constant _SYMBOL = 'DTEST';
    ...
    uint256 private _MAX_TX_SIZE = 60000000 * _DECIMALFACTOR;
