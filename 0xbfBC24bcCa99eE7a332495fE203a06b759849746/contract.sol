...
// File: contracts/JETFUEL/interfaces/venus/IVToken.sol
...
// File: contracts/BIFI/strategies/Venus/StrategyVenusv2.sol
 ...
 */
contract StrategyVenusv2 is Ownable, Pausable {
    ...
    constructor(
        ...
        IERC20(want).safeApprove(vtoken, uint256(-1));
    ...
    function _deleverage() internal {
        ...
        while (wantBal < borrowBal) {
            ...
            uint256 balanceOfUnderlying =
                IVToken(vtoken).balanceOfUnderlying(address(this));

            IVToken(vtoken).redeemUnderlying(
