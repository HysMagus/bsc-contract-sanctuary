...
──▄▄█▄▄──
    ...
    BR44P is a soft fork of BR34P that incorporates adjustable
    yield rates (so early buyers can continue to earn reasonable yields as
    more holders enter the ecosystem). BR44P also has a deflationary supply
    and fair-launch mechanisms to ensure a healthy distribution of tokens.
    BR34P Was listed on Coingecko -> https://www.coingecko.com/en/coins/br34p
    BR44P Will List too!


    Telegram: https://t.me/BR34P
    Website:  https://br34p.finance
    Farm:     https://farm.br34p.finance
    ──────▄▀─
─█▀▀▀█▀█─
──▀▄░▄▀──
────█────
...
contract BR44P is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 2 * 10**6 * 10**7;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'BR44P';
    string private _symbol = 'BR44P';
