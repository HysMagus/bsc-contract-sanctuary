...
// MineCraftSwap with Governance.
contract MinecraftToken is BEP20('MineCraftSwap', 'MINE') {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying MINEs (not scaled);
