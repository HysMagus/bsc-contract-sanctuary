...
// File: contracts/JETFUEL/interfaces/venus/IUnitroller.sol
...
// File: contracts/JETFUEL/interfaces/venus/IVBNB.sol
...
// File: contracts/BIFI/strategies/Venus/StrategyVenusBNBV2.sol
 ...
 */
contract StrategyVenusBNBV2 is Ownable, Pausable {
    ...
    address public constant venus =
        address(0xcF6BB5389c92Bdda8a3747Ddb454cB7a64626C63);
    address public constant vbnb =
     ...
     * {treasury} - Address of the JetfuelFinance treasury
    ...
    constructor(
        ...
        IERC20(venus).safeApprove(unirouter, uint256(-1));
    ...
    function _deleverage() internal {
        ...
        while (bnbBal < borrowBal) {
            ...
            uint256 balanceOfUnderlying =
                IVBNB(vbnb).balanceOfUnderlying(address(this));

            IVBNB(vbnb).redeemUnderlying(
