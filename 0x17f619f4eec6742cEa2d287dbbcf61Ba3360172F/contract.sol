...
// FYI for contract verification - constructor arguments =
// {
// 	"address _AUTO": "0x864A0B7F8466247A0e44558D29cDC37D4623F213",
// 	"address _devAddress": "0xF482404f0Ee4bbC780199b2995A43882a8595adA",
// 	"uint256 _startBlock": {
// 		"type": "BigNumber",
// 		"hex": "0x00"
// 	}
...
// Ownership will be transferred to a governance smart contract once AUTO is sufficiently
...
contract AutoFarm {
    ...
    AUTOToken public AUTO = AUTOToken(
        0xD2653285774F448fD4A2E0A3F165C453ff848cEb  // testAUTO
    ); // The AUTO TOKEN!
    uint256 public AUTOMaxSupply = 80000e18;
    uint256 public AUTOPerBlock = 8000000000000000; // AUTO tokens created per block ~10,000,000 blocks (347 days) to reach max suply
    uint256 public startBlock = 3115638; // 15 Dec 09:00 UTC  https://bscscan.com/block/countdown/3115638
    ...
    address
        public governanceAddress = 0xF482404f0Ee4bbC780199b2995A43882a8595adA;
    address public devAddress = 0xF482404f0Ee4bbC780199b2995A43882a8595adA;
    uint256 public devFee = 0;
    uint256 public devFeeMax = 10000;
    address
        public controllerAddress = 0xF482404f0Ee4bbC780199b2995A43882a8595adA; // earn() function caller
    uint256 public controllerFee = 0;
    uint256 public controllerFeeMax = 10000;
    uint256 public buyBackBurnRate = 0;
    uint256 public buyBackBurnRateMax = 10000;
    address
        public poolAdderAddress = 0xF482404f0Ee4bbC780199b2995A43882a8595adA;
    // uint256 public treasuryFee = 0;
    // uint256 public treasuryFeeMax = 10000;
    // uint256 public strategistFee = 0;
    // uint256 public strategistFeeMax = 10000;
    // uint256 public strategistFeeBlocks = 28800;      // Number of blocks strategist gets fee from the block strategy is added.
    ...
    function add(
        ...
        require(msg.sender == poolAdderAddress, "Not authorised");
        if (_withUpdate) {
            massUpdatePools();
        }
    ...
    function set(
        ...
        require(
            msg.sender == devAddress || msg.sender == governanceAddress,
            "Not authorised"
        );
    ...
    function getMultiplier(uint256 _from, uint256 _to)
        ...
        returns (uint256)
    {
        if (AUTO.totalSupply() >= AUTOMaxSupply) {
            return 0;
        }
    ...
    function updatePool(uint256 _pid) public {
        ...
        AUTO.mint(devAddress, AUTOReward.mul(138).div(1000)); // ~12%
        AUTO.mint(address(this), AUTOReward);
    ...
    function safeAUTOTransfer(address _to, uint256 _AUTOAmt) internal {
        uint256 AUTOBal = AUTO.balanceOf(address(this));
        if (_AUTOAmt > AUTOBal) {
            AUTO.transfer(_to, AUTOBal);
        } else {
            AUTO.transfer(_to, _AUTOAmt);
        }
    }
    ...
    function setPoolAdderAddress(address _poolAdderAddress) public {
        require(
            msg.sender == devAddress || msg.sender == governanceAddress,
            "Not authorised"
        );
        poolAdderAddress = _poolAdderAddress;
    }
    ...
    function inCaseStrategyTokensGetStuck(
        address _strategy,
        address _token,
        uint256 _amount
    ) public {
        ...
        IStrategy(_strategy).inCaseTokensGetStuck(_token, _amount, msg.sender);
    }
}