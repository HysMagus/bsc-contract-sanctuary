...
Inspired by other recent Little coins, I present to you Gingerbread
...
contract Gingerbread is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "Gingerbread";
    string private _symbol = "GBC";
