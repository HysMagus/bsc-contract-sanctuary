...
// Liviachain with Governance.
contract Liviachain is ERC20, Ownable, ERC20Burnable {
    using SafeMath for uint256;
    ...
    constructor(
        uint256 _tinyMint
    ) public ERC20("Liviachain", "LVA") {
        // dev needs a little of  LIVA tokens for listing on pancake initialization
    ...
    function delegateBySig(address delegatee, uint nonce, uint expiry, uint8 v, bytes32 r, bytes32 s) external {
        ...
        require(block.timestamp <= expiry, "SIG::delegateBySig: signature expired");
