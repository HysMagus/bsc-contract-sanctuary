...
contract KishuInuFOMO is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    string private _name = "$KISHUFOMO";
    string private _symbol = "$INUFOMO";
    ...
    uint256 public _maxTxAmount = 1 * 5000000**9;
    uint256 public _maxWalletAmount = 500000000 * 10**9;
