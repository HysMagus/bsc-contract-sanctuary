...
* - Max Wallet: 5000 tokens (5%)
* - Max Sell: 500 tokens (0.5%)
* - Max Buy: 1000 tokens (1%)
*
* - Buy Tax: 0% 
* - Sell Tax: (Anti-Dump Mechanic - 50% until 10k MCAP)
*
* Tax Distribution Breakdown
*
* 30% to Liquidity Pool
* 50% to ADA Reflections
* 20% to Marketing
* 
*
* 
...
//Floki Matador Contract /////////////

contract FLODOR is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'BabyFlodor';
    string private constant _symbol = '$BFLODOR';
    uint8 private constant _decimals = 9;
    uint256 public constant InitialSupply= 100000 * 10**_decimals;
    ...
    //DevWallets
    address public TeamWallet=payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6);
    address public walletTwo=payable(0x862d47994490B90bAee8dbC4DA39a836d388C1D6);
	...
	uint256 private antiWhale = 1000 * 10**_decimals;
