 ...
 *             NEXT 100X GEM!
 *                 BABY GALAXY
 * Dividend Token that reward $GHC every 60 minutes!
 *      Fees on Buy&Sell: 12%
 *
 *
 *
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RewardToken = IBEP20(0x683fae4411249Ca05243dfb919c20920f3f5bfE0); //GHC
...
contract BABYGALAXY is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "Baby Galaxy";
    string constant _symbol = "BGHC";
    uint8 constant _decimals = 9;

    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    address routerAddress = 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address RewardToken = 0x683fae4411249Ca05243dfb919c20920f3f5bfE0;  //GHC
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x990331f01E32fb85d4b63C44b508E2e21C368751;
        marketingWallet = 0x91221be1B38813F29183Dcb37B74924E1F18d5bC;  // marketingwallet
