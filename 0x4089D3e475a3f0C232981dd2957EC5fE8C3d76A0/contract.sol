...
contract pooplex is Context, IERC20, Ownable {
    ...
    string private _name = "pooplex";
    string private _symbol = "pooplex";
    ...
    uint256 public _liquidityFee = 0; // All taxes are divided by 100 for more accuracy.
    ...
    address payable private _marketingWallet = payable(0xA86B1E00C14bC090fDDb01168e023A0e7a128b00);
    address payable private _devWallet = payable(0x64e280191671feBAC938C316E48f4dc1eCfD94fC);
