/**
 * 
SafeLend is a decentralized lending platform. 


It is built on a peer-to-peer (P2P) model in which borrowers and lenders interact directly without the need of a bank, broker, or financial intermediary. 


SafeLend allows lenders to provide liquidity and receive interest in return and allows borrowers to borrow any amount they want for however long by providing collateral, eliminating the need for any registration or Know Your Customer (KYC) processes. 


It is de-fi at its finest — a crowdfunding lending platform for everyone, everywhere, at any time. 
*/
...
contract SLEND is Context, IERC20, Ownable {
