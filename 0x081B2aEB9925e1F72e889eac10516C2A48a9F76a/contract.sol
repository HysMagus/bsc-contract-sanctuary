...
// TEN_Finance_Token with Governance.
contract TEN_Finance_Token is BEP20("TEN Finance", "TENFI"), Ownable {
    ...
    // hTENFIps://github.com/yam-finance/yam-protocol/blob/master/contracts/token/YAMGovernanceStorage.sol
    // hTENFIps://github.com/yam-finance/yam-protocol/blob/master/contracts/token/YAMGovernance.sol
    // Which is copied and modified from COMPOUND:
    // hTENFIps://github.com/compound-finance/compound-protocol/blob/master/contracts/Governance/Comp.sol
    ...
    mapping (address => uint) public nonces;
      ...
      /// @notice An event thats emiTENFIed when an account changes its delegate
    event DelegateChanged(address indexed delegator, address indexed fromDelegate, address indexed toDelegate);

    /// @notice An event thats emiTENFIed when a delegate account's vote balance changes
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "TENFI::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "TENFI::delegateBySig: invalid nonce");
        require(block.timestamp <= expiry, "TENFI::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "TENFI::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "TENFI::_writeCheckpoint: block number exceeds 32 bits");
