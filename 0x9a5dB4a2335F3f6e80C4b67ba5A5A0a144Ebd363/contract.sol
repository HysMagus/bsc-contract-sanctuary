...
contract Benjimon is Benmon20Interface, Math {
    string public tokenNameBenmon = "Benjimon";
    string public tokenSymbolBenmon = "Benjimon";
    uint public _tokenSupplyBenmon = 1*10**9 * 10**9;
