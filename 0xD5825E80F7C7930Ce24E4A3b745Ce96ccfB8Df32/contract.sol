...
Presale is starting on 16 September 2021.

Invest in the future of adult entertainment through our very own $TITS ERC-20 reward token. There is a 9% fee on each transaction:
• 5% will be awarded to holders of $TITS
• 2% will go to Uniswap liquidity pool
• 2% development + marketing wallet
• Anti-whale + rug-pull protection

Token allocation:
• 58% Public Sale - Any unsold tokens will be burned at the end of each phase, greatly increasing value for early investors.
• 30% Liquidity Pool
• 9% Team - Liquidity is locked for 6 months, after which 10% will be released monthly.
