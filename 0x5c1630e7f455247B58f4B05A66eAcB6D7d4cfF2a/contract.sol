/**
 *Submitted for verification at HTPPS://BSCSCAN.COM on 2021-10-02
*/
...
//contract KishuPink is Context, IERC20, Ownable {
    
    contract  LOVEKISHU  is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x6cD435ACa7a65c663a9f188183E0DAc27d92A8De;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 1000000000000 * 10**9;                                     // = 1.000.000.0000.000 ( 100 % )
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = " LOVE KISHU (L0V3K15HU)  ";
    string private _symbol = "LOVEKISHU";
    ...
    uint256 public _maxTxAmount = 2500000000 * 10**9;                                     // = 5.000.000.000     ( 0.50 % )
    uint256 private numTokensSellToAddToLiquidity = 450000000000 * 10**9;                 // = 45.000.000.0000   ( 4.50 % )
