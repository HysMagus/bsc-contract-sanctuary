...
🐶SMARFLOKI 🐶Stealth launch / ⏰ Ownership renounced ✅ Verified contract 🔥 100% Rug Proof 🔍 100x Potential 🚀
💬 Telegram: https://t.me/SmartFloki
🌐 Website : under maintenance…🛠
 ($SMARFLOKI) 🐶is a decentralized Community experiment in Binance Smart Chain, with prospects of becoming the #1 Helper tools Ecosystem.
Learn about $SMARFLOKI Tokenomics:
...
What is our vision? 
SMARFLOKI is a community-based and community-driven project with the goal of creating Binance Smart Chain Helper tools and dApps for our Holders with complete and utter transparency through every step. Our Token $SMARFLOKI will be used to incentivize the use of said tools


💜 Community Development
Our plan from the start is to provide our community with many helper tools that will guide them through their journey in BSC
💌 SMARFLOKI community are to decide which directions will be prioritized over others. Thus, the Team will conduct polls in the official telegram channel to choose which issues the SMARFLOKI Platform will contribute to.
📈Initially liquidity – 1 BNB
...
contract SmartFloki is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            uint256 burnAmount = amount.mul(_SmartFloki).div(100);
