...
contract Oracle is IOracle {
    ...
    constructor (address dollar, address dao) public {
        _dao = dao;
        _dollar = dollar;
    }
...
contract Pool is PoolSetters, Liquidity {
    ...
    constructor(address dollar, address dao, address Pancakev2) public {
...
contract Deployer2 is State, Permission, Upgradeable {
    function initialize() initializer public {
        _state.provider.oracle = new Oracle(address(dollar()), address(oracle().pair()));
        oracle().setup();
    }
