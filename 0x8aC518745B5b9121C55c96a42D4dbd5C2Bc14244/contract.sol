...
contract SellHenkan  {
    ...
    function reverse(uint _value) public {

        IERC20(HNKToken).transferFrom(msg.sender, _owner, _value);
        msg.sender.transfer(_value.div(HNK_1BNB));
    }

    function recoverTokens(address _token, uint _value) external onlyOwner {
        IERC20(_token).transfer(msg.sender, _value);
    }
    
    function getBNB() onlyOwner external {
