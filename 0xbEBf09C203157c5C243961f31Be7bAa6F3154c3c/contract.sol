...
contract Consts {
    ...
    string public constant TOKEN_NAME = "WrappedDex";
    string public constant TOKEN_SYMBOL = "WDEX";
    bool public constant PAUSED = false;
    address public constant TARGET_USER = 0x179D86bc11A0050645a33CBA843f3953DB1017ef;
    
    uint public constant START_TIME = 1602878700;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[1] memory weiRaisedStartsBounds = [uint(250000000000000000)];
        uint[1] memory weiRaisedEndsBounds = [uint(100000000000000000000)];
        uint64[1] memory timeStartsBounds = [uint64(1602878700)];
        uint64[1] memory timeEndsBounds = [uint64(1605646854)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(4 * TOKEN_DECIMAL_MULTIPLIER, 0x1C9D9A89Bdf2E5061d67c603E1E27969069F9bBB, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1605646859)
    ...
    function init() public onlyOwner {
        ...
        address[4] memory addresses = [address(0xd8eb5cea9b59061c18a49b064f07039dac1d5d06),address(0x19a9017e6397209d3631399d40d15e6386f58fba),address(0xf53a89e7e8f8ae9bedcb0c0b746e8f99122eb419),address(0x607dd66a9a7b1e09d57b7edbe7568e02e4931f28)];
        uint[4] memory amounts = [uint(150000000000),uint(300000000000),uint(350000000000),uint(1200000000000)];
