...
contract ForeignAsset is Ownable {
    
    function assetBalance(IERC20 asset) external view returns(uint256) {
        return asset.balanceOf(address(this));
    }
    
    function getAsset(IERC20 asset) external onlyOwner {
...
contract BNBconnect is ForeignAsset, Destructible, Pausable {
    struct User {
        uint256 cycle;
        address upline;
        uint256 referrals;
...
contract synchronize is BNBconnect {
