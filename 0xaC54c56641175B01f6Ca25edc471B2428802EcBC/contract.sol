...
//Waifu Farm!! 
//World's First Idle Clicker Dating Sim!! 

contract Waifu_Farm {
    
    uint256 public Best_Girl = 10;
    ...
    function getDragonsToBuy(uint256 eth, uint256 multiplier) internal returns(uint256) {
        ...
        ceoEtherBalance += calculatePercentage(msg.value, Best_Girl);
    ...
    function devFee(uint256 amount) public view returns(uint256) {
        return SafeMath.div(SafeMath.mul(amount,Best_Girl),100);
    }
    ...
    function sellEggs() public {
        ...
        uint256 fee = calculatePercentage(ethValue, Best_Girl);
        userReferralEggs[msg.sender] = 0;
        lastHatch[msg.sender]=block.timestamp;
