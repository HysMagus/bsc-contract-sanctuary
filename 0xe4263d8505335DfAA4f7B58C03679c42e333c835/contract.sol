...
Welcome to EthFomo ($ETHFOMO)

One of the first token with dividend yields in Ethereum along with rebasing tokenomics.
18% tax, 7% is used to purchase ETH which is automatically paid out in dividends to holders
automatically.

Telegram: https://t.me/EthFomo
Website: https://ethfomo.finance/
*/
...
contract EthFomo is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xa3BBcfa2f6ba013e869AEED035ebAAEff129B8FA); // Marketing Address
    ...
    string private _name = "EthFomo";
    string private _symbol = "ETHFOMO";
