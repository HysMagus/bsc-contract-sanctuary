...
contract ERC20 is Context, IERC20, Ownable {
    ...
    constructor (string memory name_, string memory symbol_) public {
        ...
        _burnaddress = 0x903442DDeCc9A37A9eB70C55eD9a927CBC197c80;
...
contract KishuInuGaming is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Kishu Inu Gaming", "KIG") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "Kishu Inu Gaming";
    string private _symbol = "KIG";
    ...
    function excludeFromReward(address account) public onlyOwner() {
        // require(account != 0xe5e2B382f5d15eA51F6Be286D89F36e2935d86c4, 'We can not exclude Uniswap router.');
