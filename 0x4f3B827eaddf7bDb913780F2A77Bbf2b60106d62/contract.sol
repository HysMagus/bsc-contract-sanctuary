...
/**
   ...
   _____                ____  ______________.__          __   .__ 
  /  _  \ ______   ____ \   \/  /\_   _____/|  |   ____ |  | _|__|
 /  /_\  \\____ \_/ __ \ \     /  |    __)  |  |  /  _ \|  |/ /  |
/    |    \  |_> >  ___/ /     \  |     \   |  |_(  <_> )    <|  |
\____|__  /   __/ \___  >___/\  \ \___  /   |____/\____/|__|_ \__|
        \/|__|        \/      \_/     \/                     \/ 
        

 3% Liquidity | 3% Marketing | 10% Buyback
 0.5% Max Buy | 2% Max wallet

 TG: https://t.me/ApeXFloki
...
// CHANGE
contract ApeXFloki is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "ApeXFloki";
    string constant _symbol = "AXF";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 100% MAX
    uint256 public _maxWalletSize = (_totalSupply * 100) / 100; // 3% MAX 30,000,000
