...
// TunaKebab with Governance.
contract TunaKebab is ERC20("Tuna Kebab", "TUNAK"), Ownable {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "TUNAK::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "TUNAK::delegateBySig: invalid nonce");
        require(now <= expiry, "TUNAK::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "TUNAK::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "TUNAK::_writeCheckpoint: block number exceeds 32 bits");
    ...
    // In some circumstance, we should not burn TUNAK on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
