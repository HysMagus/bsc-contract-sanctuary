...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    address public buyBackToken2 = address(0x35e869B7456462b81cdB5e6e42434bD27f3F788c); // BDO
    ...
    constructor(
        ...
        address _buyBackToken1,
        address _buyBackAddress1,
        address _buyBackToken2,
        address _buyBackAddress2
    ) public {
        ...
        if (isAutoComp) {
            ...
            earnedToBuyBackToken1Path = [earnedAddress, wbnbAddress, buyBackToken1];
            if (wbnbAddress == earnedAddress) {
                earnedToBuyBackToken1Path = [wbnbAddress, buyBackToken1];
            }

            earnedToBuyBackToken2Path = [earnedAddress, wbnbAddress, buyBackToken2];
            if (wbnbAddress == earnedAddress) {
                earnedToBuyBackToken2Path = [wbnbAddress, buyBackToken2];
            }
        ...
        if (_buyBackToken1 != address(0)) buyBackToken1 = _buyBackToken1;
        buyBackAddress1 = _buyBackAddress1;
        if (_buyBackToken2 != address(0)) _buyBackToken2 = _buyBackToken2;
    ...
    function buyBack2(uint256 _earnedAmt) internal returns (uint256) {
        ...
        uint256 _before = IERC20(earnedAddress).balanceOf(buyBackAddress2);
        ...
        uint256 _after = IERC20(earnedAddress).balanceOf(buyBackAddress2);
    ...
    function distributeFees(uint256 _earnedAmt) internal returns (uint256 _fee) {
        if (_earnedAmt > 0) {
            ...
            if (controllerFee > 0) {
                ...
                IERC20(earnedAddress).safeTransfer(govAddress, _fee);
            }
        }
    }
    ...
    function setBuyBackRate1(uint256 _buyBackRate1) public {
        require(msg.sender == govAddress, "Not authorised");
        require(buyBackRate1 <= buyBackRateUL, "too high");
        buyBackRate1 = _buyBackRate1;
    }

    function setBuyBackRate2(uint256 _buyBackRate2) public {
        require(msg.sender == govAddress, "Not authorised");
        require(buyBackRate2 <= buyBackRateUL, "too high");
        buyBackRate2 = _buyBackRate2;
    }

    function setBuyBackAddress1(address _buyBackAddress1) public {
        require(msg.sender == govAddress, "Not authorised");
        require(buyBackAddress1 != address(0), "zero");
        buyBackAddress1 = _buyBackAddress1;
    }

    function setBuyBackAddress2(address _buyBackAddress2) public {
        require(msg.sender == govAddress, "Not authorised");
    ...
    function setEarnedToBuyBackToken1Path(address[] memory _path) external {
        require(msg.sender == govAddress, "!gov");
        earnedToBuyBackToken1Path = _path;
    }

    function setEarnedToBuyBackToken2Path(address[] memory _path) external {
        require(msg.sender == govAddress, "!gov");
        earnedToBuyBackToken2Path = _path;
    }

    function setEarnedToToken0Path(address[] memory _path) external {
        require(msg.sender == govAddress, "!gov");
        earnedToToken0Path = _path;
    }

    function setEarnedToToken1Path(address[] memory _path) external {
        require(msg.sender == govAddress, "!gov");
        earnedToToken1Path = _path;
    }

    function setToken0ToEarnedPath(address[] memory _path) external {
        require(msg.sender == govAddress, "!gov");
        token0ToEarnedPath = _path;
    }

    function setToken1ToEarnedPath(address[] memory _path) external {
        require(msg.sender == govAddress, "!gov");
    ...
    function executeTransaction(
        ...
        require(success, "StratX::executeTransaction: Transaction execution reverted.");
