...
contract KodiCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable private marketingAddress = payable(0xEA90D0CEfEFf10E8326aB4366494c4b1C5057C24); // Marketing Address
    ...
    string private _name = "KodiCoin";
    string private _symbol = "KODIAK";
