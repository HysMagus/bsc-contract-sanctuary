...
/*
   ...
   Welcome to ForeverCZ
   
   This is a community token. If you want to create a telegram I suggest to name it to @ForeverCZ
...
contract ForeverCZ is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xEca8502bd5938dE08a252A7b55a1BC54d8833a6c); // Marketing Address
    ...
    string private _name = "ForeverCZ";
    string private _symbol = "FOREVERCZ";
