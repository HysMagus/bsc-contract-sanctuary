...
library Address {
    ...
    function isContract(address account) internal view returns (bool) {
        ...
        // and 0x3Ae582Bd3E251762a56700f18860565ba3ec2549 is returned
...
contract Crawfish is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Crawfish';
    string  private constant _SYMBOL = 'CWF';
    ...
    function excludeAccount(address account) external onlyOwner() {
        require(account != 0x3Ae582Bd3E251762a56700f18860565ba3ec2549, 'We can not exclude Uniswap router.');
