...
contract EverGreen is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 1 * 10**10 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("EverGreen", "EVE", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0x9BD895873dD37e108719AD174660e81B749f2D1b;
        ecosystemFeeReceiver = 0x6525C1bA2952659A3aaEbEcaFA308E74fd2A6232;
        buyBackFeeReceiver = 0xB148415Dd9B09C1f1A61bd0e2Ca53eb1B7703BA7;
