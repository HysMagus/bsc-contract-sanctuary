/**
 *Submitted for verification at bscscan.com on 2020-10-1
*/

/**
 *  TICKER     : RPC
 *  TOKEN NAME : Royal Persian Carpet Token
*/


//With reference from the @openzeppelin contracts
...
/**
 * @title RPC
 * @dev RPC is a Mintable, Ownable, can be Burned and Pausable BEP20 token
 */
contract RPC is BEP20, Ownable {
    using SafeMath for uint;

    bool public paused; // True if circulation paused.

    string public constant name = "Royal Persian Carpet Token";
    uint8 public constant decimals = 18;
    string public constant symbol = "RPC";
    uint public constant initalSupply = 1 * 10**3 * 10**uint(decimals);      
    ...
    modifier whenNotPaused() {
        require(paused == false, "Cirlulation is paused!");
        _;
    }

    /**
     * @dev The RPC constructor sets the original manager of the contract to a
     * specified account, and sends all the inital supply to it.
     * @param manager, address of the first manager of this contract.
     */
    ...
    /**
     * @dev Adding an address as the minter.
     * @param minterAddress is added as a minter.
     */
    ...
    /**
     * @dev Removing an address from the minter list.
     * @param minterAddress is be removed from minters.
     */
    ...
    /**
     * @dev Function to pause all the circulation.
     */
    ...
    /**
     * @dev Function to recover all the circulation.
     */
    ...
    /**
     * @dev Function to freeze a specific user's circulation.
    ...
    /**
     * @dev Function to recover a specific user's circulation.
    ...
    /**
     * @dev Burns defined specific amount of tokens.
