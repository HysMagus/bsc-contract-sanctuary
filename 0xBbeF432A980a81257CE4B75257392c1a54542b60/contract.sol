...
contract PublicSale is Ownable{
    ...
    constructor(
        ...
        uint256 _raisingAmount
            ...
            MIN =0.1 ether;
            MAX =50 ether;
            raisingAmount = _raisingAmount.mul(10**18);
    }
    modifier isAvailable(){
        require(endingBlock>block.number,"Public Sale ended");
    ...
    receive() external payable isAvailable isEligible{
        ...
        if(tokens>tokensAvailable){
            ...
            value = tokensAvailable.div(rate);
        }
    ...
    function setRate(uint256 _normalRate) external onlyOwner{
        normalRate = _normalRate;
    }
    ...
    function setEndingBlock(uint256 _endingBlock) external onlyOwner{
    ...
    function setRaisingAmount(uint256 _amount) external onlyOwner{
        raisingAmount = _amount.mul(10**18);
    }
