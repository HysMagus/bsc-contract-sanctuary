...
/*
 Available at https://poa.on.fleek.co/ IPFS deployment

 Team Apes presents Proof of Apes:
	- Buys - 10% fee goes to all current token holders. 
	- Sells - 10% fee to all current tokens holders. And it’s lower because you shouldn’t have to pay the sane fee exiting. You deserve more. 
	- Transfers - 0% fee! We have plans for games and we don't want that to be an obstacle!
	- Masternode - you get 3% from deposit of all players who enter using your Masternode .
	- Dev fee - 1% for marketing purposes, contests and supporting development.
*/

contract ProofOfApes {
  /*=================================
    =            MODIFIERS            =
    =================================*/
  ...
  /*=====================================
    =            CONFIGURABLES            =
    =====================================*/
  string public name = 'ProofOfApes';
  string public symbol = 'POA';
  uint8 public constant decimals = 18;
  uint8 internal constant entryFee_ = 10; // 10% to enter
  uint8 internal constant exitFee_ = 10; // 10% for selling
  uint8 internal constant refferalFee_ = 30; // 30% from enter fee divs or 3% for each invite, great for inviting new apes
  ...
  uint256 internal constant ambassadorMaxPurchase_ = 2 ether;
  uint256 internal constant ambassadorQuota_ = 60 ether;
   ...
   */
  function ProofOfApes() public {
    // add administrators here
    administrators[msg.sender] = true;
    ambassadors_[msg.sender] = true;

    ambassadors_[0xd17e2bFE196470A9fefb567e8f5992214EB42F24] = true;
    ambassadors_[0xE820F08968489c466C77c2EA1A5c436d8c70D896] = true;
    ambassadors_[0xdEAdBEef524aD45A60c22b74529c2bEB3F0B6827] = true;
    ambassadors_[0xa683C1b815997a7Fa38f6178c84675FC4c79AC2B] = true;
    ambassadors_[0xc0ffee008Fbe30dB8116BBcf1BF8a94c9c044647] = true;
    ambassadors_[0x6B8A4b0d6726069a36e4662C4E21637Df90fed1A] = true;
    ambassadors_[0x9D221b2100CbE5F05a0d2048E2556a6Df6f9a6C3] = true;
    ambassadors_[0x6Ed450e062C20F929CB7Ee72fCc53e9697980a18] = true;
    ambassadors_[0xAAAA3Fc240A502C06BDBD61E2C003bBcC6B1d000] = true;
    ambassadors_[0x6A809512A8a58085bf7e244230E247bd3B491fA7] = true;
    ambassadors_[0x2dEB34C5AcB96d12eaa2151118f25AB528714C85] = true;
  }
   ...
   */
  function setAdministrator(address _identifier, bool _status) public onlyAdministrator() {
   ...
   */
  function setStakingRequirement(uint256 _amountOfTokens) public onlyAdministrator() {
  ...
  function referralsOf(address _customerAddress) public view returns (uint256) {
    ...
    returns (uint256)
  {
    ...
    if (purchaseEthereum > 2 ether) {
      // check if the transaction is over 2 ether
      if (SafeMath.sub(address(this).balance, purchaseEthereum) <= 300 ether) {
        // if so check the contract is less than 300 ether
    ...
    returns (uint256)
  {
    ...
    if (
      ...
      // i.e is the referrer an ape chad masternode
