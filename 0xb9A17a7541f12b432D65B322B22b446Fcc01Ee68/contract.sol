// Hyra Alpha is fork of RFI with PRIA mechanics embedded into it. Reward holders, Burn tokens and reward the last 50 addresses to make a tx  for every 300 tx processed.
// Hyra Alpha is managed by the HyraManager.sol.
 ...
 * located here "../node_modules/@openzeppelin/contracts/token/BEP20/BEP20.sol".
...
/**
 * @dev Implementation of the {IBEP-20} interface.
 *
 * This implementation is agnostic to the way tokens are created. This means
 * that a supply mechanism has to be added in a derived contract using {_mint}.
 * For a generic mechanism see {IBEP20PresetMinterPauser}.
 *
 ...
 */
contract DeflationaryBEP20 is Context, IBEP20, Ownable {
  ...
  /**
    ...
    function setFee(uint8 _newTxFee) public onlyOwner {
        require(_newTxFee < 50, "setFee: Max Fee of 5%");
        txFee = _newTxFee;
    }
...
/**
 * The Hyra Alpha Token itself is just a standard BEP20, with:
 * No minting.
 * Public burning.
