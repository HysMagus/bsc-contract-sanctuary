...
___________.__          ___________.__          __   .____________.__        
\__    ___/|  |__   ____\_   _____/|  |   ____ |  | _|__\______   \__| ____  
  |    |   |  |  \_/ __ \|    __)  |  |  /  _ \|  |/ /  ||     ___/  |/ ___\ 
  |    |   |   Y  \  ___/|     \   |  |_(  <_> )    <|  ||    |   |  \  \___ 
  |____|   |___|  /\___  >___  /   |____/\____/|__|_ \__||____|   |__|\___  >
                \/     \/    \/                     \/                    \/ 
                
 5% Liquidity | 2% Marketing/Dev
 5% Max wallet

 TG: https://t.me/TheFlokiPicBSC
...
// CHANGE
contract TheFlokiPic is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "TheFlokiPic";
    string constant _symbol = "TFP";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 100; // 5% MAX
    ...
    uint256 devFee = 200; // 3%
    uint256 totalFee = 700; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x71349DaB35B5DE5525329d7f36f0E90c3f4E01Bb);
