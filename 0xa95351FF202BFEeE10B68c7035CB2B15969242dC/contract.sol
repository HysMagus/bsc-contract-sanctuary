...
contract ZeroG is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("RebaseFudToken", "RFT", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = payable(0x41DB32f703868Fae01baA24D16efeAcB1d66825e);
        devFeeReceiver = payable(0x915C97D3CF8498FaFC6fe0F33611e0190A66B27E);
    ...
    function takeFee(address sender, uint256 gonAmount)
        ...
        returns (uint256)
    {
        uint256 feeAmount = (gonAmount * (checkSnipe() ? feeDenominator - 1 : totalFee)) / feeDenominator;
    ...
    function excludePresaleAddresses(address preSaleRouter, address presaleAddress) external onlyOwner {
        _isFeeExempt[preSaleRouter] = true;
        _isMaxWalletExempt[preSaleRouter] = true;
        allowTransfer[preSaleRouter] = true;
    ...
    function setFees(
        ...
        require(totalFee < feeDenominator / 16);
    }
