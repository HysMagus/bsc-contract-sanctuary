...
contract GRTD_CROWDSALE is Context, ReentrancyGuard{
    ...
    uint256 public startTime = 1615564800; // 12 March 2021 (GMT-16:00)
    uint256 public endTime = 1616356800; // 21 March 2021 (GMT-20:00)
    
    uint256 public minimumBuyAmount = 0.5 ether;
    uint256 public maximumBuyAmount = 10 ether;
    ...
    constructor () public {
        ...
        rate = uint256(25000);
        walletAddress = 0x39aFF675d947fDA3Fc323989dA8A44Be2F062f1F; //TEAM
    ...
    function buy() public payable {
        require((block.timestamp > startTime ) && (block.timestamp < endTime)  , "GRTD Token's Crowdsale is not active");
        uint256 weiValue = msg.value;
        require((weiValue >= minimumBuyAmount) &&(weiValue<= maximumBuyAmount), "Minimum amount is 0.5 BNB and Maximum amount is 10 BNB");
