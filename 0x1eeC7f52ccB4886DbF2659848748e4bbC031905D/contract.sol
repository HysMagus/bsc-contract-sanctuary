...
contract Master is Ownable {
    ...
    // Market oracle provides the UPGM/USD exchange rate as an 18 decimal fixed point number.
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = upgm.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && upgm.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(upgm.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return upgm.totalSupply().toInt256Safe()
