...
contract PeoplesDiamond is Context, IERC20, Ownable {
    ...
    string private _name = "Peoples Diamond";
    ...
    uint256 public _maxTxAmount = 100000000 * 10**3 * 10**18;
    uint256 private numTokensSellToAddToLiquidity = 2000 * 10**3 * 10**18;
