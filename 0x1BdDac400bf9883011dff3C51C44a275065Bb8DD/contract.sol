// Website : Syrup.Finance
    ...
    */
    ...
    //SyrupPresale Liquidity Event
    contract SyrupPresale is Ownable {
        ...
        constructor () public { syrup = IBEP20(0x386fE9e33c99dBF449Ab72AC76518c42Cb412386); }
        ...
        function withdrawUnsold(uint256 amount) public onlyOwner {
            require(amount <= syrup.balanceOf(address(this)).sub(totalOwed), "insufficient balance");
            syrup.transfer(msg.sender, amount);
        }
        ...
        function startPresale(uint256 _ends) public onlyOwner {
            ...
            require(maximum > 0, "set maximum first!");
        ...
        function claim() public {
            ...
            // send owed tokens
            require(syrup.transfer(msg.sender, amount), "failed to claim");
        }

        // Purchase Syrup Tokens
        function buy() public payable {
            ...
            require(totalOwed.add(amount) <= syrup.balanceOf(address(this)), "sold out");
