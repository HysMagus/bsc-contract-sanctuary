...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MiniFloki = IBEP20(0x5ee57424151d7256739A6E3386561F62D9f6EB05);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = MiniFloki.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(MiniFloki);
        ...
        uint256 amount = MiniFloki.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            MiniFloki.transfer(shareholder, amount);
...
contract MiniFlokiGate is IBEP20, Auth {
    using SafeMath for uint256;

    address MiniFloki = 0x5ee57424151d7256739A6E3386561F62D9f6EB05;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniFlokiGate";
    string constant _symbol = "MFG";
    ...
    uint256 public swapThreshold = _totalSupply * 10 / 10000000; // 0.01% of supply
    bool inSwap;
