...
contract MarsToken is Context, IBEP20, Ownable {
...
contract MasterChef is Ownable {
    ...
    struct PoolInfo {
        ...
        uint256 accMarsPerShare;   // Accumulated PLTS per share, times 1e12. See below.
    ...
    // Safe mars transfer function, just in case if rounding error causes pool to not have enough PLTs.
