...
/*
    ...
    Exclusive Collectable NFT's that offer hybrid access to the TBC Hype brand + Much more.

    TBC is a eco-friendly hybrid collective of art lovers emerged in the NFT space, collectors realm, & of fashion enthusiasts. 
    The Bear CLTV. is a collection of 7,777 unique NFT's curated and carefully crafted programatically with hundreds of variations, 
    personality traits, and accessories. Moreover, the Bear CLTV. will become a foundational clique within the blockchain itself. 
    Though TBC is a NFT collectible project, TBC is bringing a diverse selection of utility.
...
contract TheBearCLTV is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "TheBearCLTV";
    string private constant _symbol   = "TBC";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 50;
    uint256 public _liquidityFee = 0;
    uint256 public _marketingFee = 550;
