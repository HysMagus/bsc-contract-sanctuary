...
/**
 ...
 TG: https://t.me/babyminikishu
 
 Hodl $BMKishu and get MINIKISHU automatically in your wallet every hour or so!
 $ETH: 0xd62934ea8093ce56d339d75b501E8955aF4eC236
 
 # of Tokens: 100,000,000,000 (100 Billion)
 Max Wallet Size = 3,000,000,000 (3 Billion or 3%)
 Max Transaction Size = 1,500,000,000 (1.5 Billion or 1.5%)
 
 Reflection/Taxes: 5% in MINIKISHU, 3% in Liquidity, 3% to Marketing
 
 Buy Slippage: 15-20% (15% should be OK)

 *** THE MAX A WALLET CAN HAVE IS 3,000,000,000! THAT IS 3%! YOU CAN SELL A MAX OF 1%! ***
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 ETH = IERC20(0xd62934ea8093ce56d339d75b501E8955aF4eC236);
...
// CHANGE
contract BMKishu is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address ETH = 0xd62934ea8093ce56d339d75b501E8955aF4eC236;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Baby MiniKishu";
    string constant _symbol = "BMKishu";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 100000000000 * (10 ** _decimals); // 100,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 1) / 66; // 1.5% MAX 1,500,000,000
    ...
    uint256 devFee = 500; //
    uint256 totalFee = 1400; // liquidityFee + reflectionFee + devFee
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xA9507AbC9028949118660a6aF8733438E32f108D);
