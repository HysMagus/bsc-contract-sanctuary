...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        address _DELTAAddress,
        address _WBNBAddress,
        address _deltaVaultAddress
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        deltaTokenAddress = _DELTAAddress;
        WBNBAddress = _WBNBAddress;
        tokenBakerySwapPair = IBakerySwapFactory(address(0x01bF7C66c6BD861915CdaaE475042d3c4BaE16A7)).getPair(WBNBAddress,deltaTokenAddress);
        deltaVaultAddress = _deltaVaultAddress;
        feePercentX100 = 20;
    ...
    address deltaTokenAddress;
    address deltaVaultAddress;
    ...
    function setDeltaVaultAddress(address _deltaVaultAddress) public onlyOwner {
        deltaVaultAddress = _deltaVaultAddress;
    }
        ...
        )
    {
        ...
        // Dont have a fee when deltaVault is sending, or infinite loop
        // And when pair is sending (buys are happening, do not tax on it)
        if(sender == deltaVaultAddress || sender == tokenBakerySwapPair ) {
