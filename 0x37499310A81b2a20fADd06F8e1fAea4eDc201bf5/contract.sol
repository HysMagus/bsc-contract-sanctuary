...
contract Lending {
    ...
    function setAddress(address _flap, address _busd, address _eth) _onlyOwner public {
        flap = IERC20(_flap);
        busd = IERC20(_busd);
        eth = IBEP20(_eth);
    }
    ...
    function borrow(uint256 amountDeposited) public {
        ...
        require(flap.transferFrom(msg.sender, address(this), fee));
        require(eth.transferFrom(msg.sender, address(this), amountDeposited));
        collateral[msg.sender] = collateral[msg.sender] + amountDeposited;
        uint256 borrowAmount = amountDeposited * 200;
   ...
   function withdrawCollateral() public {
    ...
    function finish() _onlyOwner public {
        ...
        uint256 e = eth.balanceOf(address(this));
        eth.transfer(owner, e);
    }
