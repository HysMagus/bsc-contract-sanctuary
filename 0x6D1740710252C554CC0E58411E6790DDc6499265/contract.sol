...
contract MILKstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    address public constant uniswapV2router = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;
    
    IUniswapV2Router02 router = IUniswapV2Router02(uniswapV2router);
    
    // trusted deposit token contract address (MILK)
    address public constant trustedDepositTokenAddress = 0x502bC65861221f0365FAe1728D206D50fEc90bF8;
    // trusted reward token contract address (MILK)
    address public constant trustedRewardTokenAddress  = 0x502bC65861221f0365FAe1728D206D50fEc90bF8;
    // reward rate
    uint public rewardRatePercentX100 = 30e2;   // 30% Per Year
