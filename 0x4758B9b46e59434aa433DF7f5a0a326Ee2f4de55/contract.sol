...
contract RisingFOMO is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 10**16 * 10**DECIMALS;
    ...
    constructor() ERC20Detailed("RisingFOMO", "RFOMO", uint8(DECIMALS)) {
        ...
        marketingFeeReceiver = 0xa0A5CAc3a0dE270e565B6903a12e98db4b2519E9;
        ecosystemFeeReceiver = 0x141cff3eC71f5a4cBB11b7bBbe67Bc48A1faF57C;
        buyBackFeeReceiver = 0x46454BC40b9902266Df2aa2510c6D9af89dB65c7;
