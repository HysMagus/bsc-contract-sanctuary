...
contract LEGALIZEXRP is Ownable, IBEP20, SafeToken {
    using SafeMath for uint256;
    ...
    uint256 public _maxWalletPublic = _totalSupply.mul(2).div(200); 
    ...
    address public marketing = address(0xe666dCfa0dD956874A83d1Ca013b1Eeb20fAAD22);
    address public liquidity = address(0x583CE2C782c0D264e7Fe85722A78a600E6430432);
    address public buyback = address(0xe666dCfa0dD956874A83d1Ca013b1Eeb20fAAD22);
    ...
    constructor () {
        ...
        marketing = address(0x1305F0B9Dc0773Aaa06E36Dd4893d5d9021755C2);
        liquidity = address(0xf022618e208197FB68F7f8CA0ffF8BFc16B3d503);
