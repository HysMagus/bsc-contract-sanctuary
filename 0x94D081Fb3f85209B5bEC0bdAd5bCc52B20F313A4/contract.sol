...
contract MaxDream is Context, IERC20, Ownable, ReentrancyGuard {
    ...
    address payable public marketingAddress =
        payable(0xF6AdAbD4ABDfD93A8B635a9979f20E8E2Fb64383); // Marketing Address
    address payable public charityAddress =
        payable(0xF6AdAbD4ABDfD93A8B635a9979f20E8E2Fb64383); // Charity Address
    address payable public scholarshipAddress =
        payable(0xF6AdAbD4ABDfD93A8B635a9979f20E8E2Fb64383); // Scholarship Address
    ...
    string private _name = "FLOKISBNB";
