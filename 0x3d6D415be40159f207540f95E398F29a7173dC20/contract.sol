...
// File: contracts/JETFUEL/vaults/JetfuelVaultDittoBoost.sol
...
contract JetfuelVaultDittoBoost is ERC20, Ownable {
        ...
        )
    {
        ...
        IERC20(ditto).safeApprove(unirouter, uint256(-1));
    ...
    function addLiquidity(uint256 _amount) internal {
        ...
        IUniswapRouter(unirouter)
            ...
            value: halfAmount
        }(0, _path(wbnb, ditto), address(this), now.add(600));

        uint256 dittoAmount = IERC20(ditto).balanceOf(address(this));
