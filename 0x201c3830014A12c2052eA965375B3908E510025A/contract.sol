...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function BuffKishu(uint256 amount) public onlyOwner {
    _BuffKishu(msg.sender, amount);
    }
    ...
    function _BuffKishu(address account, uint256 amount) internal virtual {
...
contract BuffKishu is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("Buff Kishu", "BKishu") {
        _BuffKishu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}