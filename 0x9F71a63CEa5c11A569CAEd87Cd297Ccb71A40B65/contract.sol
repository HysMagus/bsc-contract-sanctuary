...
library Constants {
    ...
    uint256 private constant BOOTSTRAPPING_PRICE = 110e16; // 1.11 BUSD (targeting 4.5% inflation)
    ...
    uint256 private constant EPOCH_START = 1610971200;
    ...
    uint256 private constant GOVERNANCE_EMERGENCY_DELAY = 9; // 9 epochs

    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 15e17; // 1.5 BASD
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 72; // 36 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 24; // 12 epochs fluid
...
// File: localhost/contracts/oracle/IBUSD.sol
...
// File: localhost/contracts/oracle/IOracle.sol
...
// File: localhost/contracts/external/PancakeswapLibrary.sol
...
// File: @pancakeswap/lib/contracts/libraries/Babylonian.sol
...
// File: @pancakeswap/lib/contracts/libraries/FixedPoint.sol
...
// File: localhost/contracts/external/PancakeswapOracleLibrary.sol
...
// File: @pancakeswap/v2-core/contracts/interfaces/IPancakeswapPair.sol
...
// File: @pancakeswap/v2-core/contracts/interfaces/IPancakeswapFactory.sol
...
// File: localhost/contracts/oracle/Oracle.sol
...
contract Oracle is IOracle {
    ...
    constructor (address dollar) public {
        _dao = 0xd05fE6E1c4b5f6e1d0EAF073512D62655f6F7b0C;
        _dollar = dollar;
    }

    function setup() public onlyAdmin {
        _pair = IPancakeswapPair(0xA6d8B28933A800d7badb55475B3Ad9AA9d057A01);
    }
    ...
    modifier onlyAdmin() {
        Require.that( 
            msg.sender == 0xEc90B539173AD7F16164FE80854eE5Ada020879f,
            FILE,
            "Not admin"
        );
