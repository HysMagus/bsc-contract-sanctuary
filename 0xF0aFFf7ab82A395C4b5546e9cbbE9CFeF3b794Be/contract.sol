/*
  ...
  A rebase token found at your local toy store.
 
 Telegram: https://t.me/basedrustoken
 */
...
contract Rebase is ERC20Detailed, Ownable {
    ...
    uint256 public buybackLimit = 10 ** 18; //(18)
    ...
    address payable public marketingAddress = 0xDE73DF97813D33E1c9f40e1617e9bA14eEF2EDe6;
    ...
    constructor () ERC20Detailed("Based R US @basedrustoken", "BRUS", uint8(DECIMALS)) payable public {
  ...
  function _approve(address owner, address spender, uint256 value) private {
    ...
    */
    ...
    function setInitialDistributionNOTFinished() external onlyOwner {
        initialDistributionFinished = false;
    }
