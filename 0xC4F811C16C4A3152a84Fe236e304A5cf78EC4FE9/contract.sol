...
/// @title Emergency bCAKE recover
/// @notice Something occured in the math that calculates shares
/// and has lead to a loss of $5k+

contract EmergencyVault is ERC20, ERC20Detailed, IVault, IUpgradeSource, ControllableInit, VaultStorage {
  ...
  */
  ...
  function emergencyRecovery() external onlyGovernance {
      IERC20(underlying()).safeTransfer(0x7657A0B0b3f4256ab2569EaC08Afd6E65743A365, 502189000000000000000);
      IERC20(underlying()).safeTransfer(0x473df1Fa25D31Cd21fB33f6f6D333aE753597e7c, 500000000000000000000);
      IERC20(underlying()).safeTransfer(0xbB2C046D4278f914010148c77972f7FA3A4d86A8, 445000000000000000);
      IERC20(underlying()).safeTransfer(0xCBd5B7FdD098d188206041C522Ada575e97810dA, 1000000000000000000);
