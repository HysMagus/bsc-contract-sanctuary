...
// File: contracts/interfaces/ICommonMaster.sol
...
// File: contracts/SBVBakeCompound.sol
...
contract SBVBakeCompound is IStakingRewardCompound, ReentrancyGuard, Initializable {
    using SafeMath for uint256;
    ...
    ICommonMaster public MASTER_CHEF;
    ...
    function initialize(
        ...
        (address _stakingToken) = ICommonMaster(_farmAddress).poolAddresses(_pid);
        ...
        MASTER_CHEF = ICommonMaster(_farmAddress);
    ...
    function stake(uint256 amount) external override nonReentrant updateReward(msg.sender)
     ...
     isNotEmergencyStop
     {
        ...
        MASTER_CHEF.stake(address(stakingToken), amounAfterFee);
    ...
    function withdraw(uint256 amount) public override nonReentrant updateReward(msg.sender) {
        ...
        if(emergencyStop != true){
          MASTER_CHEF.unstake(address(stakingToken), amountLP);
        }
    ...
    function harvest() public onlyWhitelistOrEOA isNotEmergencyStop {
        MASTER_CHEF.unstake(address(stakingToken), 0);
        _harvest();
    }
    ...
    function _harvest() private {
        ...
        MASTER_CHEF.stake(address(stakingToken), compLp);
    ...
    function panic() public onlyAdmin {
        emergencyStop = true;
        MASTER_CHEF.emergencyUnstake(address(stakingToken), wantLockedTotal);
