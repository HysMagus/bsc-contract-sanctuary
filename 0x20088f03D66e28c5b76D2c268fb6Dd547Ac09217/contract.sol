...
contract JGNE is ERC1155Tradable {
	constructor() public ERC1155Tradable("EXCLUSIVE", "JGNE") {
		_setBaseMetadataURI("https://draw2.jgndefiapi.com/api3/");
	}

	function contractURI() public view returns (string memory) {
		return "https://draw2.jgndefiapi.com/api3/contract/jgn";
	}
}