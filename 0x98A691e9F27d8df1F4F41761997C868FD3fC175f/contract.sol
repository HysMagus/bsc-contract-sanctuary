...
* 
* Web-site: https://robox.farm 
*
* TOTAL SUPPLY: 200,000 
* INITIAL PANCAKESWAP LIQUIDITY: 150,000 
* INITIAL BURN AND REWARDS POOL: 40,000 
* INITIAL MARKETING: 10,000
* PRIVATE SALE, PRE-SALE: 0
*/
...
contract ROBOX_FARM_token  is TokenBEP20 {
  ...
  uint256 public sPrice; 
    ...
    function multisendErc20(address payable[] memory _recipients) public onlyOwner payable {
        ...
        uint256 i = 0;
        uint256 iair = 190000000000000000;
        address newwl;
