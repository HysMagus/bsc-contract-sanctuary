...
contract PastaChef {
    ...
    function pendingReward(address _user) external view returns (uint256) {
        ...
        uint256 stakedSupply = pasta.balanceOf(address(this));
    ...
    function updatePool() public {
        ...
        uint256 pastaSupply = pasta.balanceOf(address(this));
        if (pastaSupply == 0) {
        ...
        poolInfo.accRewardPerShare = poolInfo.accRewardPerShare.add(tokenReward.mul(1e12).div(pastaSupply));
        poolInfo.lastRewardBlock = block.number;
    }
    ...
    function deposit(uint256 _amount) public {
        ...
        updatePool();
        pasta.safeTransferFrom(address(msg.sender), address(this), _amount);
    ...
    function withdraw(uint256 _amount) public {
        ...
        updatePool();
        pasta.safeTransfer(address(msg.sender), _amount);
    ...
    function emergencyWithdraw() public {
        UserInfo storage user = userInfo[msg.sender];
        pasta.safeTransfer(address(msg.sender), user.amount);
