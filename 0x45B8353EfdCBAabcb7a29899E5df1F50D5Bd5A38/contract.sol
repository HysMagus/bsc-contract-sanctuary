...
contract StratX_biswap is Ownable, ReentrancyGuard, Pausable {
    ...
    address public constant unirouterbiswap =
        address(0x3a6d8cA21D1CF76F653A67577FA0D27453350dD8);//biswap
    ...
    address[] public wbnbToToken0Path;
    address[] public wbnbToToken1Path;
    ...
    constructor() public {
        wantAddress = 0x3d94d03eb9ea2D4726886aB8Ac9fc0F18355Fd13; 
        pid = 11;
    ...
    function _farm() internal {
        ...
        wantLockedTotal = wantLockedTotal.add(pairBal);
        if (pairBal > 0) {
    ...
    function earn() public whenNotPaused {
        ...
        // Converts earn tokens into wbnb tokens
    ...
    function addLiquidity() internal {
        uint256 earnedAddressHalf = IERC20(wbnb).balanceOf(address(this)).div(2);
    ...
    function distributeFees(uint256 _earnedAmt) internal returns (uint256) {
        if (_earnedAmt > 0) {
            ...
            if (controllerFee > 0) {
                ...
                //IERC20(wbnb).safeTransfer(fundManager, fee.mul(75).div(100));
                IERC20(wbnb).safeTransfer(receiveFee, fee);
