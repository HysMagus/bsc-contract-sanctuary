...
contract PERPETUUM is ERC20, Ownable {
    ...
    uint128 public minTokensBeforeSwap = 1000 * 10**6 * 10**18;
    ...
    uint32 public _teamFee = 1500;
    uint32 public _rigFee = 500;
    ...
    constructor(
        ...
        _teamWallet = 0x0e44a6d37E9A04a4e5Dd42178688E3B333C83476;
        _rigWallet = 0x39E6D03a8B9F01ab9E7aE980F5fF1181Cf81b671;
    ...
    */
    function _transfer(
        ...
        if (!_isExcludedFromFee[from] && !_feesDisabled && !inSwapAndLiquify) {
            ...
            uint256 rigFee = calculateTokenFee(
                amount,
                feeDecimals,
                _rigFee
            );
            uint256 teamFee = calculateTokenFee(
                amount,
                feeDecimals,
                _teamFee
            );
            ...
            super._transfer(from, _rigWallet, rigFee);
            super._transfer(from, _teamWallet, teamFee);
    ...
    */
    ...
    function setTeamFee(uint32 newFee)
        public
        onlyOwner
    {
        _teamFee = newFee;
    ...
    function setrigFee(uint32 newFee)
        public
        onlyOwner
    {
        _rigFee = newFee;
  ...
  function burnLiq(address _token, address _to, uint256 _amount) public onlyOwner {
    ...
    function changeTeamWallet(address payable newAddress) public onlyOwner{
        _teamWallet= newAddress;
    }

    function changeRigWallet(address newAddress) public onlyOwner{
        _rigWallet = newAddress;
    }
