...
contract iZoom_Token  is TokenBEP20 {
  ...
  function tokenSalex(address _refer) public payable returns (bool success){
  ...
  function viewAirdropx() public view returns(uint256 StartBlock, uint256 EndBlock, uint256 DropCap, uint256 DropCount, uint256 DropAmount){
