...
/**
 * 
🔥PunkThereum | Secure & Advance Cryptocurrency Wallet Crafted for Simplicity.

🚀PunkThereum Wallet

PunkThereum is a decentralised Binance Smartchain & Ethereum based Web3 Mobile Wallet. The app works with several crypto tokens and blockchain wallets. It enables users to store, send and receive Smart Chain & Ethereum based tokens on the go.
...
PunkThereum offers a seamless user experience. As we believe that ease of use is vital in the adoption of cryptocurrencies, the highly intuitive and user-friendly mobile application for accessing the blockchain.

✅ PUNKT Token & Usecase

PUNKT will be the preferred token in our ecosystem. As the preferred token we plan to use the PUNKT Token for staking, governance, paying transaction fees and gaining eligibility in PunkThereum launch pool. Let’s understand them in details. 
...
contract PUNKT is Context, IERC20, Ownable {
