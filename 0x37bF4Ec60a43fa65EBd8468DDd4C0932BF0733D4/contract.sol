...
contract StratVLEV is Ownable, ReentrancyGuard, Pausable {
    ...
    address public wantAddress = 0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d;
    address public vTokenAddress = 0xecA88125a5ADbe82614ffC12D0DB554E2e2867C8;
    ...
    address public afiFarmAddress = 0x94Ed0cd7A6458229b087C4CA0D76cDCAA495Be1B;
    address public AFIAddress = 0x6C77dF12c39CAE90C4c46E5C19177679b7235CFa;
    ...
    constructor(
        ...
        earnedToAFIPath = [venusAddress, wbnbAddress, AFIAddress];
    ...
    function buyBack(uint256 _earnedAmt) internal returns (uint256) {
        ...
        // Burn AFI tokens
        uint256 burnAmt = IERC20(AFIAddress).balanceOf(address(this));
        IERC20(AFIAddress).safeTransfer(buyBackAddress, burnAmt);
