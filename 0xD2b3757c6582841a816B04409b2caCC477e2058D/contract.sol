...
interface IDemoSwap{
     ...
     * 
    */ 
    function swapTokenToNativeAndOtherToken(address fromAddress, uint fromAmount, address otherTokenAddress, uint nativePercent) external payable returns (bool);
}
...
contract DemoSwap is IDemoSwap, Ownable{
     ...
     * 
     */ 
    function swapTokenToNativeAndOtherToken(address fromAddress, uint fromAmount, address otherTokenAddress, uint nativePercent) external payable override returns (bool){
