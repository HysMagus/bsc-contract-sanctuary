...
/* Doggy Style Total Supply is 10,000,000
 * Max buy/sell limit 200,000 tokens.
 * 3% will distrubite to holders
 * 2% burning forever
 * I will add 0.35 BNB and 95% total supply to pool.
 * 5% Dev tokens.
 * I will send to LP tokens dead address.
 * If you interested create a Telegram community.
 * Have fun.
 * Sory for other token i was accidentally deployed it :)
