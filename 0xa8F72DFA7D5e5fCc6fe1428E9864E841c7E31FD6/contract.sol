...
library Constants {
    ...
    uint256 private constant EPOCH_START = 1610856000;
    uint256 private constant EPOCH_PERIOD = 900;
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 1e18; // 1 TSD
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 288; // 288 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 192; // 192 epochs fluid

    /* Market */
    uint256 private constant COUPON_EXPIRATION = 2880;
