...
/**
    TRIDENT(TEST)  is an Automated Yield Token Built on Binance Smart Chain 
...
contract TRITest is Context, IERC20, Ownable {
    ...
    string private _name = 'TRIDENTTest';
    string private _symbol = 'TRIT';
    uint8 private _decimals = 8;

    uint256 private _taxFee = 1;
    uint256 private _burnFee = 1;
    uint256 private _maxTxAmount = 2000e8;
