...
contract LosDiablos is ERC20 {
    ...
    string public constant name = "LosDiablos";
    string public constant symbol = "DIABLO";
    uint public constant decimals = 18;
    uint public deadline = now + 0 * 1 seconds;  //Now
    uint public round2 = now + 50 * 1 days;
    uint public round1 = now + 10 * 1 days;
    
    uint256 public totalSupply = 735.081505e18;
    ...
    constructor() public {
        uint256 companyFund = 735.081505e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 10000 BNB or more and get 2% more DIABLO of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 10000 BNB or more and get 1% more DIABLO of round 2
