 ...
 *  Supply 1,000,000,000, Max TX 10,000,000, Max Wallet 30,000,000
 *  Tokenomics, 5% Auto LP, 10% Marketing
 *  15% tax
 
 https://t.me/GalaxyKishu
 www.GalaxyKishu.xyz (on development)
 
 
 Tired of getting rekt on rebased contract? 
lets back to basic and the classic one, we moon together, Make profit with us .
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDS = IERC20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4);
...
// CHANGE
contract GalaxyKishu is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address REWARDS = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Galaxy Kishu";
    string constant _symbol = "GALAXYKISHU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000 * (10 ** _decimals); // 1,000,000,000
    uint256 public _maxTxAmount = (_totalSupply * 100) / 50; // 100% MAX
    uint256 public _maxWalletSize = (_totalSupply * 100) / 25; // 3% MAX 30,000,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xc26BB63154300cEF911EE34BaEAc650E7F020A09);
