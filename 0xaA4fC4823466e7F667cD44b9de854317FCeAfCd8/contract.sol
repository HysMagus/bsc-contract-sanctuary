...
interface IMigratorChef {
    // Perform LP token migration from legacy PancakeSwap to HoneySwap.
...
contract MasterChef is Ownable, ReentrancyGuard {
    ...
    // Migrate PancakeSwap LP token to HoneySwap LP contract. Secured by the 72 Hours timelock and the masterchef contract itself.
