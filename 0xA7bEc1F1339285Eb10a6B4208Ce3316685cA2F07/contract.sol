...
// * diceplay.io - fair games that pay Binance BNB. Version 1.
//
// * Binance smart contract, deployed at 0x9Efe9f1AFa22D35aE6D45E5c5a7157720AF72517.
//
// * Uses hybrid commit-reveal + block hash random number generation that is immune
//   to tampering by players, house and miners. Apart from being fully transparent,
//   this also allows arbitrarily high bets.
//
// * Refer to https://diceplay.io/whitepaper.pdf for detailed description and proofs.
...
contract DicePlay {
   ...
   uint constant HOUSE_EDGE_MINIMUM_AMOUNT = 0.003 ether;

    // Bets lower than this amount do not participate in jackpot rolls (and are
    // not deducted JACKPOT_FEE).
    uint constant MIN_JACKPOT_BET = 1.2 ether;

    // Chance to win jackpot (currently 0.1%) and fee deducted into jackpot fund.
    uint constant JACKPOT_MODULO = 1000;
    uint constant JACKPOT_FEE = 0.01 ether;

    // There is minimum and maximum bets.
    uint constant MIN_BET = 0.15 ether;
    uint constant MAX_AMOUNT = 3000000 ether;
    ...
    // 4 and 6; for games with modulos higher than threshold (BinanceRoll), a simple
    ...
    // threshold. On rare occasions diceplay.io croupier may fail to invoke
    // settleBet in this timespan due to technical issues or extreme Binance
