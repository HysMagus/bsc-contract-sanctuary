...
//
// Coming soon
// Starting from 0.6 BNB first 1499
// Then 1.2 BNB 1500+
// 20 per person max
//
//
 ...
 */
contract ChadNFTs is Context, Ownable, ERC165, IWaifus, IERC721Metadata {
    ...
    string public constant WAIFUS_PROVENANCE = "285cba606e2961c36ea9495400da6e13ac7623d7f88d88da3bda8f4da776e555";
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 16381) {
            return 600000000000000000000; // 16381 - 16383 600 BNB
        } else if (currentSupply >= 16000) {
            return 12000000000000000000; // 16000 - 16380 12 BNB
        } else if (currentSupply >= 15000) {
            return 7800000000000000000; // 15000  - 15999 7.8 BNB
        } else if (currentSupply >= 13000) {
            return 6600000000000000000; // 13000 - 14999 6.6 BNB
        } else if (currentSupply >= 11000) {
            return 5400000000000000000; // 11000 - 12999 5.4 BNB
        } else if (currentSupply >= 9000) {
            return 4200000000000000000; // 9000 - 10999 4.2 BNB
        } else if (currentSupply >= 7000) {
            return 3000000000000000000; // 7000 - 8999 3 BNB
        } else if (currentSupply >= 5000) {
            return 2400000000000000000; // 5000 - 6999 2.4 BNB
        } else if (currentSupply >= 3000) {
            return 1800000000000000000; // 3000 - 4999 1.8 BNB
        } else if (currentSupply >= 1500) {
            return 1200000000000000000; // 1500 - 2999 1.2 BNB
        } else {
            return 600000000000000000; // 0 - 1499 0.6 BNB 
        }
    }
