/**
https://t.me/mysterydailybsc

🅴🅻🅾🅽 🅶🅴🆃 🅳🆁🆄🅽🅺

Stealth launch token with 8% token reward for holders
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  MATIC = IBEP20 (0x4cC9aC1D6662fe0de927DB28aB347A82342c318B);
...
contract ElonGetDrunk is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x4cC9aC1D6662fe0de927DB28aB347A82342c318B;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

        string constant _name = "ElonGetDrunk";
    string constant _symbol = "EGD";
