/**
 *Come in the next x1000 Moonshoot! ☄️
OnePunk👾🦄
Welcome to ONE PUNK holding ONE PUNK in your wallet will give you $1INCH token every 15 minute

First token with 1Inch coin reward and nft ecosystem.
Want to find additional passive income? 
Come on join with us!!
OnePunk coin with 13%
1INCH reward every 15 minutes.
Nft Giveaway for Presale and Nft Marketplace

Telegram: t.me/Onepunkbsc

Website: https://onepunkbsc.com/

Whitepapper : https://onepunkbsc.com/Whitepaper_OnePunk.pdf

Twitter : https://twitter.com/OnePunkbsc?s=09

Medium : https://medium.com/@onepunkbsc
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 INCH = IBEP20(0x111111111117dC0aa78b770fA6A738034120C302);
    ...
    function deposit() external payable override {
        uint256 balanceBefore = INCH.balanceOf(address(this));
        ...
        uint256 amount = INCH.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            INCH.transfer(shareholder, amount);
    ...
    event Deposit(uint256 amountBNB, uint256 amountinch);
...
contract OnePunk is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "One Punk ";
    string constant _symbol = "OnePunk";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000000 * (10 ** _decimals); // 1,000,000,000,000,000
    uint256 public _maxTxAmount = _totalSupply / 50; //1000 0.1% 
    ...
    uint256 swapThreshold = _totalSupply / 8000; // 0.0125%
