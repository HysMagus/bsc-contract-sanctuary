...
/* EThereumSV.net Token - BNB Reward Token
...
contract EthereumSV is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xE7f59DAF871968a34e3d83CaDCEd4DA929EE38f4); // Marketing Address
    address payable public charityAddress = payable(0xE7f59DAF871968a34e3d83CaDCEd4DA929EE38f4); // Charity/Dev Address
    ...
    uint256 private _tTotal = 2000000000000000 * 10**18; // 1 Qud
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "ETH Silicon Valley";
    string private _symbol = "ETHSV";
  ...
  function setALLFeePercent(uint256 charity,uint256 marketting,uint256 burnTaxFee,uint256 liquidityFee,uint256 taxFee,uint256 sellLiquidityFee,uint256 sellTaxFee,uint256 buyLiquidityFee,uint256 buyTaxFee) external onlyOwner() {
    ...
    uint256 private _airdropEth =   5000000000000000; //0.002 BNB Airdrop fee
    uint256 private _airdropToken = 500000000000000000000000000; // 200,000,000; token will be given on airdrop
    ...
    uint256 private salePrice = 2000000000000;// 0.01*100000000000=10,000,000,000 token for 0.01 bnb (set as per requirements)
