...
contract MdoRewardPool {
    ...
    constructor(address _mdo, uint256 _startBlock) public {
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({lpToken: _lpToken, allocPoint: _allocPoint, lastRewardBlock: _lastRewardBlock, accMdoPerShare: 0, isStarted: _isStarted}));
        if (_isStarted) {
