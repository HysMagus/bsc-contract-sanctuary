/**
 * MarsCoin
 * "There will definitely be a MarsCoin!" - Elon
*/
 ...
 *
 * DISCLAIMER: BEP20 TOKEN GENERATOR'S AUTHOR IS FREE OF ANY LIABILITY REGARDING THE TOKEN AND THE USE THAT IS MADE OF IT.
 *  The following code is provided under MIT License. Anyone can use it as per their needs.
 *  The BEP20 Token Generator's purpose is to make people able to tokenize their ideas without coding.
...
/**
 * @title MarsCoin
 * @dev Implementation of the MarsCoin
 */
contract MarsCoin is BEP20Mintable, BEP20Burnable {

    constructor ()
      BEP20("MarsCoin", "MARS")
    {
        _mint(_msgSender(), 100000000000000000000000000000000000000000);
    }
