...
contract Csix is Context, IERC20, Ownable {
    ...
    string private _name = "Csix";
    string private _symbol = "Csix";
    ...
    uint256 public _fundingFee = 1;
    uint256 private _previousFundingFee = _fundingFee;
    
    address  public charityAddress = 0x37428f639A6a1BBC9968b7df139af7a6667EC1d9;
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
        ...
        _transferStandard(sender, charityAddress, fundingAmt);
    ...
    function setBurnFee(uint256 BurnFee) external onlyOwner() {
     ...
     function setFundingFee(uint256 FundingFee) external onlyOwner() {
