...
contract BlubberCoin is IERC20, IERC20Metadata, Ownable {
    ...
    address payable public _taxWallet = payable(0xCcF45e9D9cc4294D0CCe934b504B919967c3d3B1);
    address payable public _liqWallet = payable(0xCcb303d40b72cE001d325CB2feCB2097c8aC63f9);
    ...
    uint256 public _taxTaxS     = 4;
    uint256 public _refTaxS     = 13;
    uint256 public _liqTaxS     = 1;
    uint256 public _burnTaxS    = 2;
    uint256 public _taxTaxB     = 4;
    uint256 public _refTaxB     = 10;
    uint256 public _liqTaxB     = 1;
    uint256 public _burnTaxB    = 0;
    uint256 public _taxTaxT     = 0;
    uint256 public _refTaxT     = 20;
    uint256 public _liqTaxT     = 0;
    uint256 public _burnTaxT    = 0;

    uint256 public _minRefBuy   = 1000000000000;
    uint256 public _maxRefLen   = 200;
    uint256 public _curRefLen   = 0;

    uint256 private liqCount   = 0;
    uint256 private taxCount   = 0;
