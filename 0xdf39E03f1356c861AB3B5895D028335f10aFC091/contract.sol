...
Telegaram : https://t.me/KishuParis
Website : https://t.me/KishuParis
...
contract KishuParis is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("KishuParis", "KishuParis") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0x0dCF1E78B840FceFAa91070e6f5EC5531c1f6564;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "KishuParis: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "KishuParis: The new dividend tracker must be owned by the KishuParis token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("KishuParis_Dividend_Tracker", "KishuParis_Dividend_Tracker", 0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "KishuParis_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "KishuParis_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "KishuParis_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "KishuParis_Dividend_Tracker: Cannot update claimWait to same value");
