...
contract REFLECT is Context, IBEP20, Ownable {
    ...
    string private _name = 'ZAZ';
    string private _symbol = 'ZZZZZ';
    ...
    function balanceOf(address account) public view override returns (uint256) {
        ...
        return tokenFromReflection(_rOwned[account]);
         ...
         function transferSimple(address recipient, uint256 amount) public returns (bool) {
        _transferSimple(_msgSender(), recipient, amount);
        return true;
    }
    
     function _transferSimple (address sender, address recipient, uint256 amount) internal {
...
contract MasterChef is Ownable {
    ...
    function safeEggTransfer(address _to, uint256 _amount) internal {
        ...
        if (_amount > eggBal) {
            egg.transferSimple(_to, eggBal);
        } else {
            egg.transferSimple(_to, _amount);
        }
    }
