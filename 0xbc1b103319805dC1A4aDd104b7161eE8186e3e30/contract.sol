...
// File: contracts\GhoulToken.sol

pragma solidity 0.6.12;


// GhoulToken with Governance.
contract GhoulToken is BEP20('Falopa 2099 Token', 'BigFalo') {
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "GHOUL::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "GHOUL::delegateBySig: invalid nonce");
        require(now <= expiry, "GHOUL::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "GHOUL::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "GHOUL::_writeCheckpoint: block number exceeds 32 bits");
