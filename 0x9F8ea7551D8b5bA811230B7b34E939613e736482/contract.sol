...
contract BAKEDistributor is IBAKEDistributor {
    ...
    uint256 public minDistribution = 0.01 * 10**18; // 0.1 BAKE minimum auto send
...
contract BURGERDistributor is IBURGERDistributor {
    ...
    // once the minimum distribution limit is hit after "minPeriod" it awards the reward
    uint256 public minPeriod = 30 minutes;
    uint256 public minDistribution = 0.02 * 10**18; // 0.1 BURGER minimum auto send
...
contract CAKEDistributor is ICAKEDistributor {
    ...
    // once the minimum distribution limit is hit after "minPeriod" it awards the reward
    uint256 public minPeriod = 30 minutes;
    uint256 public minDistribution = 0.03 * 10**18; // 0.1 CAKE minimum auto send
...
contract BAKEaBURGERCAKE is IERC20, Context, Ownable {
    ...
    uint256 public BAKEreflectionFee    =   5;
    uint256 public BURGERreflectionFee  =   5;
    uint256 public CAKEreflectionFee    =   5;
    uint256 public totalFeeSells        =  20;
    uint256 public totalFeeBuys         =  10;
    uint256 feeDenominator              = 100;

    uint256 minimumToDistribute = 0.01 * 10**18; // 0.1 BNB
