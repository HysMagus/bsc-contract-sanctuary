...
EthereumForever - Rebase + Reward Tokenomic
...
contract EthereumForeverDividendTracker is IDividendDistributor {
    ...
    IBEP20 Ethereum = IBEP20(0x2170Ed0880ac9A755fd29B2688956BD959F933F8);
    ...
    uint256 public minDistribution = 10000000000000; // 0.00001 ETH minimum auto send  
    uint256 public minimumTokenBalanceForDividends = 1000000 * (10**9); // Must hold 1000,000 token to receive Etheruem
...
contract EthereumForever is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "EthereumForever";
    string _symbol = "EthereumForever";
    ...
    EthereumForeverDividendTracker dividendTracker;
    ...
    constructor() {
        ...
        autoLiquidityReceiver = 0xeb745f8Ca9c5004cAce018E72dFE3cA8359489e5;
        marketingFeeReceiver = 0x7B60A4De15E34660CB71ED4230189D8E63868095;
        ecosystemFeeReceiver = 0xfD41c1D0313985795f11827D4161B921Df88785D;
        buyBackFeeReceiver = 0x4CE471ddf977c5b037099862fACd16d493DE7869;

        excludeDividend[pair] = true;
        excludeDividend[address(this)] = true;
        excludeDividend[DEAD] = true;
        
        dividendTracker = new EthereumForeverDividendTracker();
