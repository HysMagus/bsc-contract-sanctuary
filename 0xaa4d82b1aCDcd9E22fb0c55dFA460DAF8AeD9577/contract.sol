...
library FlokiCash  {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "FlokiCash : addition overflow");

        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "FlokiCash : subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "FlokiCash : multiplication overflow");

        return c;
    }

    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "FlokiCash : division by zero");
    }
...
contract FlokiCashx is
    BASEToken("FlokiCash ", "FlokiCash ", 1000000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using FlokiCash  for uint256;
    ...
    uint256  buyBackUpperLimit = 25 * 10**16;
