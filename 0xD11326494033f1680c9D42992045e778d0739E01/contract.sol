...
=== ' Persian Rap Fan' Token contract with following features ===
    => bep20 Compliance
    => Higher degree of control by owner - safeguard functionality
    => SafeMath implementation 
    => Burnable 
    => Minting capped at the Max Supply 
    => User freezing/blacklisting 



======================= Quick Stats ===================
    => Name        : Persian Rap Fan
    => Symbol      : PRF
...
-------------------------------------------------------------------
 ...
 Copyright (c) 2020 onwards  Persian Rap Fan Team ( http://kandisumusic.com )
...
contract UndergroundPersianRap is owned {
    ...
    string constant private _name = " Persian Rap Fan";
    string constant private _symbol = "PRF";
    uint256 constant private _decimals = 8;
    uint256 private _totalSupply = 10000000 * (10**_decimals);         
    uint256 constant public maxSupply = 10000000 * (10**_decimals);    
