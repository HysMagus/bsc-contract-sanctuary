// ZelCore - Multi-asset wallet & Fintech platform
// https://zelcore.io
// https://github.com/ZelCore-io
// Built off of https://github.com/wbobeirne/eth-balance-checker
...
contract BalanceChecker {
  /* Fallback function, don't accept any BNB */
  ...
  */
  ...
  /*
    ...
    Pass 0x0 as a "token" address to get BNB balance.
    ...
    for(uint i = 0; i < users.length; i++) {
      for (uint j = 0; j < tokens.length; j++) {
        ...
        if (tokens[j] != address(0x0)) { 
          ...
          addrBalances[addrIdx] = users[i].balance; // BNB balance    
        }
      }  
    }
