...
contract FlokiSpaceBalls is Context, iBEP20, Ownable {
  ...
  constructor() public {
    ...
    uint256 public _XRPReward = 4;
    uint256 private _previousTaxFee = _XRPReward;
