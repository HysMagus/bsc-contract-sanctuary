...
contract DEAFINANCE is ERC20 {
    ...
    constructor() public {
        uint256 companyFund = 166670e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 100 BNB or more and get 2% more DEA of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 100 BNB or more and get 1% more DEA of round 2
