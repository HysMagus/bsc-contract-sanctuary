...
contract PresaleLockForwarder is Ownable {
    ...
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(0xCE67415e41817a3E9461E2A20281bB80c1820038);
        UNICRYPT_LOCKER = IUniswapV2Locker(0xc8B839b9226965caf1d9fC1551588AaF553a7BE6);
        UNI_FACTORY = IUniswapV2Factory(0xBCfCcbde45cE874adCB698cC183deBcF17952812);
    }
