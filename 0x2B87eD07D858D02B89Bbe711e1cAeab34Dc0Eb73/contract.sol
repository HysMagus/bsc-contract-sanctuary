...
contract GADOSHI is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Molasses';
    string  private constant _SYMBOL = 'MLSS';
    ...
    uint256 private _tTotal = 800000000 * _DECIMALFACTOR;
    ...
    uint256 private _MAX_TX_SIZE = 40000000 * _DECIMALFACTOR;
