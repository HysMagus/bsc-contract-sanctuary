...
contract RFMOON is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'REFLECT MOON';
    string  private constant _SYMBOL = 'RFMOON';
    ...
    uint256 private constant _MAX_TX_SIZE = 210000000 * _DECIMALFACTOR;
