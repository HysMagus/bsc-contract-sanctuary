...
contract MasterChef is Ownable {
    ...
    // Block number when bonus ELEVEN period ends.
    ...
    // Bonus muliplier for early eleven makers.
    ...
    // The block number when ELEVEN mining starts.
    ...
    */
    ...
    constructor(
        ...
        eleven = ElevenToken(0xb8005Dc9a8d48793Ba60b72E10380465f9412c73);
        devaddr = 0x6B3C201575aCe5Ed6B67df5c91E40B98c0D2BE36;
        elevenPerBlock = 237823300000000000;
        startBlock = 5370000;
        bonusEndBlock = startBlock+3504000;
        miningEndBlock = startBlock+10512000;
    ...
    function getMultiplier(uint256 _from, uint256 _to) public view returns (uint256) {
        ...
        if (_from < bonusEndBlock)
            return bonusEndBlock.sub(_from).mul(BONUS_MULTIPLIER).add(miningEndBlock.sub(bonusEndBlock));
        if (_from < miningEndBlock)
            return miningEndBlock.sub(_from);
        return 0;
    }
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number);
        uint256 elevenReward = multiplier.mul(elevenPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        eleven.mint(devaddr, elevenReward.div(10));
        eleven.mint(address(this), elevenReward);
