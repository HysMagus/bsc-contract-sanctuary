/**
MiniStackFloki buy and hodl for stack $Floki. The Floki reflection token with auto-claim future. Simply hold $MiniStackFloki token in your wallet and you will earn $Floki.



What is our main Future : Auto paid every 60 mins  , you dont need to claim $Floki. Its automatically sent to your wallet. Note: it may take longer to claim at a lower Volume.



MiniStackFloki Tokenomics
...
.Buy-Sell Tax : 17-21%
.4% Max wallet
.2% Max sell ( Anti Dump)

Our only official Telegram: https://t.me/MiniStackFloki_official
...
contract MiniStackFloki is ERC20 {

    uint tokenTotalSupply = 4000000000;

    constructor() public ERC20("Mini Stack Floki", "MINISF") {
