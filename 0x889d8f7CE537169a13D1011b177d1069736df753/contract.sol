...
https://t.me/soccerinu
💻 Website:  www.soccerinu.live
...
contract SOCCERINU is Context, IBEP20, Ownable {
  using SafeMath for uint256;
  
  uint256 public _fee = 1;
  uint256 public _feeLiq = 15;
  uint256 public _tokenreflection = 1;
  uint256 public _maxTXPercent = 7**2*2; //Max tax cannot be more than 49% to prevent honeypot
    uint256 public _buybackfee = 0;
  uint256 public _totalfee = 17;
