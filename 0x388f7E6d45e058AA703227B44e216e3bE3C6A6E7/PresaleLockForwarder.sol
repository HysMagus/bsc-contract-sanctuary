...
contract PresaleLockForwarder is Ownable {
    ...
    constructor() public {
        PRESALE_FACTORY = IPresaleFactory(0x593848cFADB16Fe8b13A0A913520b701ed0c8Eec);
        UNICRYPT_LOCKER = IUniswapV2Locker(0x1f23742D882ace96baCE4658e0947cCCc07B6a75);
        UNI_FACTORY = IUniswapV2Factory(0x553990F2CBA90272390f62C5BDb1681fFc899675);
    }
