...
contract TokenNFTTUBE is Context, IERC20, IERC20Metadata, Ownable, Mather  {
	...
	address internal constant PresaleWallet = 0xfA1970b002dD8fAeb450F470b0A7B20547b027D5; 
 
    uint256 public _TaxFee  = 5;
    uint256 public _MarketingFee = 5;
    
    uint256 _PRNTB = 10000000 * 10**18;
    
    
    mapping(address => uint256) private _balances;
    mapping(address => mapping(address => uint256)) private _allowances;
    
    bool private LockedLiquify = false;  //45% of the supply in pancakeswap will be blocked prior to public launch
    uint public LockedLiquifyTime = 182 days;
    ...
    constructor() {
        ...
        _balances[_msgSender()] = _totalSupply;
         ...
         _transfer(_msgSender(), PresaleWallet, _PRNTB); 
         }
