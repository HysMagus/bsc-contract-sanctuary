...
contract DonkeyKongv2 {
    
    uint256 public DonkeyKongFinance_v2 = 2;
    ...
    function getDragonsToBuy(uint256 eth, uint256 multiplier) internal returns(uint256) {
        ...
        ceoEtherBalance += calculatePercentage(msg.value, DonkeyKongFinance_v2);
    ...
    function devFee(uint256 amount) public view returns(uint256) {
        return SafeMath.div(SafeMath.mul(amount, DonkeyKongFinance_v2),100);
    }
    ...
    function sellEggs() public {
        ...
        uint256 fee = calculatePercentage(ethValue, DonkeyKongFinance_v2);
        userReferralEggs[msg.sender] = 0;
        lastHatch[msg.sender]=block.timestamp;
