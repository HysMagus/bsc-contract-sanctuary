...
contract Dechmont_Token {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "Dechmont Token";
    string public symbol = "DXBT";
    uint8 constant public decimals = 8;
    uint256 internal totalSupply_ = 1500000*10**8;
	uint256 internal availabletoken=975000*10**8;
	uint256 internal tokenSupply_ = 0;
	uint256 internal tokenforReferalIncome_ = 0;
	uint256 internal totalNoOfBurntoken_ = 0;
	uint256 public flag_ = 100;
    ...
    uint256 public PurchasecurrentPrice_ = 4600000000000000;    	
    ...
    constructor() 
    {
		 ...
		 owner = sonk;
         tokenSupply_ = 100000*10**8; 
		 tokenforReferalIncome_ = 100000*10**8;
         availabletoken=975000*10**8;
		 flag_ = 100;
         tokenBalanceLedger_[commissionHolder] = 425000*10**8; 
         PurchasecurrentPrice_ = 4600000000000000; //wei per token
		 ...
		 while(saleToken <=_tokens)
           {
               ...
               if(_slotno >0)
               {
					 ...
					 if(flag==0 && tokenSupplyforPrice !=100000)
					 {
