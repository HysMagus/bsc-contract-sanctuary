...
contract BalloonToken is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 100 * 10 ** uint256(_decimals); // Initial supply
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Balloon Token';
    string private constant _symbol = 'BLN';
