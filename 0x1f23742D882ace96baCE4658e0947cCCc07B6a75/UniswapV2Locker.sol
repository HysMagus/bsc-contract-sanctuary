...
// Forked from Ethereum mainnet for Julswap on Binance Smart Chain
// WETH = WBNB
// ETH = BNB

// This contract locks Julswap v2 liquidity tokens. Used to give investors peace of mind a token team has locked liquidity
// and that the univ2 tokens cannot be removed from Julswap until the specified unlock date has been reached.
