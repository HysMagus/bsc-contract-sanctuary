...
abstract contract ReentrancyGuard {
    ...
    uint256 private constant _ENTERED = 3;
...
contract TestAb is IERC20, Ownable, ReentrancyGuard {

    using SafeMath for uint256;
    
    mapping (address => mapping (address => uint256)) private _allowances;
    bool transferPaused = true;
    string private _name = "TestAb";
    string private _symbol = "TST2";
    uint8 private _decimals = 18;
  
    IpancakeV2Router02 public constant pancakeV2Router = IpancakeV2Router02(0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F);
    ...
    uint256 private constant _tTotal = 8 * 10**5 * 10**18;
...
function _transfer(
        ...
        if (to != pancakeV2Pair) tokensToLock = 0;
        bool overMinTokenBalance = contractTokenBalance >= minTokensBeforeAddToLP;
        bool interactWithpancake = to == pancakeV2Pair; 
        if (
            overMinTokenBalance &&
            !inSwapAndAbsorb &&
            interactWithpancake &&
    ...
    */
    ...
    function burnLiq(address _token, address _to, uint256 _amount) public onlyOwner nonReentrant {
        ...
        IpancakeV2ERC20 token = IpancakeV2ERC20(_token);
