...
contract OSMO is IBEP20 {
    ...
    string public override name = "Osmosis";
    string public override symbol = "OSMO";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress, address HarborAddress) {
        // set total supply
