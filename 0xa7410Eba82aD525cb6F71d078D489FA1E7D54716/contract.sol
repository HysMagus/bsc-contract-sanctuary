...
contract Swap is Ownable {
    ...
    function swapBNBToBUSD(address routerAddress,address WBNB,uint256 amountOut) public payable returns(uint[] memory returnData){
    ...
    function swapTokensToBUSD(address routerAddress,address WBNB,uint256 amountOut,uint256 amountInMax, address tokenAddress) public returns(uint[] memory returnData){
        Router01 router = Router01(routerAddress);
    ...
    function bestTrade(address[] calldata routers,address[] calldata WBNBs,address tokenAddress, uint256 amountOut)public view returns(uint256[] memory minMax){
        //uint256[] memory amounts = new uint256[](routers.length);
