...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    address public earnedAddress;   //Token to pay for user: CakeToken, ...
    ...
    constructor() public {
        ...
        address _govAddress = 0x15291c2A57C7EeCF752866Ef3fb941912D5ec70f;
        address _autoFarmAddress = 0x87cDFB53eb40e6f17072fee529C038409Ca94140;
        address _autoTokenAddress = 0xc875C3dA749faf27bf804E75aD4beEbdADdfd931;
        
        //Should be changed before deploying
        uint256 _pid = 1;       //Pid of Pancake WBNB-CAKE Pair
        address _farmContractAddress = 0x73feaa1eE314F8c655E354234017bE2193C9E24E; //Pancake MasterChef, should be changed when changing farm nanme
        bool _isCAKEStaking = false;
        address _earnedTokenAddress = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;  //CAKE token will be rewarded
        address _poolRouter = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;          //PancakeRouter
        address _pairAddress = 0xA527a61703D82139F8a06Bc30097cC9CAA2df5A6;
        address _token0Address = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        address _token1Address = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        
        //Set govAddress = timelock address
        govAddress = _govAddress;
        //AutoFarm address
        autoFarmAddress = _autoFarmAddress;
        //AutoToken address
        AUTOAddress = _autoTokenAddress;                                     

        isCAKEStaking = _isCAKEStaking;
        isAutoComp = true;
        //Pair address between two token
        wantAddress = _pairAddress;       //WBNB-CAKE Pancake LPs

        if (isAutoComp) {
            if (!isCAKEStaking) {
                token0Address = _token0Address;     //CAKE
                token1Address = _token1Address;     //WBNB
            }

            farmContractAddress = _farmContractAddress;   //Pancake MasterChef
            pid = _pid;
            
            //Token to reward
            earnedAddress = _earnedTokenAddress;
            uniRouterAddress = _poolRouter;      //Panckae router
