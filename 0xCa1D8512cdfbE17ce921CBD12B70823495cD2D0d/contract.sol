...
contract JGNE is ERC1155Tradable {
	constructor() public ERC1155Tradable("BSC Genesis Collection", "JGNB") {
		_setBaseMetadataURI("https://draw2.jgndefiapi.com/api4/");
	}

	function contractURI() public view returns (string memory) {
		return "https://draw2.jgndefiapi.com/api4/contract/jgn";
	}
}