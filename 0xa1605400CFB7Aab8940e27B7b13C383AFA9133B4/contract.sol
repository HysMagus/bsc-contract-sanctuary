...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 360; // 360 epochs
    uint256 private constant BOOTSTRAPPING_PRICE = 122e16; // 1.22 BUSD
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e6; // 100 EQD -> 100M EQD-S
    ...
    uint256 private constant EPOCH_START = 1610935200; //
    uint256 private constant EPOCH_PERIOD = 3600;

    /* Governance */
    uint256 private constant GOVERNANCE_PERIOD = 20;
    uint256 private constant GOVERNANCE_QUORUM = 43e16; // 43%
    uint256 private constant GOVERNANCE_SUPER_MAJORITY = 56e16; // 56%
    uint256 private constant GOVERNANCE_EMERGENCY_DELAY = 6; // 6 epochs

    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 2e18; // 2 EQD
    uint256 private constant DAO_EXIT_LOCKUP_EPOCHS = 30; // 30 epochs fluid

    /* Pool */
    uint256 private constant POOL_EXIT_LOCKUP_EPOCHS = 10; // 10 epochs fluid
...
contract Dollar is IDollar, MinterRole, ERC20Detailed, Permittable, ERC20Burnable  {
    ...
    constructor()
    ERC20Detailed("Equilibrium Dollar Protocol", "EQD", 18)
    Permittable()
    public
    { }
