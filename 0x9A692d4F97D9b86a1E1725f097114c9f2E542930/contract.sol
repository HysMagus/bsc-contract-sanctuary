...
/**
 * @title IMPACT price Oracle
 *      This Oracle calculates the average USD price of IMPACT based on the BNB-IMPACT and USDC-BNB pools.
...
contract MarketOracle is Ownable {
    ...
    constructor(
        address __IMPACT_bnb,   // Address of the IMPACT-BNB pair on Pancakeswap
