...
contract FACstaking is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    // FAC Token Contract Address
    address public constant tokenAddress = 0x6ce11E61E1b2C466c21022D0dF8141a33CB7A840;
    
    // reward rate 9.00% per year
    uint public constant rewardRate = 900;
    ...
    uint private constant stakingAndDaoTokens = 2500e18;   // 2,500 FAC will be staked by owner
