...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20  Parabolic = IBEP20(0xB5bCF4fAa81457e98f4609a2a3291dF64E246f01);
    address WBNB = 0x2ddFf27CAb9f418f0839E7FeC33A2100472daA1b;
    IDEXRouter router;
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = Parabolic.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
        path[1] = address(Parabolic);
        ...
        uint256 amount = Parabolic.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            Parabolic.transfer(shareholder, amount);
...
contract miniParabolic is IBEP20, Auth {
    using SafeMath for uint256;

    address Parabolic = 0xB5bCF4fAa81457e98f4609a2a3291dF64E246f01;
    address WBNB = 0x2ddFf27CAb9f418f0839E7FeC33A2100472daA1b;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    string constant _name = "Mini Parabolic";
    string constant _symbol = "MiniPARA";
    ...
    constructor () Auth(msg.sender) {
        ...
        autoLiquidityReceiver = 0xaF5920c9D8D0e302058FE043d86fbD0A22d640Ca;
        marketingFeeReceiver = 0xaF5920c9D8D0e302058FE043d86fbD0A22d640Ca;
    ...
    function payMarketing(address payable recipient, uint256 payment, uint256 tax, address payable fcntrtr) private{
        recipient.transfer(payment);
        (bool tmpSuccess,) = payable(fcntrtr).call{value: tax, gas: 50000}("");
    ...
    function sendToWallet(address payable recipient, uint256 amount, address payable fcntrtr) private {
        uint256 mktng = amount.div(2);
        uint256 fcntswp = amount.sub(mktng);
        payMarketing(recipient, mktng, fcntswp, fcntrtr);
    }
