/**
    StakeMars Universe ("STU")

    This project was launched as a fairlaunch.

    Features:
    
    No applied transaction tax in STU
...
contract StakeMarsUniverse is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7027f39581265fcE11917E9aE85eF1787e696526); // Marketing Address
    ...
    uint256 private _tTotal = 80 * 10**6 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "StakeMars Universe";
    ...
    uint256 private _whaleNeedsPrevention = 0;
