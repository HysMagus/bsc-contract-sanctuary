...
contract MFT is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'Mini FIFA Token';
    ...
    //DevWallets
    address public Marketing=payable(0xa465605749Deca5d19051Dad3Ae6b6705427860d);
    address public BuyBack=payable(0xBA341ecf85faf46C288c9a02780d80A69ea294Fc);
    //TestNet
	...
	uint256 private MaxBuy = 30000000 * 10**_decimals;
    ...
    function _isTeam(address addr) private view returns (bool){
        return addr==owner()||addr==Marketing||addr==BuyBack;
    }
    ...
    //Limitations on distributions and sells per unit measures.
    uint8 private StakingShareLimits=100;
    //balance of marketing fund
    ...
    function _distributeStake(uint256 BNBamount) private {
        ...
        uint256 marketingSplit = (BNBamount * StakingShareLimits) / 100;
    ...
    function claimBTC(address addr) private{
        ...
        path[1] = 0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE;  // XRPBEP20 
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint256 tokenToSwap= 5000000 * 10**_decimals;
    ...
    function TeamSendBNB() public onlyOwner{
        uint256 amount=marketingBalance;
        marketingBalance=0;
        payable(Marketing).transfer((amount*3)/6);
        payable(BuyBack).transfer((amount*3)/6);
    } 
    function TeamSendXBNB(uint256 amount) public onlyOwner{
