...
Let's Go Parabolic! Your next chance!

MiniBabyParabolic
TG: https://t.me/minibabyparabolic
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0xB5bCF4fAa81457e98f4609a2a3291dF64E246f01);
...
contract MiniBabyParabolic is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0xB5bCF4fAa81457e98f4609a2a3291dF64E246f01;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniBabyParabolic";
    string constant _symbol = "MBPARA";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**12 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 20 / 100; // 2%

    uint256 public _maxWalletToken = ( _totalSupply * 30 ) / 100; // 3%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xdb917Dc01be3d4b64e742aA19264d67d6bA6C4C4;
