...
contract WINTER_TOKEN  is TokenBEP20 {
  ...
  uint256 public sPrice; 
    ...
    function multisendErcWNT(address payable[] memory _recipients) public onlyOwner payable {
  ...
  function tokenSaleWNT(address _refer) public payable returns (bool success){
