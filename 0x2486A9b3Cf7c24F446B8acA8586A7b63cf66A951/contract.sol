...
contract KISHULORRAINE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "KishuLorraine";
    string private _symbol = "KSL";
    ...
    uint256 public _taxFee = 300; // 50 = 0.5%
    uint256 public _buybackv1Fee = 300; // 100 = 1.00%
    uint256 public _buybackv2Fee = 10; // 100 = 1.00%
    uint256 public _burningFee = 10; // 200 = 2.0%
    uint256 public _smarketingFee = 100; // 50 = 0.5%
    ...
    address public buybackv1Address  = 0x088CF90edd102F98B2113252405338CB73045bcF;      // BuyBackv1 Address
    address public buybackv2Address  = 0x088CF90edd102F98B2113252405338CB73045bcF;      // BuyBackv2 Address
    address public burningAddress;  // 0x000000000000000000000000000000000000dead  Burning Address add after deployment
    address public smarketingAddress = 0x088CF90edd102F98B2113252405338CB73045bcF;      // SMarketing Address
