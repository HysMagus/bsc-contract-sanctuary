...
contract CelestialProject is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Celestial Shard';
    string  private constant _SYMBOL = 'SHARD';
    ...
    uint256 private _tTotal = 50000 * _DECIMALFACTOR;
