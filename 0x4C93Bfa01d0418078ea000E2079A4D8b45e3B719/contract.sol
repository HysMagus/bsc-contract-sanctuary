...
/*
BNB REWARDS AND POOP'S NFT! 💸

Hold POOP IT UP TOKEN and earn passive income paid in $BNB 🤑

It's not all ! Hold POOP IT UP TOKEN and participate in random drops to maybe receive POOP'S NFT 💩

First BSC GEM 💎 to offer this!

#POOPARMY ARE YOU READY 🔥? 

💩POOP IT UP on the BSC 💩
Supply: 100 000 000 000 🚀

💩We are proud to announce the launch of our  token 💩
🚀Our ambition ? One of the biggest and first memecoin in the crypto space, POOP ARMY ! 

Nobody assumes they are a shitcoin! 💩
Here we assume!
Welcome to Poop It Up🌟

With us you have the guarantee of:
- A fairlaunch
- No Dev Wallet 🤑
- No rug pull 👿
- Liquidity locked 🔒
- SC audits by professional team ✅
- Anti whale / Anti Bot at Launch ✅
- 7% BNB Reward  ✅
-Marketing plan ✅
-POOP NFT still ready for Random airdrop 
...
contract Poopitup is ERC20, Ownable {
    ...
    constructor() ERC20("PoopItUp", "PIU") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function set_enablerewardsfee(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
        


        function set_percentage_Marketing_fee(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function liquidityfee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        ...
        function setNFactor(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
