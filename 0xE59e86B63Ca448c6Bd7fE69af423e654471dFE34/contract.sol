...
contract Presale {
    ...
    uint percentSell = 85;              // 85,000 token presale
    uint256 pricePresale = 1;           // 0.10 BNB PER
    uint256 multiplierPresale = 250;     // change to multiply above price rate
