...
contract Consts {
    ...
    string public constant TOKEN_NAME = "TestCrowdSaleMain";
    string public constant TOKEN_SYMBOL = "TCSM";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x3bcef10ca91582D40d903C9674Af96b69709b620;
    
    uint public constant START_TIME = 1615082452;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[4] memory weiRaisedStartsBounds = [uint(0),uint(500000000000000000),uint(0),uint(0)];
        uint[4] memory weiRaisedEndsBounds = [uint(500000000000000000),uint(1000000000000000000),uint(10000000000000000000000),uint(10000000000000000000000)];
        uint64[4] memory timeStartsBounds = [uint64(1615082452),uint64(1615082452),uint64(1615082452),uint64(1615237200)];
        uint64[4] memory timeEndsBounds = [uint64(1617825647),uint64(1617825647),uint64(1615237200),uint64(1615323600)];
        uint[4] memory weiRaisedAndTimeRates = [uint(500),uint(250),uint(500),uint(300)];
        ...
        // apply amount
        uint[2] memory weiAmountBounds = [uint(20000000000000000000),uint(10000000000000000000)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(1000 * TOKEN_DECIMAL_MULTIPLIER, 0x425ec29C0a00EB699a11cA7d789Da7a274E62080, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1617825652)
        CappedCrowdsale(10000000000000000000000)
        
        RefundableCrowdsale(100000000000000000)
        ...
        internal
    {
        ...
        require(msg.value <= 42000000000000000000);
