...
contract BrickTokenLock {
    ...
    uint256 public oneHour = 60;        // in seconds
    ...
    //Increase lock duration in hours
    function increaseLockInHours(uint256 _numberOfHours) public onlyOwner {
        uint256 _increaseLockHours = _numberOfHours.mul(oneHour);
        currentLockTimer = currentLockTimer.add(_increaseLockHours);
    }

    //Increase lock duration in days
    function increaseLockInDays(uint256 _numberOfDays) public onlyOwner {
