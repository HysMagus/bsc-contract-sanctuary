...
contract Owned {
    ...
    constructor()  {
        owner = 0xB2AF25ecFcD2f5e6BD6Df55b0705E27Eac2c993b;
    }
...
contract SourSopNetwork is IERC20, Owned, SafeMath {
 ...
 constructor() {
        symbol = "SOURS";
        name = "SourSop Network";
        decimals = 18;
        _totalSupply = 10000000e18;         // 188,000 SOURS
        address owner = owner;
