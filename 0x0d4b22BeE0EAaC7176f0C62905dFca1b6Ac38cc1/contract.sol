...
contract DfMaxiFarm is Ownable, ReentrancyGuard, Pausable, Initializable {
    ...
    address public constant firstAddress = 0x55d398326f99059fF775485246999027B3197955; //USDT
    address public constant secondAddress = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; // WBNB
    address public constant vFirstAddress = 0xfD5840Cd36d94D7229439859C0112a4185BC0255; // Venus USDT
    ...
    uint256 constant activePool = 17;
    ...
    function initialize() public initializer {
        ...
        usdtToBnbPath = [firstAddress, secondAddress];
    ...
    returns (uint256 _secNeeded, uint256 _maxBorrowSec)
    {
        ...
        require(address(pair.token1()) == secondAddress); // USDT!!!
        _secNeeded = poolBUSD.mul(reserve1).div(reserve0);
    ...
    returns (uint256 userTotalRecv, uint256 totalBnbToRepay, uint256 amountBNB, uint256 amountBUSD)
    {
        ...
        if (totalBnbToRepay > amountBNB) {
            IPancakeRouter02(uniRouterAddress).swapTokensForExactTokens(totalBnbToRepay - amountBNB, amountBUSD, usdtToBnbPath, address(this), now.add(600));
        } else {
