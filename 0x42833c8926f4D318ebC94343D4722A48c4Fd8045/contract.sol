/**
 * 
CoviCoin is an Altcoin on the Binance Smart Chain, built as an alternative currency for global healthcare. Alongside Project X, a unified global framework for healthcare systems, CoviCoin will answer some of the most deep rooted issues that have been plaguing the sector in recent times.

By progressing through several planned milestones, CoviCoin is slated to become a globally recognised and adopted healthcare currency by 2024.

Key Highlights
🌐 Principal currency of a global healthcare framework
💵 Reflection in BUSD, among other investor-centric tokenomics
👨 Fully doxxed key founders

Become an early holder today, and join us in this journey of bringing about unprecedented fairness and transparency to the world of healthcare. 
*/
...
contract CVC is Context, IERC20, Ownable {
