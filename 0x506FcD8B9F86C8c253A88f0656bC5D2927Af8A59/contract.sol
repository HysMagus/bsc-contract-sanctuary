/**
 * FAIR LAUNCH ON SUNDAY 03-10-2021 20h00 UTC *


 * Telegram: https://t.me/AdaSaurus *
...
// CHANGE
contract AdaSaurus is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "AdaSaurus";
    string constant _symbol = "AdaSaurus";
    ...
    uint256 reflectionFee = 400; // 5%
    uint256 devFee = 800; // 4%
