...
contract SharPei is Context, IERC20, Ownable {
    ...
    string private _name = "SharPeiToken";
    string private _symbol = "SRP";
    ...
    address public marketingwallet = 0x3e2654A591E185f9d368e87997b2B9416A0EA8b0;
    ...
    function setmarketingyFeePercent(uint256 marketingFee) external onlyOwner() {
