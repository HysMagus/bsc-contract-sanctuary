...
contract KishuSushi is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address REWARDCOIN = 0x947950BcC74888a40Ffa2593C5798F11Fc9124C4;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "KishuSushi";
    string constant _symbol = "$KISHUSUSHI";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 10000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = (_totalSupply * 20) / 1000; // 2% Max TX
    uint256 public _maxWalletSize = (_totalSupply * 40) / 1000; // 4% Max Hold
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x2B4Efa2C74C48937909C20fd1aE229C0B6F3aD71);
