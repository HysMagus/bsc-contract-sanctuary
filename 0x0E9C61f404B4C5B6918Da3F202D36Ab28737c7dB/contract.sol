...
contract Master is Ownable {
    ...
    ISafebet public safebet;

    // Market oracle provides the SAFEBET/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _safebet) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = safebet.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && safebet.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(safebet.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return safebet.totalSupply().toInt256Safe()
