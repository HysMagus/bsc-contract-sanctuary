...
contract mobile is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    using TransferHelper for address;

    string private _name = 'mobile';
    string private _symbol = 'mobile';
    ...
    constructor() public {
        ...
        address _owner = 0xea96F4874c76F4b4Ea80CC8D4364a9B1712A52a8;
