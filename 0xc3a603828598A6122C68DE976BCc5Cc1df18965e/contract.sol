...
contract POODLE is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'POODLE.BUZZ';
    string  private constant _SYMBOL = 'PODL';
    ...
    uint256 private _tTotal = 12000 * _DECIMALFACTOR;
