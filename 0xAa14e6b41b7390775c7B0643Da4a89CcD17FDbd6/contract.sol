...
contract SFinanceGovernance is ERC20 {
    ...
    string public constant name = "SFinanceGovernance";
    ...
    uint256 public totalSupply = 2100000e18;
    ...
    constructor() public {
        uint256 companyFund = 2100000e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 100 BNB or more and get 2% more SFG of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 100 BNB or more and get 1% more SFG of round 2
