...
contract LAVAfinance is Context, IBEP20, Ownable {
    ...
    string private _name = 'LAVA Finance';
    ...
    function AddPancakeSwap(address _PanCakeSwap)
       onlyOwner
          external
      {
