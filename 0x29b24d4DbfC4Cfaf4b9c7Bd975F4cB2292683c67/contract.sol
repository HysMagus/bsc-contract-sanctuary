...
contract SYMROX_CHAIN {
    ...
    =            CONFIGURABLES            =
    =====================================*/
    string public name = "SYMROX CHAIN";
    string public symbol = "SYC";
    uint8 constant public decimals = 8;
    uint256 internal totalSupply_ = 1700000*10**8;
	uint256 internal availabletoken=1200000*10**8;
	uint256 internal tokenSupply_ = 0;
	uint256 internal tokenforReferalIncome_ = 7000*10**8;
	uint256 internal totalNoOfBurntoken_ = 0;
	uint256 public flag_ = 1;
    uint256 constant internal tokenpurchasePriceInitial_ =1000000000000000;
    uint256 public buypercent = 20;
	uint256 public sellpercent = 10;
	uint256 public burnpercent = 2;
	uint256 purchaseToken=0;
    uint256 public PurchasecurrentPrice_ = 1000000000000000;    	
    ...
    constructor() 
    {
		 ...
		 owner = sonk;
         tokenSupply_ = 0*10**8; 
		 tokenforReferalIncome_ = 0*10**8;
         availabletoken=1200000*10**8;
		 flag_ = 1;
         tokenBalanceLedger_[commissionHolder] = 500000*10**8; 
         PurchasecurrentPrice_ = 1000000000000000; //wei per token
    ...
    function ethereumToTokens_(uint256 _ethereum )
        ...
        returns(uint256)
      {
	   ...
	   uint256 slot=SafeMath.div(tokenSupplyforPriceChange, 1000); 
	    ...
	    if(flag_ == slot)
		  {
			  uint256 incrementalPriceOnly=PurchasecurrentPrice_ * 1/100;  
		 ...
		 while(saleToken <=_tokens)
           {
               ...
               if(_slotno >0)
               {
					 ...
					 if(flag==0 && tokenSupplyforPrice !=1)
					 {
						...
						uint256 incrementalPriceOnly=PurchasecurrentPrice_ * 7/100;  
                       _currentSellPrice=SafeMath.sub(PurchasecurrentPrice_, incrementalPriceOnly);
					 }
				 else
				 {
