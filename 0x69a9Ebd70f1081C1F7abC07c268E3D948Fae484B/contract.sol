...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAfiComp= false; // this vault is purely for staking. eg. WBNB-AFI staking vault.

    address public constant farmContractAddress = 0x73feaa1eE314F8c655E354234017bE2193C9E24E; // address of farm, eg, PCS, Thugs etc.
    uint256 public constant pid = 16; // pid of pool in farmContractAddress
    address public constant wantAddress = 0x19e7cbECDD23A16DfA5573dF54d98F7CaAE03019;//EGG-BUSD LP
    address public constant token0Address= 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    address public constant token1Address= 0xF952Fc3ca7325Cc27D15885d37117676d25BfdA6;
