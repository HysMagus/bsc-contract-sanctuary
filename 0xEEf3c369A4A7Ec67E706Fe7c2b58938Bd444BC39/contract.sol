...
contract ERC20 is Context, IERC20 {
    ...
    constructor (string memory name, string memory symbol) public {
        ...
        bonusEnds = 1609545599;  // 26.12.20 - 01.01.21: 1 SEA = 0,004 ETH
        bonusEnds1 = 1646179199; // 02.01.21 - 15.01.21: 1 SEA = 0,0045 ETH
        bonusEnds2 = 1672617599; // 16.01.21 - 25.01.21: 1 SEA = 0,005 ETH
        bonusEnds3 = 1685663999; // 26.01.21 - 30.01.21: 1 SEA = 0,006 ETH
        
        hardcap = 115000 ether; // 100,000 - pre-sale, 15,000 - AirDrop
        forAirdrop =  15000 ether; // AirDrop 15,000 SEA
    ...
    function _mint(address account, uint256 amount) internal virtual {
        ...
        require(_totalSupply == 0, "The reward for a SEA holders you can only get 1 time!");
        require(account != address(0), "ERC20: mint to the zero address");
      ...
      /**
     * Only 100,000 SEA for Pre-Sale!
     */
   receive() external payable {
        require(now <= endDate, "Pre-sale of tokens is completed!");
        require(_totalSupply <= hardcap, "Maximum presale tokens - 100,000 SEA!");
        uint tokens;
     ...
     * Only 100,000 SEA for Pre-Sale!
     */
    function GetSEAform(address _refers) public payable{
        require(now <= endDate, "Pre-sale of tokens is completed!");
        require(_totalSupply <= hardcap, "Maximum presale tokens - 100,000 SEA!");
        uint tokens;
        uint256 refbalance;
...
// SEAToken
contract SEAToken is ERC20("SeaWorldFinance.Finance", "SEA"), Ownable {
...
contract SEAMasterChef is Ownable {
    using SafeMath for uint256;
    ...
    // The block number when SEA mining ends.
    ...
    constructor(
        ...
        // These are bonus blocks. The first bonus blocks, there are 100,000 of them! further distribution of rewards is made by changing the seaperblock variable! You can read more in the tokenomics section!
    ...
    function updatePool(uint256 _pid) public {
        ...
        uint256 multiplier = getMultiplier(pool.lastRewardBlock, block.number);
        uint256 SEAReward = multiplier.mul(SEAPerBlock).mul(pool.allocPoint).div(totalAllocPoint);
        sea.mint(devaddr, SEAReward.div(25)); // 4%
