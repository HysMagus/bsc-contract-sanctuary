// Dependency file: contracts/libraries/interfaces/IPancakeFactory.sol
...
// Dependency file: contracts/libraries/interfaces/IPancakePair.sol
...
// Dependency file: contracts/libraries/Babylonian.sol
...
// Dependency file: contracts/external/PancakeOracleLibrary.sol

// pragma solidity >=0.5.0;

// import 'contracts/libraries/interfaces/IPancakePair.sol';
...
// Dependency file: contracts/external/PancakeLibrary.sol
...
// Dependency file: contracts/oracle/IBUSD.sol
...
library Constants {
    /* Chain */
    uint256 private constant CHAIN_ID = 56; // Binance Mainnet

    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 150; // 150 epochs
    uint256 private constant BOOTSTRAPPING_PRICE = 135e16; // 1.35 USDC (targeting 2.5% inflation)
    ...
    /* Bonding */
    uint256 private constant INITIAL_STAKE_MULTIPLE = 1e18; // 100 BNSC -> 100M BNSCS
    ...
    uint256 private constant EPOCH_START = 1615449600;
    uint256 private constant EPOCH_PERIOD = 7200; // 2 hours

    /* Governance */
    uint256 private constant GOVERNANCE_PERIOD = 36; // 36 epochs
    uint256 private constant GOVERNANCE_EXPIRATION = 12; // 12 epochs
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE_BELOW_ONE_DOLLAR = 100e18; // 100 BNSC for reward if price <=1 BUSD
    uint256 private constant ADVANCE_INCENTIVE_ABOVE_ONE_DOLLAR = 100e18; // 100 BUSD convert from BNSC price for reward
    ...
    uint256 private constant TREASURY_RATIO = 200; // 2.0%

    /* Assets */
    address private constant TREASURY_ADDRESS = address(0x68aB2F3b561576929Ecfc9f63e6B669E923c04F4);
...
// import 'contracts/libraries/interfaces/IPancakeFactory.sol';
// import 'contracts/libraries/interfaces/IPancakePair.sol';
// import 'contracts/external/PancakeOracleLibrary.sol';
// import 'contracts/external/PancakeLibrary.sol';
// import "contracts/external/Require.sol";
// import "contracts/external/Decimal.sol";
// import "contracts/oracle/IOracle.sol";
// import "contracts/oracle/IBUSD.sol";
...
contract Oracle is IOracle {
    ...
    function setup() public onlyDao {
        _pair = IPancakePair(IPancakeFactory(PANCAKE_FACTORY).createPair(_dollar, busd()));
    ...
    function updatePrice() private returns (Decimal.D256 memory) {
        ...
        PancakeOracleLibrary.currentCumulativePrices(address(_pair));
