...
contract RewardDividendTracker is DividendPayingToken {
    ...
    constructor(address token) DividendPayingToken("HonestCakeScamReward_Dividend_Tracker", "HonestCakeScamReward_Dividend_Tracker") {
        claimWait = 1800;
    ...
    function _transfer(address, address, uint256) pure internal override {
        require(false, "HonestCakeScamReward_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "HonestCakeScamReward_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main HonestCakeScamReward contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOperator {
        require(newClaimWait >= 1800 && newClaimWait <= 86400, "HonestCakeScamReward_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "HonestCakeScamReward_Dividend_Tracker: Cannot update claimWait to same value");
...
contract HonestCakeScam is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    address public marketingWallet = 0x4C6A0a7b4C8Af24aa22B1E2e6c6a584c987ebBbb;
    ...
    constructor() ERC20("HonestCakeScam", "HonestCakeScam") {
