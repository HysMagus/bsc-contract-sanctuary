...
contract Configurable {
    uint256 public constant presale1 = 50000*10**18;
    uint256 public constant presale1Price = 100*10**18; // tokens per 1 ether
    uint256 public tokensSold1 = 0;
    uint256 public constant presale2 = 30000*10**18;
    uint256 public constant presale2Price = 80*10**18; // tokens per 1 ether
    uint256 public tokensSold2 = 0;
    uint256 public constant presale3 = 15000*10**18;
    uint256 public constant presale3Price = 60*10**18; // tokens per 1 ether
    uint256 public tokensSold3 = 0;
    uint256 public constant tokenReserve = 55000*10**18;
    uint256 public remainingTokens1 = 0;
    uint256 public remainingTokens2 = 0;
    uint256 public remainingTokens3 = 0;
}
/**
 * @title JellyPearFinance
 * @dev Contract to preform crowd sale with token
 **/
contract JellyPearFinance is StandardToken, Configurable, Ownable {
    /**
...
/**
 * @title jellypearfinance
 * @dev Contract to create the jellypearfinance
 **/
contract jellypearfinance is JellyPearFinance{
    string public constant name = "JellyPear Finance";
    string public constant symbol = "PEAR";
