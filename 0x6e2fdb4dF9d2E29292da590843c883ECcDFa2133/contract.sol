...
abstract contract ERC20Permit is ERC20 {
    ...
    function chainID() public virtual view returns (uint256 _chainID) {
        assembly {
            _chainID := chainid()
        }
    }
...
// File: contracts/TWT.sol

pragma solidity ^0.6.12;
pragma experimental ABIEncoderV2;

contract TrustWalletToken is ERC20("Trust Wallet", "TWT"), ERC20Permit, Ownable {
