...
//Just launched in $OnlyUP2. We have created a token so rewarding for everyone.
//OnlyUP2 Hold we will Tothemoon
//Tg : t.me/OnlyUP2
...
contract OnlyUP2 is Context, IERC20, Ownable {
    ...
    string private _name = "ONLY UP2";
    string private _symbol = "OnlyUP2";
