...
contract JuggerDRAW is ERC1155Tradable {
	constructor() public ERC1155Tradable("JuggerDRAW", "DRAW") {
		_setBaseMetadataURI("http://54.196.227.217/api/");
	}

	function contractURI() public view returns (string memory) {
		return "http://54.196.227.217/api/contract/jgn";
	}
}