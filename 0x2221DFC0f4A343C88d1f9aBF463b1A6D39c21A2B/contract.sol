/**
 ...
 | |   | | __| __| |/ _ \ ' /| / __| '_ \| | | |
 | |___| | |_| |_| |  __/ . \| \__ \ | | | |_| |
 |_____|_|\__|\__|_|\___|_|\_\_|___/_| |_|\__,_|
                                                
 
 Missed out on $MINIKISHU? make sure you don't miss out on LittleKishu, we'll take you to the moon
 join our official telegram @littlekishuofficial                                                                                           
*/
...
// CHANGE
contract LittleKishu is IERC20, Ownable {
    using SafeMath for uint256;
    ...
    string constant _name = "LittleKishu";
    string constant _symbol = "LITTLEKISHU";
