...
contract YIELD is ERC20 {
    ...
    string public constant name = "YIELD";
    ...
    uint256 public totalSupply = 5e18;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 10000 BNB or more and get 2% more YIELD of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 10000 BNB or more and get 1% more YIELD of round 2
