...
contract BeeToken is Context, IBEP20, Ownable {
    ...
    // mint 5k BEEs to the Admin Account, will be used to provide liquidity, what is not needed will get burned with time.
    constructor () public {
        _mint(_msgSender(), 5000 * 10 ** uint256(_decimals));
    }
