...
// File: contracts/BIFI/strategies/Thugs/StrategyHoesBurnOnTransfer.sol
...
/**
 * @dev Implementation of a strategy to get yields from farming a {hoes} pool + base {drugs} farming. This is a modification
 * of the base strat, designed to work with burn on transfer tokens like bTRI.
 *
 ...
 */
contract StrategyHoesBurnOnTransfer is Ownable, Pausable {
    ...
    function chargeFees() internal {
        ...
        IUniswapRouter(unirouter).swapExactTokensForTokensSupportingFeeOnTransferTokens(toWbnb, 0, outputToWbnbRoute, address(this), now.add(600));
    ...
    function swapRewards() internal {
        ...
        IUniswapRouter(unirouter).swapExactTokensForTokensSupportingFeeOnTransferTokens(outputBal, 0, outputToDrugsRoute, address(this), now.add(600));
    }
