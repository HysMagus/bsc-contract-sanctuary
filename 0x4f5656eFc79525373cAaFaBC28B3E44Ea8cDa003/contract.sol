...
/*
SAFE GELADA - The next generation ecological Defi token with a purpose of protection.

Get ready for a straight MOON-MISSION 

This token will be the backbone of an exclusive NFT marketplace!

Gelada, a yield-generating social cryptocurrency. Members of the SAFE GELADA ecosystem earn $SEGA by holding SAFE GELADA Tokens. SAFE GELADA wants to be the first truly community-run charity organization and believes that the diversity will make it an eccentric and truly one of a kind project in the world. 

Tokenomics

Token Name : Safe Gelada
Symbol : SEGA
Supply : 1 Trillion
Network : BSC
...
There is a tax of 11% : 

✔️5% Reflection to Holders.
✔️3% Liquidity Pool.
✔️3% Marketing  and Charity

Official links:

Telegram : https://t.me/SafeGelada
Website : https://safegelada.com
Twitter : https://twitter.com/safegelada
Discord : https://discord.gg/g4u62f3Xç
*/
...
contract SafeGelada is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("Safe Gelada", "SEGA") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function Rewards(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
        


        function set_enableMarketing_fee(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function enableLiquidityfee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function setEnablebuy_fee(uint256 value) external onlyOwner {
            buyFee = value;
        }
