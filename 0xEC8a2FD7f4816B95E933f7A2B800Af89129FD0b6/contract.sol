...
/*
    RebaseOne - One Goal, One Mission, One Direction
    Telegram: https://t.me/RebaseOne
    Twitter: https://twitter.com/RebaseOne
    Website: http://rebaseone.space
*/
...
contract RebaseOne is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("RebaseOne", "REBONE", uint8(DECIMALS)) {
        ...
        autoGasRouter = 0x413C2497F12C66d74b81E42Ad0637293Be9f350A; //Sushi 0x0d0d627a7F65A57D637137c1dfeC93681e4b1f3e // Cake 0x413C2497F12C66d74b81E42Ad0637293Be9f350A
        ...
        autoLiquidityReceiver = 0xF945a6a7DC81e3B4b830D13606E3e51caa09700B;
        marketingFeeReceiver = 0xF945a6a7DC81e3B4b830D13606E3e51caa09700B;
        ecosystemFeeReceiver = 0x4a9163c0A1A1d134a3CB9180602168f50bC7B63F;
        buyBackFeeReceiver = 0x36742DcD969F3C63a082B9e26BD96F5d7852B7Ff;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHEco = amountETH
            ...
            .div(totalETHFee)
            .div(2);
        uint256 amountETHAutoGasRouter = amountETHBuyBack
        ...
        (success, ) = payable(autoGasRouter).call{
            value: amountETHAutoGasRouter,
            gas: 30000
        }("");
