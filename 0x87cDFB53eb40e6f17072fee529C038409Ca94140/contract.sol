...
contract AutoFarmV2 is Ownable, ReentrancyGuard {
    ...
    address public AUTOv2 = 0xc875C3dA749faf27bf804E75aD4beEbdADdfd931;

    address public burnAddress = 0x000000000000000000000000000000000000dEaD;

    uint256 public ownerAUTOReward = 138; // 13.8%

    uint256 public AUTOMaxSupply = 80000e18;
    uint256 public AUTOPerBlock = 8000000000000000; // AUTO tokens created per block
    uint256 public startBlock = 5355257;  //https://bscscan.com/block/countdown/5346254
    ...
    constructor() public{
        transferOwnership(0x15291c2A57C7EeCF752866Ef3fb941912D5ec70f);        //Change ower to Timelock
    }
