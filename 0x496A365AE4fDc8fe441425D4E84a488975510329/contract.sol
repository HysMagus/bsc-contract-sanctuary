/**
 * Let's get this dot rolling. Hodlers gets POLKADOT rewards.
 */
...
contract PumpDot is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    PumpDotDividendTracker public dividendTracker;
    ...
    address public _marketingWalletAddress = 0x74F5c83dbAec4a787F378d3bd3cD4D8F6592F16a;
    ...
    constructor() public ERC20("PumpDot", "PDOT") {

    dividendTracker = new PumpDotDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        ...
        PumpDotDividendTracker newDividendTracker = PumpDotDividendTracker(payable(newAddress));
...
dividendTracker.processAccount(msg.sender, false);
    ...
    function _transfer(
        ...
        {
            swapDuration++;if(swapDuration>2){
...
contract PumpDotDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("PumpDot_Dividend_Tracker", "PumpDot_Dividend_Tracker") {
    claimWait = 3600;
