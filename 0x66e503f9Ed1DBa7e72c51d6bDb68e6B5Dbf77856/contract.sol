...
contract MEUSE is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD489B0A88b4Cd6ceAC6Da1A3576d120d43A9bB3F); // Marketing Address
    ...
    string private _name = "MEUSE";
    string private _symbol = "MUS";
    ...
    function initContract() external onlyOwner() {
        ...
        marketingAddress = payable(0xD489B0A88b4Cd6ceAC6Da1A3576d120d43A9bB3F);
    }
