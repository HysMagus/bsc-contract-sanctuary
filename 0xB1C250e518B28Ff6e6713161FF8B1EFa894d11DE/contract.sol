...
/*
    ...
    In Great Heroes, each hero comes with a unique skin and a randomly-generated statline across 4 different skills: 
    Weapons, Engineering, Biotech, and Psychics. 
    Heroes can be minted in packs of three with HERO token and there are endless combinations to collect. Based on greatNFTs
    
    Each hero is a greatNFT. This means you own all your heroes and their skin and statlines are private metadata, 
    allowing for privacy-preserving gameplay not found on any other blockchain.

    TOKENOMICS
    
    Total Supply: 1,000,000,000,000,000
    80% supply will be burnt after launch
    20% liquidity pool will be sent to dead wallet
    
    In every transaction
    %2 to holders 
    %3 to liquidity pool
    
    MaxTransactions 10B (Anti-Dump)
    ANTI RUG embedded in code

    www.greatheroes.io
    t.me/GreatHeroes
    twtitter/GreatHeroes
...
contract GreatHeroes is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "GreatHeroes";
