...
contract Waifus is Context, Ownable, ERC165, IWaifus, IERC721Metadata {
    ...
    string public constant WAIFUS_PROVENANCE = "TEST";

    uint256 public constant SALE_START_TIMESTAMP = 1614538200;
    ...
    function getNFTPrice() public view returns (uint256) {
        ...
        if (currentSupply >= 16381) {
            ...
            return 100000000000000000; // 1500 - 2999 1.2 BNB
        } else {
            return 100000000000000000; // 0 - 1499 0.6 BNB 
        }
    }
