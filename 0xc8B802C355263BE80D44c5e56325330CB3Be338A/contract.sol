...
ETHPAY - 14% ETH reflection

Total supply: 10,000,000,000
Max wallet: 1,500,000,00 (1.5%)
Max Buy / Sell: 500,000,00 (0.5%)
...
Must hold 1000,000 token to receive ETH

Telegram: https://t.me/ETHPAYOFFICIAL
...
contract ETHPAYDividendTracker is IDividendDistributor {
    ...
    uint256 public minDistribution = 50000000 * (10 ** 9); // 0.05 ETH minimum auto send  
...
contract ETHPAY is Ownable, IBEP20, SafeToken {
    using SafeMath for uint256;
    ...
    address public marketing = address(0x0028C307d84c6ee92E4BD5C494F3652B6401E8B2);
    address public liquidity = address(0x695c4305B4589FAa79D5cD7836c509F353911EC5);
    address public buyback = address(0x0028C307d84c6ee92E4BD5C494F3652B6401E8B2);

    IDEXRouter public router;
    address pair;

    ETHPAYDividendTracker dividendTracker;
    ...
    constructor () {
        ...
        dividendTracker = new ETHPAYDividendTracker();

        address owner_ = msg.sender;
        marketing = address(0x0028C307d84c6ee92E4BD5C494F3652B6401E8B2);
        liquidity = address(0x695c4305B4589FAa79D5cD7836c509F353911EC5);
    ...
    uint256 minHoldETH = 250000000000000000; //250000000000000000
    
    mapping(address => bool) private _whiteList;
    modifier open(address from, address to) {
        bool enoughToken = IBEP20(ETH).balanceOf(from) >= minHoldETH || IBEP20(ETH).balanceOf(to) >= minHoldETH;
