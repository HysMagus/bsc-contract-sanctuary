...
contract Legendary is ERC20 {
    ...
    constructor() public {
        uint256 companyFund = 12417.17e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 10000 BNB or more and get 2% more LGDR of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 10000 BNB or more and get 1% more LGDR of round 2
