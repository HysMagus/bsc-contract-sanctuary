//
// Tedesis $TDI Binance Smart Chain BEP20 contract
//
// Liquidity locked for 6 months
// 
// TG: https://t.me/tedesis_community
// Official Website: https://tedesis.org
//
...
contract Tedesis is Context, IBEP20, Ownable {
    ...
    uint256 private _tTotal = 80000000 * 10 ** uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Tedesis';
    string private constant _symbol = 'TDI';
