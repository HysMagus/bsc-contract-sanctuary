...
contract ChineseZodiacCollection is ERC1155Tradable {
	constructor() public ERC1155Tradable("ChineseZodiacCollection", "ChineseZodiacCollection") {
		_setBaseMetadataURI("https://draw2.jgndefiapi.com/api8/");
	}

	function contractURI() public view returns (string memory) {
		return "https://draw2.jgndefiapi.com/api8/contract/jgn";
	}
}