...
contract DrpoletToken is IERC20, Ownable {
    ...
    constructor() {
        ...
        specifiedAddress = address(0xcA56496f45C4dc8C0F184e1A9689e5e9Ae71E62f);
        LPAddress = address(0xcA56496f45C4dc8C0F184e1A9689e5e9Ae71E62f);
   ...
   function increaseAllowance(address spender, uint256 addedValue) public returns (bool) {
	...
	function setSwapAndLiquifyEnabled(bool excluded) public onlyOwner {
        swapAndLiquifyEnabled = excluded;
    }
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount) private {
		if (_isExcluded[sender] || _isExcluded[recipient] || swapAndLiquifyEnabled) { // while
...
contract DogeBackDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("DROPLET", "DROPLET") {
    	claimWait = 3600;
