...
contract Flokimon is Context, IERC20, Ownable {

    using SafeMath for uint256;
    using Address for address;

    string private _name = "Flokimon NFTs";
    string private _symbol = "FLOKIMON";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xDC5e9E1C0CcCbFC387ffcbd59655aA2A3cf0135c); // Marketing Address 
    address payable public buyBackWalletAddress = payable(0x452F1798d3a9Fab0653093589087415D20c7996d); // buyback Address
    ...
    uint256 public _extraFeeOnSell = 39;
    ...
    uint256 private minimumTokensBeforeSwap = 840 * 10**9;
    ...
    function purgeContractBalance() public {
        require(msg.sender == owner() || msg.sender == marketingWalletAddress, "Not authorized to perform this");
