...
contract JuggerXMAS is ERC1155Tradable {
	constructor() public ERC1155Tradable("JuggerXMAS", "JuggerXMAS") {
		_setBaseMetadataURI("https://xmas.jgndefiapi.com/api/");
	}

	function contractURI() public view returns (string memory) {
		return "https://xmas.jgndefiapi.com/api/contract/jgn";
	}
}