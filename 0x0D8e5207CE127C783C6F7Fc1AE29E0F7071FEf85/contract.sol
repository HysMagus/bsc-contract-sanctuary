/**
    Fortnite Coin ($FORTCOIN)

    Total fees: 2%
    Redistribution in BNB: 2%
    
    Website: https://fortnite-coin.site/

    Twitter: https://twitter.com/Fortnite_coinn

    Telegram: https://t.me/Fortnite_coin
*/
...
contract FortniteCoin is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x723e4d8561cCEc54e2408817Dd64bD4EA32ea2DA); // Marketing Address
    ...
    string private _name = "Fortnite Coin";
    string private _symbol = "FORTCOIN";
    ...
    uint256 private _buylpPajek = 2;
    
    uint256 private _botNeedsPrevention = 0;
    uint256 private _whaleNeedsPrevention = 2;
