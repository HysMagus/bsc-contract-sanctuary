...
/*
                                     ...
                                     / __| / _ \ | |   | __| ___  _ _  ___ __ __ ___  _ _ | __|| | | ||   \ 
                                    \__ \| (_) || |__ | _| / _ \| '_|/ -_)\ V // -_)| '_|| _| | |_| || |) |
                                    |___/ \___/ |____||_|  \___/|_|  \___| \_/ \___||_|  |_|   \___/ |___/ 

                                                                TG: SolForeverFUD
SolForeverFUD ^

Introducing SolForeverFUD

The 50th token on the BSC smartchain to combine the rebase with rewards.
Hold $SFF and receive $SOL directly to your BEP-20 wallet as a reward for holding

TG: https://t.me/SolForeverFUD
Website: Not Being Made
...
contract SolForeverFUD is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SolForeverFUD";
    string constant _symbol = "$SFF";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x7b3a31a7c5Dec3a6c04F51989164ddB4B909f0D8;
