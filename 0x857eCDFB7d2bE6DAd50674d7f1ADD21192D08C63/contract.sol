...
| $$      | $$  | $$| $$  | $$| $$| $$  | $$| $$_  $$ | $$_____/| $$  | $$
| $$$$$$$$|  $$$$$$$|  $$$$$$/| $$|  $$$$$$/| $$ \  $$|  $$$$$$$| $$  | $$
|________/ \____  $$ \______/ |__/ \______/ |__/  \__/ \_______/|__/  |__/
           /$$  \ $$                                                      
          |  $$$$$$/                                                      
           \______/                                                                            
...
✅5% Add  to liquidity
✅2% Reflection
✅Info on project in group chat
max transaction (1%)
 max wallet (2%)
TG: t.me/EgoToken
💎Hidden gem ready to X100
...
contract EgoToken is Context, IBEP20, Ownable {
    ...
    address private _charityWalletAddress = 0x4253f005187a809681C1E87899e7C39144683AFb;
    ...
    string private _name = "EgoToken t.me/EgoToken";
    string private _symbol = "Ego";
    ...
    uint256 public _maxTxAmount = 2000000 * 10**6 * 10**8;
    uint256 private numTokensSellToAddToLiquidity = 1000000 * 10**6 * 10**8;
