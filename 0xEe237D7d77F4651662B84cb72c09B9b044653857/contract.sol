/**
 * 
The new type of Yield Farm using Automatic Liquidity integrated with Pancake liquidity and swap on Binance Smart Chain, Symmetry.markets team is pleased to announce the official launch of Symmetry token and platform used to earn Symmetry.

Our team will also create V2 AMM, loans platform and Solana cross-chain integration in future.

Here are some details our users can be curious about:
-0% Transfer Tax
-0% Transfer fee
-99% Liquidity and tokens locked
-No harvest lockup
-Free market without control
-High yield APR% expected
-New project with experienced well-built team 
*/
...
contract SYMMETRY is Context, IERC20, Ownable {
