...
contract ForeverRebaseSphinx is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("ForeverRebase Sphinx", "FRS") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "ForeverRebaseSphinx";
    string private _symbol = "FRS";
