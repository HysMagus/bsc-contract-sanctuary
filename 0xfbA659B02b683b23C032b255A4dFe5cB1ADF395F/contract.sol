/**
 * TG: https://t.me/SafeXCake
 * Max Wallet 4%, 2% max buy , Slippage buys 20 to 25% to be sure 
 * SafeXCake gathers SafeXCake and delivers direct to your wallet!!!!
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82); //the reward token you want distributed 
...
contract SafeXCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "SafeXCake";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "SafeXCake";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x055da9bA815A1BAc42744ca54E4F8FFC65435200;
