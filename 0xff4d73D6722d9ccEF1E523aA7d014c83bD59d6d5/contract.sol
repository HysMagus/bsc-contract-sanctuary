...
BITPay - The future of merchant cryptocurrency payments

Pay expenses & earn $BPAY rewards with your crypto
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xEB714Ca7C3c155839Fe767ae9dC0eCb7c5fb7EAe); // Marketing Address
    address payable public devAddress = payable(0xd24943537323C5d2014b4d6624B18BC2dd5f2D97); // Dev Address
...
contract BITPay is ERC1363, TokenRecover {
    constructor ()
        ERC1363("BITPay", "BPAY")
    {
    }
