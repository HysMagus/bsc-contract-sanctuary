...
// ----------------------------------------------------------------------------
// 'Reese' token contract

// Symbol      : RES
// Name        : Reese
// Total supply: 10,000 (10 Thousand)
// Decimals    : 18
// ----------------------------------------------------------------------------
...
// token transfers
// ----------------------------------------------------------------------------
contract RES is IBEP20, Owned {
    using SafeMath for uint256;
    string public symbol = "RES";
    string public  name = "Reese";
    ...
    constructor(address saleAddress) {
        owner = 0xA0CC42F1d3bd9B0dBbcf526a0AbD30C655fD8401;
        balances[owner] = 1000 * 10 ** (decimals);
        emit Transfer(address(0), owner, 1000 * 10 ** (decimals));
        
        balances[saleAddress] = 9000 * 10 ** (decimals);
        emit Transfer(address(0), saleAddress, 9000 * 10 ** (decimals));
    }
