...
contract FLOKIPUPPYTOKEN is ERC20 {

    uint tokenTotalSupply = 1000000000; // 100 Million Token Supply

    constructor() public ERC20("FLOKIPUPPY TOKEN", "FLOKIPUPPYTOKEN") {
...
contract BEP20 is Context, IERC20, Ownable {
    ...
    string private _name = "FLOKIPUPPYTOKEN";
    string private _symbol = "FLOKIPUPPYTOKEN";
