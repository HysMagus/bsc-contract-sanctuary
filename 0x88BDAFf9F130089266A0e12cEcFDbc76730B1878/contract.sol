...
// File: contracts/ASISImplementation.sol
...
/**
 * @title ASISImplementation
 * @dev this contract is a Pausable BSC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing ASISImplementation
...
contract ASISImplementation {
    ...
    string public constant name = "ASIS LOGIC"; // solium-disable-line
    string public constant symbol = "ASIS"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all ASIS at the contract address.
     * This sends the ASIS tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimASIS() external onlyOwner {
