/**
	...
	$$ |  $$ |$$ |  $$ |$$ |  $$ |   $$ |    $$ |  $$ |$$ |  $$ |$$ |\$  /$$ |$$\   $$ |  $$ |   $$ |      $$ |  $$ |
	$$$$$$$  |$$ |  $$ |$$$$$$$  |   $$ |    $$ |  $$ |$$ |  $$ |$$ | \_/ $$ |\$$$$$$  |  $$ |   $$$$$$$$\ $$ |  $$ |
	\_______/ \__|  \__|\_______/    \__|    \__|  \__|\__|  \__|\__|     \__| \______/   \__|   \________|\__|  \__|
    ...
    function _transfer(address from, address to, uint256 amount) internal override {
        ...
        if(takeFee) {
        	if(automatedMarketMakerPairs[to])
			{
				...
				marketingTokens = marketingTokens.add(fees.mul(sellMarketingFee).div(totalSellFees));
				liquidityTokens = liquidityTokens.add(fees.mul(sellLiquidityFee).div(totalSellFees));
				rewardTokens = rewardTokens.add(fees.mul(sellBTCBRewardsFee).div(totalSellFees));
				buybackTokens = buybackTokens.add(fees.mul(sellBuyBackFee).div(totalSellFees));
			...
			else
			{
				...
				marketingTokens = marketingTokens.add(fees.mul(buyMarketingFee).div(totalBuyFees));
			    liquidityTokens = liquidityTokens.add(fees.mul(buyLiquidityFee).div(totalBuyFees));
				rewardTokens = rewardTokens.add(fees.mul(buyBTCBRewardsFee).div(totalBuyFees));
				amount = amount.sub(fees);
                super._transfer(from, address(this), fees);
			}
        }
