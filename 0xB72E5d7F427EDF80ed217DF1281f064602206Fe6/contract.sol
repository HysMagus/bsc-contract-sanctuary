...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "AcidDoge";
    string internal constant SYMBOL = "ACD";
     ...
     */
    uint256 internal constant maxWalletBalance = 200 ;
    ...
    address internal charityAddress = 0x8A7E4f9dd8A8a07EAB5cc5c6158BfFe70d47255A;
...
abstract contract BaseRfiToken is IERC20, IERC20Metadata, Ownable, Presaleable, Tokenomics {
    ...
    function _transfer(address sender, address recipient, uint256 amount) private {
        ...
        if ( isInPresale ){ takeFee = false; }
            ...
            */
            if ( maxWalletBalance > 200 && !_isUnlimitedSender(sender) && !_isUnlimitedRecipient(recipient) && !_isV2Pair(recipient) ){
...
abstract contract Liquifier is Ownable, Manageable {
    ...
    address public marketingAddress = 0xa916Ebc4BF0bE0AE9DB60174CA8E9616a4976012;
...
contract AcidDoge is SafeToken{
