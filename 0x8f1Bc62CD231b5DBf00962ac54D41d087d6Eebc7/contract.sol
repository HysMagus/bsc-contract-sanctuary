...
contract SafeBet is ERC20Detailed, Ownable {
    ...
    uint256 private constant INITIAL_FRAGMENTS_SUPPLY = 777 * 10**12 * 10**DECIMALS;
    uint256 public gonMaxWallet = TOTAL_GONS.div(100).mul(5);

    uint256 public ecosystemFee = 1;
    uint256 public liquidityFee = 2;
    uint256 public casinoFee = 15;
    uint256 public buyBackFee = 0;
    uint256 public totalFee =
        ecosystemFee.add(liquidityFee).add(casinoFee).add(buyBackFee);
    ...
    address public casinoFeeReceiver;
    ...
    constructor() ERC20Detailed("SafeBet", "SBET", uint8(DECIMALS)) {
        ...
        casinoFeeReceiver = 0xd070E8D4294A22F877F1e9Cd2420a14b3b43fE03;
        ecosystemFeeReceiver = 0x779d13AD2d9269d54F0951BA977C77199DB3523b;
        buyBackFeeReceiver = 0xE23ECe091B9d00592D961c57a33a074A32f7dF8A;
    ...
    function swapBack() internal swapping {
        ...
        uint256 amountETHCasino = amountETH.mul(casinoFee).div(
            totalETHFee
        );
        uint256 amountETHEco = amountETH.mul(ecosystemFee).div(totalETHFee);

        (bool success, ) = payable(casinoFeeReceiver).call{
            value: amountETHCasino,
            gas: 30000
        }("");
	...
	function addToWhitelist(address _addr) public onlyOwner {
        require(!_isFeeExempt[_addr], 'Account is already in whitelist!');
        _isFeeExempt[_addr] = true;
    }
    ...
    function setFees(
        ...
        totalFee = ecosystemFee.add(liquidityFee).add(casinoFee).add(buyBackFee);
