...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    symbol = "CNDAO";
    name = "CNDAO.FINANCE Token";
    decimals = 18;
    _totalSupply =  401000000000000000000000;
    balances[owner] = _totalSupply;
    emit Transfer(address(0), owner, _totalSupply);
  }
  function newCNDAOexchange(address _exchangepool) public onlyOwner {
...
contract CNDAO_TOKEN  is TokenBEP20 {
