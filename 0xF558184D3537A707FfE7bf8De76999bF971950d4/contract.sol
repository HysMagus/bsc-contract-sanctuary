 ...
 * is concerned)
 *
 * This contract is required for intermediate, library-like contracts.
 */
...
contract wallstreetcoin is Context, IERC20, Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    using Address for address;
    using TransferHelper for address;

    string private _name = 'Wallstreet Coin';
    string private _symbol = 'WSCOIN';
    ...
    constructor() public {
        ...
        address _owner = 0x6Dfda9a9cb11717fC2D5C8d5A2B7e1b21786c501;
        cake = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        marketingWallet = 0xCfB3bdCbFECF00DC7cEEA0715652f9F07362f16f;
        insuranceWallet = 0x1f7227806Ce8ef965Df85B047822457a483Fa36A;
