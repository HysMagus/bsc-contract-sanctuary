...
contract AFIFarmV2 is Ownable, ReentrancyGuard {
    using SafeMath for uint256;
    ...
    //production BSC
    address public AFI = 0x82D6F82a82d08e08b7619E6C8F139391C23DC539; // bAFI 1:1 migration to AFIv2
    address public AFIv2 = 0x6C77dF12c39CAE90C4c46E5C19177679b7235CFa;
    
    //Testnet BSC
    //address public AFI = 0x46380581B256752200705D558D6731a9e1a548B0; // bAFI 1:1 migration to AFIv2
    //address public AFIv2 = 0xE8B7eB8629e4FF2bC5a0d10933AF6569261C445D;
    ...
    function getMultiplier(uint256 _from, uint256 _to)
        ...
        returns (uint256)
    {
        if (IERC20(AFIv2).totalSupply() >= AFIMaxSupply) {
            return 0;
        }
    ...
    function updatePool(uint256 _pid) public {
        ...
        AFIToken(AFIv2).mint(address(this), AFIReward);
    ...
    function safeAFITransfer(address _to, uint256 _AFIAmt) internal {
        uint256 AFIBal = IERC20(AFIv2).balanceOf(address(this));
        if (_AFIAmt > AFIBal) {
            IERC20(AFIv2).transfer(_to, AFIBal);
        } else {
            IERC20(AFIv2).transfer(_to, _AFIAmt);
        }
    }
    ...
    function inCaseTokensGetStuck(address _token, uint256 _amount)
        ...
        onlyOwner
    {
        require(_token != AFIv2, "!safe");
        IERC20(_token).safeTransfer(msg.sender, _amount);
    }

    function migrateToAFIv2(uint256 _inputAmt) public {
        ...
        AFIToken(AFIv2).mint(msg.sender, _inputAmt);
    }
}