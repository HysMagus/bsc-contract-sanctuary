...
contract STEST4Token is StandardToken {

    string public name = "STEST Token 4";
    string public symbol = "STEST4";
    ...
    function STEST4Token(address _owner, address _minter) payable {
        owner = _owner;
        minter = _minter;
