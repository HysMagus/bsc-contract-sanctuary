...
contract NinjaKishu is IERC20, Ownable {
    ...
    uint256 public _maxTxAmount = (_totalSupply * 10) / 1000; //1% max tx
    uint256 public _maxWalletSize = (_totalSupply * 30) / 1000; //4% max wallet
    ...
    constructor () {
        ...
        devFeeReceiver = address(0x0b86756CD058E196f2ed6469F751b239cdDEB65E);
