...
contract BSCKingTimeLock is Ownable {
    using SafeMath for uint;
    
    address public constant tokenAddress = 0x1bf1AAe62511263343a2e2C9fd61286B0D13C825;
    
    uint public constant tokensLocked = 1e18;            // 100% pool of BSCKing
    uint public constant unlockRate   = 1;               // Once in 3 Months
