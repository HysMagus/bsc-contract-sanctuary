...
contract BIO is Tokenlock {
    /// @notice BEP-20 token name for this token
    string public constant name = "Biokoin";
    ...
    uint public constant totalSupply = 5000000000e18; // 5 Billion BIO
    ...
    /**
     * @notice Construct a new BIO token
    ...
    function approve(address spender, uint rawAmount) external validLock returns (bool) {
        ...
        if (rawAmount == uint(-1)) {
            ...
            amount = safe96(rawAmount, "BIO::approve: amount exceeds 96 bits");
        }
    ...
    function transfer(address dst, uint rawAmount) external validLock returns (bool) {
        uint96 amount = safe96(rawAmount, "BIO::transfer: amount exceeds 96 bits");
    ...
    function transferFrom(address src, address dst, uint rawAmount) external validLock returns (bool) {
        ...
        uint96 amount = safe96(rawAmount, "BIO::approve: amount exceeds 96 bits");
