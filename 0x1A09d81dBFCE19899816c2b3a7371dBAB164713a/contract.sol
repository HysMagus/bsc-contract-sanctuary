...
// File: contracts/HumanityToken.sol
...
// HumanityToken with Governance.
contract HumanityToken is ERC20("HUM", "HUM"), Ownable {
    uint256 private _cap = 25000000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "LBC::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "LBC::delegateBySig: invalid nonce");
        require(now <= expiry, "LBC::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "LBC::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "LBC::_writeCheckpoint: block number exceeds 32 bits");
    ...
    // In some circumstance, we should not burn HUM on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
    ...
    constructor() public {
        ...
        _mint(msg.sender, _initial_supply); // Mint 5000 LBC
