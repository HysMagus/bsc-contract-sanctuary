...
contract Inshallah is Context, IBEP20, Ownable { // contract name
    ...
    string private _name = "Inshallah"; // token name
    string private _symbol = "Inshallah"; // token symbol
    ...
    uint256 public durationBetweenEachBuyback = 3 days; // duration betweeen each buyback
    ...
    uint256 _marketingBNBFee = 50; // marketing BNB fee
    uint256 private _previousMarketinBNBFee = _marketingBNBFee; // marketing BNB fee

    uint256 _liquidityFee = 0; // liquidity fee 
    ...
    uint256 public _maxTxAmount = _tTotal.div(400); // max allowed tokens tranfer per transaction
