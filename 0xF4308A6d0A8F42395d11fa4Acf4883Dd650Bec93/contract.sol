...
/*
    ...
    The first and only token by the adult industry, for the adult industry!
    Introducing $SIMP, a token designed to power trust and transactions for adult entertainment stars and their communities
...
contract SimpStudios is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Simp Studios";
    string private constant _symbol   = "$SIMP";
    uint8  private constant _decimals = 9;

    uint256 public _taxFee       = 50;
    uint256 public _liquidityFee = 0;
    uint256 public _marketingFee = 440;
