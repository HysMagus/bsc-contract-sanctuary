...
contract WYPE_CROWDSALE is Context, ReentrancyGuard{
    ...
    uint256 public minimumBuyAmount = 0.05 ether;
    ...
    constructor () public {
        ...
        rate = uint256(10000);
        walletAddress = 0x93467f0F9a09b5478B0E2ECdA979045dda53750b; //Fund Receiver
    ...
    function buy() public payable {
        ...
        require((weiValue >= minimumBuyAmount) &&(weiValue<= maximumBuyAmount), "Minimum amount is 0.05 BNB and Maximum amount is 20 BNB");
