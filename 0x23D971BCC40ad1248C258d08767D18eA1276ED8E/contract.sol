...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        address _whaleVaultAddress
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        whaleTokenAddress = _whaleAddress;
        WBNBAddress = _WBNBAddress;
        tokenBakerySwapPair = IBakerySwapFactory(address(0x01bF7C66c6BD861915CdaaE475042d3c4BaE16A7)).getPair(WBNBAddress,whaleTokenAddress);
        whaleVaultAddress = _whaleVaultAddress;
        feePercentX100 = 20;
    ...
    address whaleTokenAddress;
    address whaleVaultAddress;
    ...
    function setwhaleVaultAddress(address _whaleVaultAddress) public onlyOwner {
        whaleVaultAddress = _whaleVaultAddress;
    }
        ...
        )
    {
        ...
        // Dont have a fee when whaleVault is sending, or infinite loop
        // And when pair is sending (buys are happening, do not tax on it)
        if(sender == whaleVaultAddress || sender == tokenBakerySwapPair ) {
