...
Make sure you add the PARABOLIC address into your wallet to be able to see your rewards. => 0xb5bcf4faa81457e98f4609a2a3291df64e246f01 <=

Our tokenomics:
Parabolic rewards Fee: 5%
Marketing Fee: 5%
Liquidity Fee: 3%

TG: https://t.me/MiniParabolic_BSC
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 PARA = IBEP20(0xB5bCF4fAa81457e98f4609a2a3291dF64E246f01);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = PARA.balanceOf(address(this));
        ...
        uint256 amount = PARA.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            PARA.transfer(shareholder, amount);
...
contract MiniParabolic is IBEP20, Auth {
    ...
    address PARA = 0xB5bCF4fAa81457e98f4609a2a3291dF64E246f01;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniParabolic";
