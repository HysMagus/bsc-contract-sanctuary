...
contract Dalmatian_Shelter is Context, IBEP20, Ownable {
    ...
    string private constant _name     = "Dalmatian Shelter";
    string private constant _symbol   = "DLMTN";
    uint8  private constant _decimals =  18;
    
    uint256 public _taxFee       = 300; // 2% of every transaction is redistributed to holders
    uint256 public _liquidityFee = 300; // 2% of every transaction is kept for liquidity
    uint256 public _charityFee = 400; // 4% of every transaction is sent to charity wallet

    uint256 private _previousTaxFee       = _taxFee;
    uint256 private _previousLiquidityFee = _liquidityFee;
    uint256 private _previousCharityFee = _charityFee;

    uint256 public _maxTxAmount                   = 1000000000000 * 10**18; // 1,000,000,000,000
    uint256 public _numTokensSellToAddToLiquidity = 500000000 * 10**18; // 500,000,000 500 Million
    ...
    constructor (address cOwner, address charityWallet) Ownable(cOwner) {
        ...
        IUniswapV2Router02 uniswapV2Router = IUniswapV2Router02(0x10ED43C718714eb63d5aA57B78B54704E256024E);//mainnet
    ...
    function excludeFromReward(address account) public onlyOwner {
        ...
        require(_excluded.length <= 1000, "Excluded array too long");
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256, uint256) {
        ...
        uint256 tCharity = tAmount.mul(_charityFee).div(10000);
