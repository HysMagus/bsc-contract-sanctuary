...
pragma solidity ^0.8.4;
abstract contract SPC is BEP20, BEP20Detailed {
...
contract PreSale is Owned{
  ...
  constructor(address _wallet, SPC _token, IBEP20 _busd) {
   ...
   * @return Number of tokens that can be purchased with the SPCified _amount
   */
