...
// Xemmcore with Governance.
contract XemmCore is ERC20("xemmcore.finance", "XEMM"), Ownable {
...
contract XemmCoreFarm is Ownable {
    using SafeMath for uint256;
    ...
    struct PoolInfo {
        ...
        XemmCore rewardToken;        // Address of reward token contract.
    ...
    IERC20 public referralToken;  // XemmCore for check referral program

    uint256 public stakeAmountLv1;    // Minimum stake XemmCore condition level1 for referral program.
    uint256 public stakeAmountLv2;    // Minimum stake XemmCore condition level2 for referral program.
...
constructor(
    ...
    function _setAllocPoints(XemmCore _rewardToken, uint256 _allocPoint) internal onlyOwner {
    ...
    function totalLock(XemmCore _rewardToken) public view returns (uint256) {
