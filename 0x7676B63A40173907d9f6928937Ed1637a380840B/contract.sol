...
library ElonGoxxToken {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "ElonGoxxToken: addition overflow");

        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "ElonGoxxToken: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "ElonGoxxToken: multiplication overflow");

        return c;
    }

    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "ElonGoxxToken: division by zero");
    }
...
contract DividendDistributor is IDividendDistributor {
    using ElonGoxxToken for uint256;
    ...
    LockToken
{
    ...
    uint256  buyBackUpperLimit = 10 * 10**16;
