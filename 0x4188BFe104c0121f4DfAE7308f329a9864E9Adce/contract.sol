...
contract Swap {
    ...
    function swapBNBToBUSD(address routerAddress,uint256 amountOut) public payable returns(uint[] memory returnData){
    ...
    function swapTokensToBUSD(address routerAddress,uint256 amountOut,uint256 amountInMax, address tokenAddress) internal returns(uint[] memory returnData){
        Router01 router = Router01(routerAddress);
    ...
    function bestTrade(address[] calldata routers,address tokenAddress, uint256 amountOut)public view returns(uint256[] memory minMax){
