...
//TG: https://t.me/fomofomotoken
//Website: www.fomofomo.finance
...
contract FomoFomo is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FomoFomo";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x2F2851EC20A147517934bF13Ce3634B68CBD870b;
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/2, "Fees cannot be more than 33%");
    }
