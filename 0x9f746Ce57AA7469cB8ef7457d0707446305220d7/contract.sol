...
/*
   ...
   This is a community token. If you want to create a telegram I suggest to name it to @FlokiWorldBSC
   ...
   Can you make #FlokiWorld 10000X? 
...
contract FlokiWorld is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xe3126CD05AE7Bc4ea1691F39Ac065f89855317d3); // Marketing Address
    ...
    string private _name = "FlokiWorld";
