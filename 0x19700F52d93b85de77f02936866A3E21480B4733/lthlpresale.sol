...
contract LTHLpresale is Context, ReentrancyGuard {
    ...
    uint totalNumberForPresale = 22500; 
    uint maxEthHardCap = 200; 
    uint256 tokensPerETH = totalNumberForPresale / maxEthHardCap;
    ...
    function buyTokens() public payable nonReentrant {
        ...
        // like 
        //require (ethSpent[msg.sender] <= 0.1 ether);
        require(msg.value >= 0.1 ether, "You sent less than 1 BNB");
        
        //EARTH: 50 BNB limit
        //require(msg.value <= 2.5 ether, "You sent more than 17.5 BNB");
        require(msg.value <= 17.5 ether, "You sent more than 17.5 BNB");

        //EARTH: 2500 BNB presale cap
        require(ethSent < 200 ether, "Hard cap reached");
        require (msg.value.add(ethSent) <= 200 ether, "Hardcap reached");

        //EARTH: 50 BNB limit
        require(ethSpent[msg.sender].add(msg.value) <= 17.5 ether, "You cannot buy more than 17.5 BNB");
