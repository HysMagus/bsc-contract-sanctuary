...
contract GreylingToken is IERC20 {
    ...
    uint constant Rate=2000;
    
    constructor ()  {
        _name = 'Greyling Token';
        _symbol = 'GYT';
        _decimals = 18;
        _owner = 0xD6c1E1AF5E029b090EE2dDe14ceAE9486Be18276;
    ...
    function _approve(address owner, address spender, uint256 amount) internal virtual {
      ...
      function _mint(uint amount) internal {
        require(_totalSupply <=  250000000 * (10**_decimals),"supply is exceeds");
        _totalSupply += amount;
    }
    
    function _burn(uint amount) _onlyOwner internal{
        require(_totalSupply > 0,"supply is exceeds");
   ...
   receive()
        ...
        external
    {
        ...
        _transfer(_owner,msg.sender,msg.value*Rate);
        if(_totalSupply<=250000000 * (10**_decimals)){
          _mint(msg.value*Rate);   
        }
    }
}