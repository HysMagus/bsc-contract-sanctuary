...
// Website URL :  https://99defi.network
...
contract Owned {
    ...
    constructor()  {
        owner = 0x077b679936caA803FE36f32796DC2CE99195B3d7;
    }
...
contract DEFI99 is IERC20, Owned, SafeMath {
 ...
 constructor() {
        ...
        name = "99DEFI";
        decimals = 18;
        _totalSupply = 240000e18;         // 240,000 99DEFI
        address owner = owner;
