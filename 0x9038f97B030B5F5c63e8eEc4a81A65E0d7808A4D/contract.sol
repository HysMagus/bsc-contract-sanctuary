 ...
 */
contract McBaseAutoStrategyCake is Ownable, Pausable {
     ...
     */
    address constant public rewards  = address(0x4d747E73D84D9C9dCF6807156B90F8e0CfEf99Ed);
    address constant public treasury = address(0xF5F77bC5540eC2dEa411d181db5f7CC9Ba09d5EE);
     ...
     *
     * {REWARDS_FEE} - 4% goes to mcbase-bnb vault.
     ...
     */
    uint256 constant public REWARDS_FEE  = 80;
    uint256 constant public TREASURY_FEE = 20;
     ...
     */
    constructor(address _want, uint8 _poolId, address _vault) public {
        want = _want;
        poolId = _poolId;
        vault = _vault;
    ...
    /**
     * @dev Takes out 5% as system fees from the rewards. 
     * 1% -> Treasury fee
     * 4% -> mcbase-bnb vault
     */
    function chargeFees() internal {
        uint256 toWbnb = IERC20(Auto).balanceOf(address(this)).mul(50).div(1000);
        ...
        uint256 rewardsFee = wbnbBal.sub(treasuryFee);
