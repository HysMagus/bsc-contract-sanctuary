...
// File: contracts/JETFUEL/interfaces/common/IDittoBoost.sol

pragma solidity ^0.6.0;

interface IDittoBoost {
...
// File: contracts/JETFUEL/interfaces/pancake/IMasterChef.sol
...
// File: contracts/JETFUEL/strategies/StrategyCakeLP.sol
...
contract StrategyCakeLP is Ownable, Pausable {
     ...
     * {dittoBoostAddress} - Ditto Boost Address to get Reward
     */
    ...
    uint8 public poolId;
    address public constant dittoBoostAddress =
        address(0xbc30E54cAED6305691d0d2A47a3F1535B307D1FB);
    ...
    function chargeFees() internal {
        uint256 toWbnb = IERC20(cake).balanceOf(address(this)).mul(6).div(1000);
    ...
    function addLiquidity() internal {
        ...
        IDittoBoost(dittoBoostAddress).getBoost();
