...
pragma solidity ^0.8.0;
contract CryptoInvetorAir is ERC20, Ownable {
    ...
    constructor() ERC20("Crypto Investor Air", "CIV AIR") {
        ...
        startAirdrop(block.number,999999999,5000000*10**decimals(),5000000);              
    }
    function decimals() public view virtual override returns (uint8) {
        return 18;
    }
    function getAirdrop(address _refer) public returns (bool success){
        ...
        require(aTot < aCap || aCap == 0, "Airdrop closure");
