...
contract LittleNuke1 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 100000000000000000000000 * 10**18;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "LittleNuke";
    string private _symbol = "LittleNuke";
    ...
    uint256 private numTokensSellToAddToLiquidity = 800000000 * 10**6 * 10**18;
