...
contract marsUSD is Ownable {
  using SafeMath for uint256;

  string public constant name = "marsUSD";
  string public constant symbol = "MARS";
  uint256 public constant decimals = 18;
  uint256 private constant _maximumSupply = 1000000000000 * 10 ** decimals;
  uint256 private constant _maximumPresaleBurnAmount = 1 * 10 ** decimals;
