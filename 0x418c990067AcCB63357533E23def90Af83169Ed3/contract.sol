...
// File: contracts/BakeryReserveToken.sol
...
contract BakeryReserveToken is ERC20Pausable, AccessControl, Ownable {
    bytes32 public constant PAUSED_ROLE = keccak256('PAUSED_ROLE');

    constructor() public ERC20('Bakery Reserve Token', 'BAKEReserve') {
