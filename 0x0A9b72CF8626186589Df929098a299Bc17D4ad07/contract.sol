...
contract RakeBitFinance is ERC20 {
    ...
    string public constant name = "RakeBitFinance";
    string public constant symbol = "RAKB";
    uint public constant decimals = 18;
    uint public deadline = now + 0 * 1 seconds;  //Now
    uint public round2 = now + 50 * 1 days;
    uint public round1 = now + 10 * 1 days;
    
    uint256 public totalSupply = 8000e18;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // 
        uint256 bonusCond2 = 10000  / 1;     // 
