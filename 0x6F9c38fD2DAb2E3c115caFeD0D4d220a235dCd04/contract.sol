...
contract RIOUKIToken is Context, IBEP20, Ownable {
    ...
    string private constant _name = 'RIOUKI Token';
    string private constant _symbol = 'RIOU';

    uint256 private _taxFee = 100;
    uint256 private _burnFee = 200;
    uint private _max_tx_size = 10 ** uint256(_decimals);
