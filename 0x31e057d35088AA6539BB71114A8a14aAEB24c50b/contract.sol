...
contract SafeMoon is  IERC20, Ownable {
    ...
    string private _name = "LIVE TEST1";
    string private _symbol = "LTS1";
    ...
    function calculateReflectionFee(uint256 _amount, uint8 taxes) private view returns (uint256) {
        return (_amount*_reflectionTax*taxes)/100;
    }
...
////////////////////////////////////////////////////////////////////////////////
    ...
    address public MarketingWallet=address(0xdead);
    address public LotteryWallet=address(1);
    
    
    uint256 public LaunchTimestamp;
    uint256 public BotProtectionTimestamp;
    
    
    uint256 BotProtectionTime=10 minutes;
    mapping(address=>uint256) public firstBuyTimestamp;
    uint256 BotBlacklistTimestamp;
...
////////////////////////////////////////////////////////////////////////////////
    ...
    function _swapContractToken() private lockTheSwap{
        ...
        uint8 totalBNBTax=_marketingTax+_lotteryTax;
        uint256 marketingBNB=address(this).balance*_marketingTax/totalBNBTax;
        bool sent;
        (sent,)=MarketingWallet.call{value:marketingBNB}("");
        (sent,)=LotteryWallet.call{value:address(this).balance}("");
...
////////////////////////////////////////////////////////////////////////////////
    ...
    function _tokenTransfer(address sender, address recipient, uint256 amount,bool takeFee) private {
        ...
        if(takeFee){
            if(sender==_pancakePairAddress){//BUY
                require(balanceOf(recipient)+amount<=MaxHold);
                taxes=_buyTax;
    ...
    function _transfer(address from, address to,uint256 amount) private {
        ...
        if (!inSwapAndLiquify && from != _pancakePairAddress && swapAndLiquifyEnabled) _swapContractToken();
