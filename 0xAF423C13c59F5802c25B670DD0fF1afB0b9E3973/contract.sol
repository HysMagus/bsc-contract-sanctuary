...
interface IVSafeVaultControllerCreator {
    function create() external returns (address);
}

contract VSafeVaultControllerCreator is IVSafeVaultControllerCreator {
    function create() external override returns (address) {
        VSafeVaultController controller = new VSafeVaultController();
