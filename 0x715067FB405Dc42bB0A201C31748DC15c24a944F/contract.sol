...
// File: contracts/JETFUEL/interfaces/auto/IAutoFarmV2.sol
...
// File: contracts/JETFUEL/strategies/Auto/StrategyAutoV2.sol
 ...
 */
contract StrategyAutoV2 is Ownable, Pausable {
    ...
    address public constant autofarm =
    ...
    function chargeFees() internal {
        uint256 toWbnb =
            IERC20(Auto).balanceOf(address(this)).mul(6).div(100);
