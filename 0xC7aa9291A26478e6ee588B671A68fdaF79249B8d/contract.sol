...
pragma solidity ^0.8.4;
contract SPT is BEP20, BEP20Detailed {
  using SafeBEP20 for IBEP20;
  using Address for address;
  using SafeMath for uint256;
  
  
  constructor () BEP20Detailed("Spectivetest", "SPT", 18)
  {
    _totalSupply = 120000000 *(10**uint256(18));
...
contract PreSale is Owned{
  ...
  constructor(address _wallet, SPT _token, IBEP20 _busd) {
   ...
   * @return Number of tokens that can be purchased with the SPTified _amount
   */
