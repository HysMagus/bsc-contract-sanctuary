...
/**
 * @dev Contract for Squid Game Coin
 */
contract SquidGameCoin is Pausable, Ownable, Burnable, Lockable, ERC20 {
    uint256 private constant _initialSupply = 7_874_965_732e18;

    constructor() ERC20("Squid Game Coin", "SGC") {
