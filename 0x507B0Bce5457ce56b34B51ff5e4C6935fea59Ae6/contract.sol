...
contract TESTDISCO is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public devAddress = payable(0x71Cc5ee98a36fC49b09D9a8a7D2dd8bFC15C5cD7); //pay me
    address payable public marketingAddress = payable(0x9E3eDA5d6af640FB4ABac1A4E044dC68665A3B1E); // Marketing Address
    ...
    string private _name = "TDP14";
    string private _symbol = "DPT14";
    ...
    function initContract() external onlyOwner() {
        ...
        devAddress = payable(0x71Cc5ee98a36fC49b09D9a8a7D2dd8bFC15C5cD7);
        marketingAddress = payable(0x9E3eDA5d6af640FB4ABac1A4E044dC68665A3B1E);
    }
    ...
    function _transfer(
        ...
        require(!_isSniper[to], "Fucking Bot!");
        require(!_isSniper[msg.sender], "Bots Suck Dick!");
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        //Send to Marketing and dev addresses
    ...
    function isRemovedBot(address account) public view returns (bool) {
        return _isSniper[account];
    }
    
    function BotBlocker5000(address account) external onlyOwner() {
