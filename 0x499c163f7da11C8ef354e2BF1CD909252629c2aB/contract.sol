...
Rewards: 4% ETH Rewards
Liquidity: 2% Auto Liquidity 
Marketing: 3% Marketing and Buyback
Game: 2% Goes to the development of our game
Charity: 1% Goes to charity.
...
contract MiniKishuFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniKishuFloki";
    string constant _symbol = "MKFloki";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 5 / 10000;
