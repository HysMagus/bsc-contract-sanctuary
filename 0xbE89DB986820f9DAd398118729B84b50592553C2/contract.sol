...
// File: contracts/BIFI/interfaces/For.sol
...
// File: contracts/BIFI/interfaces/IFToken.sol
...
// File: contracts/BIFI/interfaces/IBankController.sol
...
// File: contracts/BIFI/interfaces/ForReward.sol
...
// File: contracts/BIFI/strategies/StrategyFortube.sol
...
contract StrategyFortube {
    ...
    */
     ...
     */
    address public rewards = address(0x75b4BA20405268B131A5849Cce49ff74fcE3d0c7); 
    address public vault = address(0xdb23B950cc24a6dFE1Ba2030464cc66644209f42);
    ...
    */
    ...
    function withdraw(uint _amount) external {
        ...
        if (withdrawalFee > 0){
            ...
            IERC20(want).safeTransfer(rewards, _fee);
        }        
    ...
    function doswap() internal {
        ...
        UniswapRouter(unirouter).swapExactTokensForTokens(_2token, 0, swap2TokenRouting, address(this), now.add(300));
        UniswapRouter(unirouter).swapExactTokensForTokens(_2wbnb, 0, swap2WbnbRouting, address(this), now.add(300));
    }
