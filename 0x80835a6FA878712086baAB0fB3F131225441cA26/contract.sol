/**
   ...
   Fair Launch 
   Welcome to MommyKishu
   
   Official Telegram = MommyKishu
   The Future Game Smart Chain 
...
contract MommyKishu is ERC20 {

    uint tokenTotalSupply = 1000000000;

    constructor() public ERC20("MommyKishu", "MommyKishu") {
