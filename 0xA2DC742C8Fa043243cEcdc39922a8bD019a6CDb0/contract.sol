...
// File: contracts/BIFI/strategies/Thugs/StrategyHoesVaultV2.sol
 ...
 * This is meant to be used as an upgrade candidate for vaults implementing the BeefyVaultV2. Newer vaults use BeefyVaultV3
 * and should use the 'StrategyHoes.sol' version of this strategy. The only difference is that newer vaults
 ...
 */
contract StrategyHoesVaultV2 is Ownable, Pausable {
