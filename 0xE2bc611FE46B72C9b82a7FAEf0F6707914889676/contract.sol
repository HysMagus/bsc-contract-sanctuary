...
// File: contracts\FlaskToken.sol
// FlaskToken with Governance.
contract FlaskToken is ERC20("BaoToken", "Bao"), Ownable, Authorizable {
    uint256 private _cap = 80000e18;
    ...
    modifier OnlyChef(){
        require(msg.sender == masterChef,"!chef");
        _;
    }
    ...
    function cap() public view returns (uint256) {
     ...
     // Update the master chef
    function chefUpdate(address _chef) public onlyOwner {
        masterChef = _chef;
    }
    ...
    function lock(address _holder, uint256 _amount) public OnlyChef {
