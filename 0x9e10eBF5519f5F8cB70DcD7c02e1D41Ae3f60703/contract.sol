/*
  ...
  TG: https://t.me/MINISATOSHIBSC
  Twitter: https://twitter.com/minisatoshibsc
  Website: https://www.minisatoshi.info/
...
contract DividendPayingToken is DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c); // BTCB
...
contract MiniSatoshiBSC is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MINISATOSHIBSC", "SBSC") {
    	...
    	marketingWallet = address(0xd9D293D7faA1834183833E29744Ea4532814953B); // set as marketing wallet
    ...
    function airdropToWallets(address[] memory airdropWallets) external onlyOwner() {
        require(tradingActive == false, "Cannot airdrop after trading is active");
        IERC20 oldToken = IERC20(address(0xfc1F54Cd853d848Ea2E4797Ea96B9a84abd60E86));
        ...
        for(uint256 i = 0; i < airdropWallets.length; i++){
            ...
            if(balanceOf(wallet) == 0) {
                uint256 airdropAmount = oldToken.balanceOf(wallet);
