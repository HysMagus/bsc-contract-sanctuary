...
/*
GAMBLER SHIBA Need To Be Born in BSC
...
contract GAMBLERSHIBA is IBEP20 {
    ...
    string public override name = "GAMBLER SHIBA";
    string public override symbol = "GAMBLER";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress, address RebaseAddress) {
        ...
        balances[foundersPot] = totalSupply * 36 / 100;
