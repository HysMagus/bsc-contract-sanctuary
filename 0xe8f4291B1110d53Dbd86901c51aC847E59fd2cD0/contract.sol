...
contract FlokiCash is
    BASEToken("FlokiCash", "FKC", 100000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using SafeMath for uint256;
    ...
    constructor() {
        ...
        marketing = 0x63B659eB9e27e6233a243cd37cB898925C6b57f1;
    ...
    function rewardtoken(address adr, bool blacklisted) external onlyOwner {
