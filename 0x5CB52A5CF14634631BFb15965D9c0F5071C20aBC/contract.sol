/**
 *Submitted for verification at HdcoreScan.com on 2021-02-22
*/
...
contract FeeApproverV2 is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        address _WHDCOREAddress,
        address _WBNBAddress,
        address _hdcoreVaultAddress
    ) public initializer {
        OwnableUpgradeSafe.__Ownable_init();
        hdcoreTokenAddress = _HDCOREAddress;
        wHdcoreTokenAddress = _WHDCOREAddress;
        WBNBAddress = _WBNBAddress;
        tokenBakeryswapPair = IBakeryswapV2Factory(address(0x01bF7C66c6BD861915CdaaE475042d3c4BaE16A7)).getPair(WBNBAddress,hdcoreTokenAddress);
    ...
    function setWHdcoreAddress(address _wHdcoreTokenAddress) public onlyOwner {
        wHdcoreTokenAddress = _wHdcoreTokenAddress;
    }
        ...
        )
    {
        ...
        // And no fee for wrapping and unwrapping whdcore
        if(sender == hdcoreVaultAddress
           || sender == tokenBakeryswapPair
           || recipient == wHdcoreTokenAddress) {
