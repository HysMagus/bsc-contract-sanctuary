...
/**
    ...
    I make this #FlokiBurnForever to hand over it to the community.
    Create the community by yourself if you are interested.   
    I suggest a telegram group name for you to create: https://t.me/FlokiBurnForeverBsc

   Two token features:
   2% fee auto add to the liquidity pool to locked forever when selling
   2% fee auto distribute to all holders
   20% burn to the black hole, with such big black hole and 2% fee, the strong holder will get a valuable reward

   I will burn liquidity LPs to burn addresses to lock the pool forever.
   I will renounce the ownership to burn addresses to transfer #LightGate to the community, make sure it's 100% safe.

   I will add 0.7 BNB and all the left 80% total supply to the pool
   Can you make #LightGate 100000X? 
  ...
  100% SAFE NO RUG.
   ...
   it's the best part of the #LightGate idea, increasing the liquidity pool automatically, 
...
contract FlokiBurnForever is Context, IERC20, Ownable {
    ...
    string private _name = "FlokiBurnForever";
    string private _symbol = "FBF";
