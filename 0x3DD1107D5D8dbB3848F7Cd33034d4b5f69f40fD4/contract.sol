...
contract GalacticIntelContinentalCouncil is Context, IERC20, Ownable {
    ...
    string  private constant _NAME = 'Galactic Intel Continental Council';
    string  private constant _SYMBOL = 'GICC';
