...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0x79494a113a163dF1F91Af4AB812E125300955137;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0x79494a113a163dF1F91Af4AB812E125300955137;
        _token = msg.sender;
    }
...
contract MicroFrunk is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x79494a113a163dF1F91Af4AB812E125300955137;

    string constant _name = "MicroFrunk";
    string constant _symbol = "MicroFrunk";
