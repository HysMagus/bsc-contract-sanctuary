...
contract DOGEpup is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 80 * 10**12 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    string private _name = "DOGEpup";
    string private _symbol = "DOGEpup";
    ...
    uint256 public _maxTxAmount = 4 * 10**5 * 10**6 * 10**9;
    ...
    function _transfer(
        ...
        if (!inSwapAndLiquify && swapAndLiquifyEnabled && to == uniswapV2Pair) {
            if (overMinimumTokenBalance) {
                ...
                swapTokens(contractTokenBalance.div(3)); 
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        swapTokensForBusd(transferredBalance/2);
        uint256 remainingBalance=transferredBalance/2;
        //Send to Marketing address
        transferToAddressBNB(marketingAddress, remainingBalance.div(2));
    ...
    function swapTokensForBusd(uint256 bnbAmount) private {
        ...
        emit SwapTokensForBUSD(bnbAmount, path);
    }
