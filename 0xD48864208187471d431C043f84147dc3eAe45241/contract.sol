...
contract BEP20UpgradeSafe is Initializable, ContextUpgradeSafe, IERC20 {
...
contract btcBASE is BEP20UpgradeSafe, OwnableUpgradeSafe {
    ...
    function initialize()
        ...
        initializer
    {
        __ERC20_init("btcBASE", "btcBASE");
        _setupDecimals(uint8(DECIMALS));
        __Ownable_init();
        
        _totalSupply = 2700 * 10**18 ;
