...
// File: contracts/NarwhalRewardHugeV2.sol
...
contract NarwhalRewardHugeV2 is LPTokenWrapper{
    using SafeERC20 for IERC20;
    ...
    uint256 public _minRate = 99999 * 1e18;
    ...
    function setMinRate(uint256 minRate) public onlyGovernance{
         _minRate = minRate;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(balanceOf(msg.sender).add(amount) > _minRate , "Balance < minRate");
