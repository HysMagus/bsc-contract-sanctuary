...
contract defiyieldprotocol is ERC20 {
    ...
    string public constant name = "defiyieldprotocol";
    string public constant symbol = "DYP";
    uint public constant decimals = 18;
    uint public deadline = now + 0 * 1 seconds;  //Now
    uint public round2 = now + 50 * 1 days;
    uint public round1 = now + 10 * 1 days;
    
    uint256 public totalSupply = 2240e18;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 100 BNB or more and get 2% more DYP of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 100 BNB or more and get 1% more DYP of round 2
