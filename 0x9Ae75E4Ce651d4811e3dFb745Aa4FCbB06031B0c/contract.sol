...
contract Consts {
    ...
    string public constant TOKEN_NAME = "White Token";
    string public constant TOKEN_SYMBOL = "WHT";
    bool public constant PAUSED = true;
    address public constant TARGET_USER = 0x608557b90146663C9cc41015d3E16Fcd307344D3;
    
    uint public constant START_TIME = 1601410547;
...
contract BonusableCrowdsale is Consts, Crowdsale {
    ...
    function getBonusRate(uint256 _weiAmount) internal view returns (uint256) {
        ...
        uint[4] memory weiRaisedStartsBounds = [uint(35714285714285714),uint(7142857142857142857143),uint(25000000000000000000000),uint(42857142857142857142857)];
        uint[4] memory weiRaisedEndsBounds = [uint(7142857142857142857143),uint(25000000000000000000000),uint(42857142857142857142857),uint(71428571428571428571429)];
        uint64[4] memory timeStartsBounds = [uint64(1601410547),uint64(1601410547),uint64(1601410547),uint64(1601410547)];
        uint64[4] memory timeEndsBounds = [uint64(1602706495),uint64(1602706495),uint64(1602706495),uint64(1602706495)];
        uint[4] memory weiRaisedAndTimeRates = [uint(100),uint(75),uint(50),uint(25)];
        ...
        // apply amount
        uint[2] memory weiAmountBounds = [uint(200000000000000000000),uint(10000000000000000000)];
    ...
    
{
    ...
    constructor(MintableToken _token) public
        Crowdsale(28 * TOKEN_DECIMAL_MULTIPLIER, 0x608557b90146663C9cc41015d3E16Fcd307344D3, _token)
        TimedCrowdsale(START_TIME > now ? START_TIME : now, 1602706500)
        CappedCrowdsale(71428571428571428571429)
        
        RefundableCrowdsale(357142857142857142857)
