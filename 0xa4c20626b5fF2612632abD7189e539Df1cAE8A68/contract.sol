...
contract FOMOBABY is IERC20, Ownable {
    ...
    address public marketingWallet = BURN_ADDRESS; //CHANGEME add address
    address public lotteryWallet = BURN_ADDRESS; //CHANGEME add address
    ...
    uint256 private _fomosPerFragment;
    mapping(address => uint256) private _fomoBalances;
    ...
    function swapAndLiquify (uint256 contractTokenBalance) private lockTheSwap {
        ...
        uint256 ethForOtherFees = addLiquidity (tokensForLiquidity, tokensToETH);
        ...
        payable(lotteryWallet).transfer (marketingETH);
    }
