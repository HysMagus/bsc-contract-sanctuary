...
Please join : https://t.me/LuckyKishuToken

  _               _            _  ___     _           
 | |   _   _  ___| | ___   _  | |/ (_)___| |__  _   _ 
 | |  | | | |/ __| |/ / | | | | ' /| / __| '_ \| | | |
 | |__| |_| | (__|   <| |_| | | . \| \__ \ | | | |_| |
 |_____\__,_|\___|_|\_\\__, | |_|\_\_|___/_| |_|\__,_|
                       |___/                          
...
contract DividendDistributor is IDividendDistributor {
    ...
    IERC20 REWARDCOIN = IERC20(0x7083609fCE4d1d8Dc0C979AAb8c869Ea2C873402);
...
contract LuckyKishu is IERC20, Ownable {
    using SafeMath for uint256;

    // CHANGE
    address REWARDCOIN = 0xbA2aE424d960c26247Dd6c32edC70B295c744C43;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "LuckyKishu";
    string constant _symbol = "$LUCKYKISHU";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000 * (10 ** _decimals); // 1,000,000
    uint256 public _maxTxAmount = (_totalSupply * 25) / 1000; // 2.5% 25,000
    uint256 public _maxWalletSize = (_totalSupply * 50) / 1000; // 5% 50,000
    ...
    constructor () {
        ...
        devFeeReceiver = address(0xd664559ECbe58006aA70A0A2c1cCA9BB683De935);
