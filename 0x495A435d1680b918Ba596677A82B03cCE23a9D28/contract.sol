/**
 *Submitted for verification at BscScan.com on 2021-28-09
*/
...
contract Ownable is Context {
    ...
    /**
     * @dev Transfers manager of the contract to a new account (`newTeam`).
...
contract Puryland is Context, IERC20, Ownable {
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        */
        ...
        /*
        * transfer amount, it will take tax, burn, liquidity fee, marketing fee
        */
