...
// File: contracts/KILOLImplementation.sol
...
/**
 * @title KILOLImplementation
 * @dev this contract is a Pausable BSC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing KILOLImplementation
...
contract KILOLImplementation {
    ...
    string public constant name = "KILOL"; // solium-disable-line
    string public constant symbol = "KILOL"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all KILOL at the contract address.
     * This sends the KILOL tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimKILOL() external onlyOwner {
    ...
    */
     ...
     * @param fee an optional BSC20 fee paid to the executor of betaDelegatedTransfer by the from address.
     ...
     * @param to The address to transfer to.
     * @param value The amount to be transferred.
     * @param fee an optional BSC20 fee paid to the delegate of betaDelegatedTransfer by the from address.
     * @param seq a sequencing number included by the from address specific to this contract to protect from replays.
     * @param deadline a block number after which the pre-signed transaction has expired.
     * @return A boolean that indicates if the operation was successful.
     */
     ...
     * @param fee optional BSC20 fees paid to the delegate of betaDelegatedTransfer by the from address.
