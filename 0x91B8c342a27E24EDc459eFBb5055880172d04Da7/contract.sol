...
// File: contracts\GamerSwapToken.sol

pragma solidity 0.6.12;


// GamerSwapToken with Governance.
contract GamerSwapToken is BEP20('GamerSwap Token', 'GAMER') {
    ...
    /**
     * @notice Constructs the MILK BEP-20 contract.
     */
    constructor(address _treasury) public {
        // Mints 2500 MILK to treasury, 2000 for airdrop and 500 for meme contest
        treasury = _treasury;
...
// File: contracts\GamerBar.sol

pragma solidity 0.6.12;



// GamerBar with Governance.
contract GamerBar is BEP20('GamerBar Token', 'GBAR') {
    /// @notice Creates `_amount` token to `_to`. Must only be called by the owner (MasterChef).
    function mint(address _to, uint256 _amount) public onlyOwner {
        _mint(_to, _amount);
        _moveDelegates(address(0), _delegates[_to], _amount);
    ...
    // The MILK TOKEN!
    GamerSwapToken public milk;


    constructor(
        GamerSwapToken _milk
    ) public {
        milk = _milk;
    }
