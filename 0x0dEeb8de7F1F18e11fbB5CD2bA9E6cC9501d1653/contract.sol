...
contract CakePenis is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "CakePenis";
    string constant _symbol = "CakePENIS";
    ...
    uint256 reflectionFee   = 180;
    uint256 marketingFee    = 20;
    uint256 totalFee = 220;
    ...
    constructor () Auth(msg.sender) {
        ...
        distributor = new DividendDistributor(address(router), 0x580dE58c1BD593A43DaDcF0A739d504621817c05);
 ...
 function claimTokens(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
