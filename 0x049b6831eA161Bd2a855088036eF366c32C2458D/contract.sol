...
contract bbSFI is ERC20 {
  using SafeERC20 for IERC20;

  address public governance;
  address public bbSFI_minter;
  ...
  function mint_bbSFI(address to, uint256 amount) public {
    require(msg.sender == bbSFI_minter, "must be bbSFI_minter");
