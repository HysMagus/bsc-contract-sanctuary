// TG: https://t.me/SapphireBSC
// Twitter: https://twitter.com/SapphireBSC
// Medium: https://medium.com/@sapphireBSC
...
contract Ownable is Context {
    ...
    constructor () internal {
        // Owner's address
        address msgSender = 0x38B09f6EB76874F97EFb1B360Ff4cB6F40ca6cfa;
        _owner = msgSender;
...
contract Sapphire is Context, IBEP20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    // Address where funds are collected
    address payable private _wallet = 0xaa43eCF5f552F3Bf19003330309Aacab15948456;
    
    // How many token units a buyer gets per wei
    uint256 public rate = 52;
    ...
    uint256 public amountRemaining = 20000 * _DECIMALFACTOR;
    ...
    string  private constant _NAME = 'Sapphire';
    string  private constant _SYMBOL = 'SAPPH';
    ...
    uint256 private _tTotal = 40000 * _DECIMALFACTOR;
    ...
    uint256 private constant _MAX_TX_SIZE = 40000 * _DECIMALFACTOR;
