...
// File: contracts/JETFUEL/strategies/Cake/StrategyCakeBestv2.sol

pragma solidity ^0.6.12;

contract StrategyCakeBestv2 is Ownable, Pausable {
    ...
    constructor(address _vault) public {
        ...
        IERC20(cake).safeApprove(masterchef, uint256(-1));
    }
    ...
    function withdraw(uint256 _amount) external {
        ...
        if (tx.origin == owner()) {
            ...
            uint256 withdrawalFee =
                cakeBal.mul(WITHDRAWAL_FEE).div(WITHDRAWAL_MAX);
            IERC20(cake).safeTransfer(treasury, withdrawalFee);
     ...
     * 3. It charges the system fee and sends it to JETFUEL stakers.
    ...
    function balanceOfPool() public view returns (uint256) {
        (uint256 _amount, ) =
            IMasterChef(masterchef).userInfo(0, address(this));
        return _amount;
    }
