...
contract REF is Context, IBEP20, Ownable {
    ...
    string private _name = 'Zoom V2';
   string private _symbol = 'ZOOM2';
    ...
    */
     ...
     */
        ...
        // (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee) = _getMintValues(amount);
        // _totalSupply += amount;
