...
/**
   ...
   1% distribute to a Charity Wallet 
   6% of transaction fee will go to Holders
   ttl supply = 109,876,543,210
   decimals 9
*/
...
contract LAUNCHER is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x9f9BBfAC7E1F462231374362155fd83C8fd43e82;
   
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 109876543210 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = "LAUNCHER Coin";
    string private _symbol = "LAUNCHER";
    ...
    uint256 public _maxTxAmount = 109876543210 * 10**9;
