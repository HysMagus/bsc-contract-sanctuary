...
| $$  | $$| $$  | $$   | $$| $$      | $$_____/| $$ | $$ | $$ /$$__  $$| $$      | $$  | $$ \____  $$
| $$$$$$$/|  $$$$$$/   | $$| $$      |  $$$$$$$|  $$$$$/$$$$/|  $$$$$$$| $$      |  $$$$$$$ /$$$$$$$/
|_______/  \______/    |__/|__/       \_______/ \_____/\___/  \_______/|__/       \_______/|_______/ 
...
🗣 Usecase and Roadmap
💪 Marketing wallet 
👥 Shilling contest at launch
🧠 Experienced Dev Team
🤹 Community Giveaways

—————————————————————
TG 🔈: https://t.me/stealthdot
*/
...
contract Dotrewards is ERC20, Ownable {
    ...
    constructor() ERC20("DOTrewards", "DOTR") public {
    ...
    function excludeMultipleAccountsFromFees(address[] calldata accounts, bool excluded) public onlyOwner {
        ...
        function enablerewardsFee(uint256 value) external onlyOwner{
            rewardsFee = value;
        }
        


        function marketing(uint256 value) external onlyOwner{
            marketingFee = value;
        }
    ...
    function setMarketingWallet(address payable wallet) external onlyOwner{
        ...
        function setPercentageliquidity_fee(uint256 value) external onlyOwner{
            liquidityFee = value;
        }
    ...
    function blacklistAddress(address account, bool value) external onlyOwner {
        ...
        function set_percentage_Buy_fee(uint256 value) external onlyOwner {
            buyFee = value;
        }
