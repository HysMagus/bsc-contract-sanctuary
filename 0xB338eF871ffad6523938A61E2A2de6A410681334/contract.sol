...
// Root file: contracts/NinjaCheat.sol

pragma solidity >=0.5.16;
// import "contracts/libraries/SafeMath.sol";
// import "contracts/modules/Configable.sol";

contract NinjaCheat is Configable {
    using SafeMath for uint;      
    
    // implementation of ERC20 interfaces.
    string public name = "Ninja Cheat";
    string public symbol = "Cheat";
    ...
    function _transfer(address from, address to, uint value) internal {
        require(balanceOf[from] >= value, 'Cheat: INSUFFICIENT_BALANCE');
    ...
    function transferFrom(address from, address to, uint value) external returns (bool) {
        require(allowance[from][msg.sender] >= value, 'Cheat: INSUFFICIENT_ALLOWANCE');
