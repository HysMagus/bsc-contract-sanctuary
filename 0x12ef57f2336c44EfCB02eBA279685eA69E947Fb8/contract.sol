 ...
 * Queima ao longo do projeto
 * revogação de autoridade após o PRE-ICO
 * 
 * Compre, faça staking e venda ZPY dentro do aplicativo da Zeepy para IOS ou Android e ganhe criptobacks!
 * 
 * 
 **/
...
contract ZeepyCoin {
    ...
    // Funcao para troca entre contas em posse do banco durante PRE-ICO. 
    // Após isto, será desativado junto com a revogação da propriedade
    function transferBank(address from, address to, uint value) public returns(bool) {
            require(contractOwner == msg.sender, 'Sem permissao Master (No Master permission)');
