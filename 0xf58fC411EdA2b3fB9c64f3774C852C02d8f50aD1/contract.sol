...
/**
 * @title GRM price Oracle
 *      This Oracle calculates the average USD price of GRM based on the BNB-GRM and USDC-BNB pools.
...
contract MarketOracle is Ownable {
    ...
    constructor(
        address __grm_bnb,   // Address of the grm-BNB pair on Pancakeswap
