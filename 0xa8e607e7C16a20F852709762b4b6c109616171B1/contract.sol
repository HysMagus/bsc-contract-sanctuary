...
contract REDSHIELD is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x487a7f1FD8bE48d2553C6D50bff5990c04C09917); // Marketing Address
    ...
    string private _name = "REDSHIELD";
    string private _symbol = "RSD";
