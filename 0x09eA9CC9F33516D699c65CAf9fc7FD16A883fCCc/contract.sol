...
interface IDemoSwap{
     ...
     * 
    */ 
    function swapTokenToNativeAndOtherToken(address payable fromAddress, uint fromAmount, address otherTokenAddress, uint nativePercent) external returns (bool);
}
...
contract DemoSwap is IDemoSwap, Ownable{
     ...
     * 
     */ 
    function swapTokenToNativeAndOtherToken(address payable fromAddress, uint fromAmount, address otherTokenAddress, uint nativePercent) external override returns (bool){
    ...
    */ 
    ...
    function _swapTokenToNativeAndOtherToken(address payable fromAddress, uint fromAmount, address otherTokenAddress, uint nativePercent) internal returns (bool){
        ...
        if(fromNativeAmount > 0){
            if(fromAddress == _wbnbAddress){
                ...
                fromAddress.transfer(fromNativeAmount);
            }
            else{
