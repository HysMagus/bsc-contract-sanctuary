...
contract Presale {
    ...
    // *** Config ***
    uint startPresale = 1613889076;     // unix timestamp for presale to go live
    uint percentSell = 90;              // 22,500 token presale
    uint256 pricePresale = 100;           // 1.00 BNB PER
    uint256 multiplierPresale = 100;     // change to multiply above price rate
    uint256 maxPerWallet = 100 ether;    // Max 100 BNB per Wallet
    // --- Config ---
