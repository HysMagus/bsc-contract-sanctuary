...
contract Stake_BORB is Ownable {
    using SafeMath for uint256;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint256 amount);
    
    // BORB token contract address
    address public tokenAddress = 0x83b2866e9940AE36BC6BC63593613eBc6455bcFC;
    ...
    uint256 public cliffTime = 3 days;
     ...
     // claim possible after 3 days
    uint256 public claimTime = 3 days;
    ...
    function claimDivs() public {
        require(now.sub(stakingTime[msg.sender]) > claimTime, "You recently staked, please wait before claim your reward.");
        updateAccount(msg.sender);
    }
    ...
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint256 _amount) public onlyOwner {
        if (_tokenAddr == tokenAddress) {
            require(totalStakeAmount >= totalStakeAmount + _amount, "You can't withdraw user's staked amount");
