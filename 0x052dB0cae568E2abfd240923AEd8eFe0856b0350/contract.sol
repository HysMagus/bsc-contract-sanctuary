...
contract Owned {
    ...
    constructor()  {
        owner = 0x44eaD5Fab4919Df7F752731B77b31c638467b2e3;
    }
...
contract Turizmo is IERC20, Owned, SafeMath {
 ...
 constructor() {
        name = "Turizmo Network Token V2";
        symbol = "TNX";
        decimals = 18;
        _totalSupply = 208000000e18;         // 208,000,000 TNX
        address owner = owner;
