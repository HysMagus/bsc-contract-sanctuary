...
contract GameKing is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingWalletAddress = payable(0xb3044aFd722723dAD9Ab8391dE4E2D0aaf21cd67); // Marketing Address
    ...
    string private _name = "GameKing";
    string private _symbol = "GAMEKING";
    ...
    function _transfer(address from, address to, uint256 amount) private {
        ...
        if(to == uniswapV2Pair && !_isExcludedFromFee[from]) {
            require(amount <= _maxBuyAmount, "Transfer amount exceeds the maxBuyTxAmount.");
        }
