...
library Constants {
    ...
    uint256 private constant BOOTSTRAPPING_PRICE = 1e18; // 1 BUSD 
    ...
    /* Regulator */
    uint256 private constant SUPPLY_CHANGE_LIMIT = 225e14 ; // 2.25%
    uint256 private constant SUPPLY_CHANGE_DIVISOR = 35e18; // 35 > Max expansion at 1.7875
    ...
    uint256 private constant ORACLE_POOL_RATIO = 52; // 52%
    
    /* Deployed */
    address private constant DAO_ADDRESS = address(0xd05fE6E1c4b5f6e1d0EAF073512D62655f6F7b0C);
    address private constant DOLLAR_ADDRESS = address(0xB913AA79a0365bC4d30c217aE2916E6E2c44c882);
    address private constant PAIR_ADDRESS = address(0xA6d8B28933A800d7badb55475B3Ad9AA9d057A01);
...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    function initialize() initializer public {
                ...
                _state.provider.pool = 0xb5acFbA71c4b215FbFC87e74A7C17Ac51ef58feb;
