...
contract SALT_NETWORK {

	uint256 constant private FLOAT_SCALAR = 2**64;
	uint256 constant private INITIAL_SUPPLY = 150000e18; //available supply
	uint256 constant private BURN_RATE = 10; //burn every per txn
	uint256 constant private SUPPLY_FLOOR = 30; // % of supply
	uint256 constant private MIN_FREEZE_AMOUNT = 1e18; //Minimum amount for stake

	string constant public name = "PEPPER";
	string constant public symbol = "PPR";
