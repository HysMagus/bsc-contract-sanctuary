...
//------------== 
bool public isCAKEStaking = true ;
bool public isAfiComp = false ;
uint256 public constant pid = 0 ;
address public constant wantAddress = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;//cake
address public constant token0Address= 0x0000000000000000000000000000000000000000 ;
address public constant token1Address= 0x0000000000000000000000000000000000000000 ;
...
//------------== 
    ...
    // ---------------==
    address public constant uniRouterAddress= 0x10ED43C718714eb63d5aA57B78B54704E256024E;
    address public constant wbnbAddress = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;

    address public constant afiFarmAddress = 0x657D0420F696aAedC48B40545Ba5e85b10e4C746; 
    address public constant AFIAddress = 0xC6bfcf0469a74b36c070b807162fFcbF7B0a1103;//AFIB

    address public govAddress = 0x6f0026469e743C75c984b0579F854F1709206114;
    
    address public constant receiveFee =
        address(0xA9B643B2fD2883AdEe7fdDE59bb477110328d224); //aries
        
    //address public constant fundManager = address(0xa9186c17dAA92Dd89F521fb26d25D1101E423FaF); //
    ...
    uint256 public constant controllerFeeUL = 5000;

    uint256 public buyBackRate = 1500;
    uint256 public constant buyBackRateMax = 10000; // 100 = 1%
    uint256 public constant buyBackRateUL = 2000;
    ...
    address[] public earnedToAFIPath;
    ...
    constructor(
      ...
      */
        ...
        if (isAfiComp) {
            ...
            earnedToAFIPath = [earnedAddress, wbnbAddress, AFIAddress];
            if (wbnbAddress == earnedAddress) {
                earnedToAFIPath = [wbnbAddress, AFIAddress];
            }
        ...
        returns (uint256)
    {
        ...
        uint256 withdrawalFee =
            _wantAmt.mul(WITHDRAWAL_FEE).div(WITHDRAWAL_MAX);
        ...
        //IERC20(wantAddress).safeTransfer(afiFarmAddress, _wantAmt);
        IERC20(wantAddress).safeTransfer(
            afiFarmAddress,
            _wantAmt.sub(withdrawalFee)
        );
    ...
    function distributeFees(uint256 _earnedAmt) internal returns (uint256) {
        if (_earnedAmt > 0) {
            ...
            if (controllerFee > 0) {
                ...
                //IERC20(earnedAddress).safeTransfer(fundManager, fee.mul(75).div(100));
                IERC20(earnedAddress).safeTransfer(receiveFee, fee);
