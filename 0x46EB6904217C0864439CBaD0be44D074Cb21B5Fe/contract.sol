...
contract Master is Ownable {
    ...
    // Market oracle provides the FSTM/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _FSTM) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = FSTM.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && FSTM.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(FSTM.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return FSTM.totalSupply().toInt256Safe()
