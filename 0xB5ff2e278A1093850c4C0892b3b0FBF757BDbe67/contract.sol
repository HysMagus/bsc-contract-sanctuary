...
// File: contracts\CrowTalons.sol

pragma solidity >=0.6.6;

contract CrowTalons is ERC20('Talons Token', 'TALONS'), Ownable {
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying Crow (not scaled);
...
// File: contracts\CrowFarmContract.sol

pragma solidity 0.6.12;

contract CrowFarmContract is Ownable {
    ...
    function getCurrentCrowRewardPerBlock() public view returns (uint256 currentBlockCrow) {
