...
contract Master is Ownable {
    ...
    // Market oracle provides the Eve/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _Eve) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = Eve.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && Eve.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(Eve.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return Eve.totalSupply().toInt256Safe()
