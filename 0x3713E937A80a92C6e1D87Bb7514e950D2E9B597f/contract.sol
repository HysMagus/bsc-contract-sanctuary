...
contract BSCBucks is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'BSCBucks';
    string  private constant _SYMBOL = 'BBucks';
    ...
    uint256 private _tTotal = 25000 * _DECIMALFACTOR;
