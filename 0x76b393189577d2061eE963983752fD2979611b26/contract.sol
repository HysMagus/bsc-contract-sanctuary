...
library Constants {
    ...
    /* Bootstrapping */
    uint256 private constant BOOTSTRAPPING_PERIOD = 5; // 240 epochs
    uint256 private constant BOOTSTRAPPING_PRICE = 144e16; // 1.44 BUSD

    /* Oracle */
    address private constant BUSD = address(0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56);
    uint256 private constant ORACLE_RESERVE_MINIMUM = 1e18; // 1 BUSDs
    ...
    uint256 private constant EPOCH_START = 1610521200;
    uint256 private constant EPOCH_PERIOD = 300;

    /* Governance */
    uint256 private constant GOVERNANCE_PERIOD = 3;
    uint256 private constant GOVERNANCE_QUORUM = 33e16; // 33%
    uint256 private constant GOVERNANCE_SUPER_MAJORITY = 66e16; // 66%
    uint256 private constant GOVERNANCE_EMERGENCY_DELAY = 6; // 6 epochs

    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE = 10e18; // 10 TSD
    ...
    /* Market */
    uint256 private constant COUPON_EXPIRATION = 10;
...
// File: contracts/oracle/IBUSD.sol
...
contract Pool is PoolSetters, Liquidity {
    ...
    event Provide(address indexed account, uint256 value, uint256 lessBusd, uint256 newUniv2);
    ...
    function provide(uint256 value) external onlyFrozen(msg.sender) notPaused {
        ...
        (uint256 lessBusd, uint256 newUniv2) = addLiquidity(value);
        ...
        emit Provide(msg.sender, value, lessBusd, newUniv2);
    }
