...
contract ERC20 is Context, IERC20 {
    ...
    constructor (string memory name, string memory symbol, uint256 decimals, uint256 burnrate, uint256 initSupply) public {
        ...
        _burnRate = burnrate;
        _totalSupply = 0;
        _createToken(msg.sender, initSupply*(10**_decimals));
        _burnedSupply = 0;
    }
     ...
     */
    function _createToken(address account, uint256 amount) internal virtual {
...
// OBRBTS token
contract OBRBTS is ERC20("OBRB TS", "OBRB", 18, 2, 8000), Ownable{
