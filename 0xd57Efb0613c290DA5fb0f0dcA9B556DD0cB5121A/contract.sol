...
// File: contracts\BFI\Collectibles.sol
 ...
 */
contract Beefy is ERC721, Ownable {
    using Counters for Counters.Counter;
    Counters.Counter private _tokenIds;

    constructor() public ERC721("BeefyCollectibles", "RareItem") {}

    function awardRareItem(address user, string memory tokenURI)
        public
        onlyOwner
        returns (uint256)
    {
        _tokenIds.increment();
        uint256 newRareItem = _tokenIds.current();
        _mint(user, newRareItem);
        _setTokenURI(newRareItem, tokenURI);
        return newRareItem;
    }
}