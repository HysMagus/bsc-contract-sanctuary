...
// File: contracts/BIFI/interfaces/Strategy.sol
...
// File: contracts/BIFI/vaults/MooVault.sol
...
contract MooVault is ERC20 {
    ...
    address public strategy = address(0xeAc48C344F83c00660Beb663f9Dd47941A16F525);
    ...
    constructor (address _token) public ERC20(
        string(abi.encodePacked("Moo ", ERC20(_token).name())),
        string(abi.encodePacked("moo", ERC20(_token).symbol()))
    ) {
        token = IERC20(_token);
    }
