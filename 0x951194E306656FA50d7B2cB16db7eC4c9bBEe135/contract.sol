...
contract PERPETUUM is ERC20, Ownable {
    ...
    address public _teamWalletAddress = address(0x0e44a6d37E9A04a4e5Dd42178688E3B333C83476); // Team Wallet
    address public _projectWalletAddress = address(0xe92C350d85cE94B376dBfDe709566A3CbC19b4e3); //Project Wallet
    ...
    constructor() ERC20("PERPETUUM", "PRP") {
        ...
        buyFee.projectFee = 90; // 9% Project fee
        buyFee.teamFee = 10;  // 1% team fee
        totalBuyFee = buyFee.projectFee + buyFee.teamFee;

        sellFee.projectFee = 80; // 8% project fee
        sellFee.teamFee = 70;   // 7% team fee
    ...
    function updateUniswapV2Router(address newAddress) external onlyOwner {
        require(newAddress != address(uniswapV2Router), "PRP: The router already has that address");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "PRP: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "PRP: Automated market maker pair is already set to that value");
