//The FREESHIT TOKEN SHIT FACTORY COPY PASTA FROM STORM WHO COPY PASTA FROM SOMEONE WHO COPY PASTA FROM SUSHI
...
contract FreeShit is ERC20("FreeShit", "FREE"), Ownable {
...
// File: contracts/ThunderCloud.sol
...
//
contract ShitFactory is Ownable {
    using SafeMath for uint256;
