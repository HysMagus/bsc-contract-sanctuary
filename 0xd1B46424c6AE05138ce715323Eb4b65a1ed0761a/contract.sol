...
/*
 ...
 | |   / _` | |/ / _ \  / _ \/\ | | | | '_ \ 
 | |__| (_| |   <  __/ | (_>  < | |_| | |_) |
  \____\__,_|_|\_\___|  \___/\/  \___/| .__/ 
                                      |_|    

CakeAndUp ^

Introducing CakeAndUp
The first token on the BSC smartchain to combine the rebase rewards with Cake rewards.
Hold $CakeAndUp and receive $Cake directly to your BEP-20 wallet as a reward for holding

📱 Telegram: https://t.me/cakeandup
🌎 Website: https://cakeandup.xyz 
🌐 Twitter: https://twitter.com/cakeandup
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 REWRD = IBEP20(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    ...
    function deposit() external payable override onlyToken {
        uint256 balanceBefore = REWRD.balanceOf(address(this));

        address[] memory path = new address[](2);
        path[0] = WBNB;
        path[1] = address(REWRD);
        ...
        uint256 amount = REWRD.balanceOf(address(this)).sub(balanceBefore);
    ...
    function distributeDividend(address shareholder) internal {
        ...
        if(amount > 0){
            ...
            REWRD.transfer(shareholder, amount);
...
contract CakeAndUp is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Cake & Up";
    string constant _symbol = "CakeAndUp";
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0xBc8DF801F0612ce766ec9fFB2396032EE237Cb10;
