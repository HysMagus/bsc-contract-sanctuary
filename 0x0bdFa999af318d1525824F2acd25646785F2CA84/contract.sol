...
contract Lizard is ERC20, Ownable {
    using SafeMath for uint256;

    IUniswapV2Router02 public uniswapV2Router;
    address public immutable uniswapV2Pair;
    
    string private _name = "Lizard";
    string private _symbol = "Lizard";
    uint8 private _decimals = 18;

    LizardDividendTracker public dividendTracker;
    ...
    event LizardRoarChange(bool indexed newValue, bool indexed oldValue);
    ...
    constructor() public ERC20("Lizard", "Lizard") {
        liquidityWallet = owner();
    	marketingWallet = owner();
    	salaryWallet = owner();
    	buyBackWallet = owner();
    	
    	dividendTracker = new LizardDividendTracker();
    ...
    function cancelLaunch() public onlyOwner {
        require(this.isInLaunch(), "Lizard: Launch is not set");
    ...
    function setLizardRoar() public onlyOwner {
        require(!this.isInRoar(), "Lizard: Roar is already set");
        require(isTradingEnabled, "Lizard: Trading must be enabled first");
        require(!this.isInLaunch(), "Lizard: Must not be in launch period");
        emit LizardRoarChange(true, false);
        _roarStartTimestamp = _getNow();
    }
    function cancelLizardRoar() public onlyOwner {
        require(this.isInRoar(), "Lizard: Roar is not set");
        emit LizardRoarChange(false, true);
        _roarStartTimestamp = 0;
    }
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "Lizard: The dividend tracker already has that address");
        LizardDividendTracker newDividendTracker = LizardDividendTracker(payable(newAddress));
        require(newDividendTracker.owner() == address(this), "Lizard: The new dividend tracker must be owned by the Lizard token contract");
    ...
    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "Lizard: Automated market maker pair is already set to that value");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFee[account] != excluded, "Lizard: Account is already the value of 'excluded'");
    ...
    function excludeFromMaxTransactionLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxTransactionLimit[account] != excluded, "Lizard: Account is already the value of 'excluded'");
        _isExcludedFromMaxTransactionLimit[account] = excluded;
        emit ExcludeFromMaxTransferChange(account, excluded);
    }
    function excludeFromMaxWalletLimit(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromMaxWalletLimit[account] != excluded, "Lizard: Account is already the value of 'excluded'");
        _isExcludedFromMaxWalletLimit[account] = excluded;
        emit ExcludeFromMaxWalletChange(account, excluded);
    }
    function blacklistAccount(address account) public onlyOwner {
        uint256 currentTimestamp = _getNow();
        require(!_isBlacklisted[account], "Lizard: Account is already blacklisted");
        if (_isLanched) {
            require(currentTimestamp.sub(_launchStartTimestamp) < _blacklistTimeLimit, "Lizard: Time to blacklist accounts has expired");
        }
        _isBlacklisted[account] = true;
        emit BlacklistChange(account, true);
    }
    function unBlacklistAccount(address account) public onlyOwner {
        require(_isBlacklisted[account], "Lizard: Account is not blacklisted");
        _isBlacklisted[account] = false;
        emit BlacklistChange(account, false);
    }
    function setLiquidityWallet(address newAddress) public onlyOwner {
        require(liquidityWallet != newAddress, "Lizard: The liquidityWallet is already that address");
    ...
    function setMarketingWallet(address newAddress) public onlyOwner {
        require(marketingWallet != newAddress, "Lizard: The marketingWallet is already that address");
        emit MarketingWalletChange(newAddress, marketingWallet);
        marketingWallet = newAddress;
    }
    function setBuyBackWallet(address newAddress) public onlyOwner {
        require(buyBackWallet != newAddress, "Lizard: The buyBackWallet is already that address");
    ...
    function setSalaryWallet(address newAddress) public onlyOwner {
        require(salaryWallet != newAddress, "Lizard: The salaryWallet is already that address");
    ...
    function setLiquidityFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(liquidityFeeOnBuy != newvalue, "Lizard: The liquidityFeeOnBuy is already that value");
    ...
    function setMarketingFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnBuy != newvalue, "Lizard: The marketingFeeOnBuy is already that value");
    ...
    function setHolderFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnBuy != newvalue, "Lizard: The holdersFeeOnBuy is already that value");
    ...
    function setBuyBackFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnBuy != newvalue, "Lizard: The buyBackFeeOnBuy is already that value");
    ...
    function setSalaryFeeOnBuy(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnBuy != newvalue, "Lizard: The salaryFeeOnBuy is already that value");
    ...
    function setLiquidityFeeOnSell(uint256 newvalue) public onlyOwner {
        require(liquidityFeeOnSell != newvalue, "Lizard: The liquidityFeeOnSell is already that value");
    ...
    function setMarketingFeeOnSell(uint256 newvalue) public onlyOwner {
        require(marketingFeeOnSell != newvalue, "Lizard: The marketingFeeOnSell is already that value");
    ...
    function setHolderFeeOnSell(uint256 newvalue) public onlyOwner {
        require(holdersFeeOnSell != newvalue, "Lizard: The holdersFeeOnSell is already that value");
    ...
    function setBuyBackFeeOnSell(uint256 newvalue) public onlyOwner {
        require(buyBackFeeOnSell != newvalue, "Lizard: The buyBackFeeOnSell is already that value");
    ...
    function setSalaryFeeOnSell(uint256 newvalue) public onlyOwner {
        require(salaryFeeOnSell != newvalue, "Lizard: The salaryFeeOnSell is already that value");
    ...
    function setUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "Lizard: The router already has that address");
        emit UniswapV2RouterChange(newAddress, address(uniswapV2Router));
        uniswapV2Router = IUniswapV2Router02(newAddress);
    }
    function setGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "Lizard: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "Lizard: Cannot update gasForProcessing to same value");
        emit GasForProcessingChange(newValue, gasForProcessing);
        gasForProcessing = newValue;
    }
    function setMaxTxAmount(uint256 newValue) public onlyOwner {
        require(newValue != maxTxAmount, "Lizard: Cannot update maxTxAmount to same value");
        emit MaxTransactionAmountChange(newValue, maxTxAmount);
        maxTxAmount = newValue;
    }
    function setMaxWalletAmount(uint256 newValue) public onlyOwner {
        require(newValue != maxWalletAmount, "Lizard: Cannot update maxWalletAmount to same value");
        emit MaxWalletAmountChange(newValue, maxWalletAmount);
        maxWalletAmount = newValue;
    }
    function setMinimumTokensBeforeSwap(uint256 newValue) public onlyOwner {
        require(newValue != minimumTokensBeforeSwap, "Lizard: Cannot update minimumTokensBeforeSwap to same value");
    ...
    function _transfer(
        ...
        if(from != owner() && to != owner()) {
            require(isTradingEnabled, "Lizard: Trading is currently disabled.");
            require(!_isBlacklisted[to], "Lizard: Account is blacklisted");
            require(!_isBlacklisted[from], "Lizard: Account is blacklisted");
            if (_isInLaunch && currentTimestamp.sub(_launchStartTimestamp) <= 300 && isBuyFromLp) {
                require(currentTimestamp.sub(_buyTimesInLaunch[to]) > 60, "Lizard: Cannot buy more than once per min in first 5min of launch");
            }
            if (!_isExcludedFromMaxTransactionLimit[to] && !_isExcludedFromMaxTransactionLimit[from]) {
                require(amount <= maxTxAmount, "Lizard: Buy amount exceeds the maxTxBuyAmount.");
            }
            if (!_isExcludedFromMaxWalletLimit[to]) {
                require(balanceOf(to).add(amount) <= maxWalletAmount, "Lizard: Expected wallet amount exceeds the maxWalletAmount.");
            }
        }
    ...
    function _swapAndLiquify() private {
        ...
        uint256 tokensInLizardForLiquidity = _liquidityTokensToSwap.div(2);
        uint256 amountToSwapForBNB = contractBalance.sub(tokensInLizardForLiquidity);
        
        // initial BNB balance
        uint256 initialBNBBalance = address(this).balance;
        // Swap the Lizard for BNB
        ...
        _addLiquidity(tokensInLizardForLiquidity, bnbForLiquidity);
        emit SwapAndLiquify(amountToSwapForBNB, bnbForLiquidity, tokensInLizardForLiquidity);
...
contract LizardDividendTracker is DividendPayingToken, Ownable {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("Lizard_Dividend_Tracker", "Lizard_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 5000000 * (10**18); 
    }
    function _transfer(address, address, uint256) internal override {
        require(false, "Lizard_Dividend_Tracker: No transfers allowed");
    }
    function withdrawDividend() public override {
        require(false, "Lizard_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main Lizard contract.");
    }
    ...
    function setTokenBalanceForDividends(uint256 newValue) external onlyOwner {
        require(minimumTokenBalanceForDividends != newValue, "Lizard_Dividend_Tracker: minimumTokenBalanceForDividends already the value of 'newValue'.");
        minimumTokenBalanceForDividends = newValue;
    } 
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "Lizard_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "Lizard_Dividend_Tracker: Cannot update claimWait to same value");
