...
contract TheRealFrunkPuppy is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public buybackAddress = payable(0x226AfE0e4B9645169eA2947f4b1A112F5A33fFD8);
    ...
    string private _name = "The Real Frunk Puppy";
    ...
    function swapTokens(uint256 contractTokenBalance) private lockTheSwap {
        ...
        transferToAddressETH(buybackAddress, transferredBalance.mul(marketingDivisor).div(100));
