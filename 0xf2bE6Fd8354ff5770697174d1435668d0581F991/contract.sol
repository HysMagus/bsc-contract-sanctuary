...
contract Strategy is BaseStrategy {
    ...
    address internal AccToken       = 0x8D5Ad40Dc0A7B3614096a013f55D02B5677803E8;
    IERC20 public brewToken         = IERC20(0x790Be81C3cA0e53974bE2688cDb954732C9862e1);
    IPancakeFarm public farmer      = IPancakeFarm(0xc772955c33088a97D56d0BBf473d05267bC4feBB);

    constructor(address _vault) public BaseStrategy(_vault) {
        require(address(want) == address(brewToken),"wrong want token");
        brewToken.safeApprove(address(farmer),type(uint256).max);
    }

    function name() external override view returns (string memory) {
        return "StrategyBrewStaking";
    }
    ...
    function pendingReward() public view returns (uint256) {
        return farmer.pendingCake(0,address(this));
    }
