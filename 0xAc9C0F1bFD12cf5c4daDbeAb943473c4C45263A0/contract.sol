...
contract The_AIM is Context, IERC20, Ownable {
    ...
    function _transfer(
        ...
        //@dev Limit the transfer to 600 tokens for first 15 minutes
        require(block.timestamp > liquidityAddedAt + 16 minutes  || amount <= 600 *10**18, "You cannot transfer more than 600 tokens.");
