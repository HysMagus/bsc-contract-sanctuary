...
/**
 * @title DAGOAT ERC20 token
 * @dev
 *      Based on the Ampleforth & Safemoon protocol.
 */
contract DAGOAT is ERC20Detailed, Ownable {
    ...
    constructor (address router, address payable _marketingAddress, address pinkAntiBot_)
        ERC20Detailed("DaGoat Token", "DAGOAT", uint8(DECIMALS))
        payable
        public
    {
