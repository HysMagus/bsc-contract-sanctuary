...
contract MuscleKishu is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x9a41dAcdA8F6f3a746ed7EAd4C58564B4d9F2b20); // Marketing Address
    ...
    string private _name = "MuscleKishu";
    string private _symbol = "MUSCLEKISHU";
