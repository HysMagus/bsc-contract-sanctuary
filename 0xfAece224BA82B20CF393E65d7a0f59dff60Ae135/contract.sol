...
contract gummygame {
    ...
    uint256 public orangeReward;
    uint256 public pinkReward;
    uint256 public redReward;
    uint256 public greenReward;
    ...
    constructor( 
        GummyToken _token,uint256 bluebean, uint256 orangebean, uint256 pinkbean, uint256 redbean, uint256 greenbean ) { 
        token = _token; 
        blueReward = bluebean;
       orangeReward = orangebean;
       pinkReward = pinkbean;
       redReward = redbean;
       greenReward = greenbean;
    ...
    function beanline(uint) internal returns(string memory) {
        ...
        if(polish >= 83 && polish <= 96) {
            rewardseed = 3;
        }
        if(polish >= 97 && polish <= 100) {
            rewardseed = 4;
        }
   ...
   function updatePrizes(uint256 bluebean, uint256 orangebean, uint256 pinkbean, uint256 redbean, uint256 greenbean) external {
