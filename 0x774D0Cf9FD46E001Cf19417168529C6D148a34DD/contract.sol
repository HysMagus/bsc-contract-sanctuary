/**
 * 
Welcome to the biggest PicArtNFT marketplace in the digital arts industry. Here you can find rare collectibles for all kinds of artwork made by talented. Take a look at our growing collection of PicArtNFT or digital artwork by most popular and trending artists and creators from across the global..
Note: Pre-Sale open 2nd October.
PANFT TOKEN Already Listed Hotbit Exchange.. XT Exchange & Probit Exchange & Bibox Exchange
Hotbit Listing price 0.10$
Pre-sale price 0.025$
4X to 10X profitable Token.. 
*/
...
contract PANFT is Context, IERC20, Ownable {
