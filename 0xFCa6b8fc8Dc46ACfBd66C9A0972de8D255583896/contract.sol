...
contract McAvalancheToken is IBEP20, Ownable
{
    ...
    //Token Info
    string private constant _name = 'McAvalancheToken';
    string private constant _symbol = 'McAvalancheToken';
    ...
    //DevWallets
    address public Marketing=payable(0xD0F38867a3755706a1c210CC024776B9e84ad530);
    address public Buyback=payable(0xD0F38867a3755706a1c210CC024776B9e84ad530);
    //TestNet
    ...
    //Marketing Share gets an extra 0.8% during launch/
    ...
    function TeamWithdrawALLMarketingBNB() public onlyOwner{
        ...
        marketingBalance=0;
        payable(Marketing).transfer((amount*4)/6);
        payable(Buyback).transfer((amount*2)/6);
    } 
