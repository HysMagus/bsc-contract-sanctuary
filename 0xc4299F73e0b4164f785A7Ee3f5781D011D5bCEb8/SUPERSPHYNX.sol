...
import "./SUPERSPHYNX-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `SUPERSPHYNX` at the very bottom **and** the `environment` into which
 * you are deploying the contract `SUPERSPHYNX(Env.Testnet)` or `SUPERSPHYNX(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "SUPERSPHYNX";
    string internal constant SYMBOL = "SUPERSPHYNX";
     ...
     */
    address internal tipToTheDev =0x8078C99f81EA566f791520DE029Ea4CA65dA3780;
...
contract SUPERSPHYNX is SafeToken{
