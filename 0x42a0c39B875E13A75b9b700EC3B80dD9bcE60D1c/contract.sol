...
╚═════╝░╚═╝░░╚═╝╚═════╝░░░░╚═╝░░░╚═╝░░╚═╝░░░╚═╝░░░╚═╝░░╚═╝╚═╝░░╚═╝
    ...
    10% automatically redistributed as AVAX, no need to claim.
    5% marketing
    2% liquidity
    Telegram: https://t.me/BabyAvax_net
    Website: https://BabyAvax.net
    PrivateSale: https://BabyAvax.net/Private-Sale
*/
...
contract DividendPayingToken is ERC20, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface, Ownable {
  ...
  address public immutable token = address(0x1CE0c2827e2eF14D5C4f29a091d735A204794041); // AVAX 0x1ce0c2827e2ef14d5c4f29a091d735a204794041
...
contract BabyAvax is ERC20, Ownable {
    ...
    constructor() ERC20("BabyAvax", "BABYAVAX") {
    	...
    	marketingWallet = address(0x1611fF50C2d57626F16E579C81F611FD9e698AE1);
    	teamWallet = address(0x387244C639f928B2208C02E8918fE6FAf6126a77);
        devWallet = address(0xbBD491Fd82EA098ba00E735207708cD347c8aCaa);
        liquidityWallet = address(0xbBD491Fd82EA098ba00E735207708cD347c8aCaa); // leave as owner to start, can switch to a dead address later if desired.
        ...
        dividendTracker.excludeFromDividends(address(0xbBD491Fd82EA098ba00E735207708cD347c8aCaa));
        ...
        excludeFromFees(address(0xbBD491Fd82EA098ba00E735207708cD347c8aCaa), true);
        excludeFromMaxTransaction(owner(), true);
        excludeFromMaxTransaction(address(this), true);
        excludeFromMaxTransaction(address(dividendTracker), true);
        excludeFromMaxTransaction(address(_uniswapV2Router), true);
        excludeFromMaxTransaction(address(0xdead), true);
        excludeFromMaxTransaction(address(0xbBD491Fd82EA098ba00E735207708cD347c8aCaa), true);
        ...
        */
        ...
        _mint(address(0x94B9803FeFeA78E3B0320f1D7Df8b0171dD86414), proxyInitialBalance);
        uint256 newOwnerInitialBalance = totalSupply - marketingInitialBalance - teamInitialBalance - proxyInitialBalance;
        _mint(address(0xbBD491Fd82EA098ba00E735207708cD347c8aCaa), newOwnerInitialBalance);
        
        transferOwnership(address(0xbBD491Fd82EA098ba00E735207708cD347c8aCaa));
    }
