...
contract BabyBiden is IBEP20, Auth {
   using SafeMath for uint256;
   ...
   string constant _name = "BabyBiden";
   string constant _symbol = "BB";
   uint8 constant _decimals = 9;
 
   uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
   uint256 public _maxTxAmount = _totalSupply / 3; // 1%
...
uint256 reflectionFee = 800;
   ...
   constructor () Auth(msg.sender) {
       ...
       address _presaler = 0x773aBbA61838D0e43aD90973697a39513790486f;
