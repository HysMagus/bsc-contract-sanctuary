...
/**
    The New Tokenomics innovations! We are proud to present ParisVanJava Token with new innovations of tokenomics, We all know that Binance Smart Chain is a place where many coin and token projects are located, since rugs and honeypots are widely encountered, many people are worried about their investments.
    A new era begins! now you do not need to be afraid or worry of your investment, with ParisVanJava Token we start the right step in Binance Smart Chain.
    
    
    It will be a stealth project to avoid sniper and bot buying.
	
	Telegram: https://t.me/ParisVanJava
	Twitter: https://twitter.com/ParisVanJava
	Website: https://www.ParisVanJava.net/
...
contract DividendPayingToken is ERC20, Ownable, DividendPayingTokenInterface, DividendPayingTokenOptionalInterface {
  ...
  address public immutable ADA = address(0); //NO REWARDS
...
contract ParisVanJava is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    ParisVanJavaDividendTracker public dividendTracker;
    ...
    uint256 public ADARewardsSplitValue = 1;
    uint256 public liquiditySplitValue = 6;
    uint256 public marketingSplitValue = 9;
    uint256 public bananaRewardSplitValue = 1;
    uint256 public feeDecimalFactor = 3;
    ...
    // public _marketingWalletAddress = 0x02ff042F70ce76D65a78aDdf26929989b3999faf;
    address public _marketingWalletAddress = 0x73ee520bfd2534Ef96b46199FF1D73568D1e7ae1;
    
    bool public hasLaunched;
    
    //address public liquidityFeeReceiver = 0xaA11A8D08A23De6a8FA050690332a719839F0DD0;
    address public liquidityFeeReceiver = 0x73ee520bfd2534Ef96b46199FF1D73568D1e7ae1;
    ...
    constructor() public ERC20("ParisVanJava", "ParisVanJava") {

    	dividendTracker = new ParisVanJavaDividendTracker();
    ...
    function updateDividendTracker(address newAddress) public onlyOwner {
        require(newAddress != address(dividendTracker), "ParisVanJava: The dividend tracker already has that address");

        ParisVanJavaDividendTracker newDividendTracker = ParisVanJavaDividendTracker(payable(newAddress));

        require(newDividendTracker.owner() == address(this), "ParisVanJava: The new dividend tracker must be owned by the ParisVanJava token contract");
    ...
    function updateUniswapV2Router(address newAddress) public onlyOwner {
        require(newAddress != address(uniswapV2Router), "ParisVanJava: The router already has that address");
    ...
    function excludeFromFees(address account, bool excluded) public onlyOwner {
        require(_isExcludedFromFees[account] != excluded, "ParisVanJava: Account is already the value of 'excluded'");
    ...
    function setAutomatedMarketMakerPair(address pair, bool value) public onlyOwner {
        require(pair != uniswapV2Pair, "ParisVanJava: The PancakeSwap pair cannot be removed from automatedMarketMakerPairs");

        _setAutomatedMarketMakerPair(pair, value);
    }

    function _setAutomatedMarketMakerPair(address pair, bool value) private {
        require(automatedMarketMakerPairs[pair] != value, "ParisVanJava: Automated market maker pair is already set to that value");
    ...
    function updateGasForProcessing(uint256 newValue) public onlyOwner {
        require(newValue >= 200000 && newValue <= 500000, "ParisVanJava: gasForProcessing must be between 200,000 and 500,000");
        require(newValue != gasForProcessing, "ParisVanJava: Cannot update gasForProcessing to same value");
...
contract ParisVanJavaDividendTracker is Ownable, DividendPayingToken {
    using SafeMath for uint256;
    using SafeMathInt for int256;
    ...
    constructor() public DividendPayingToken("ParisVanJava_Dividend_Tracker", "ParisVanJava_Dividend_Tracker") {
    	claimWait = 3600;
        minimumTokenBalanceForDividends = 50000 * (10**18); //must hold 50000+ tokens
    }

    function _transfer(address, address, uint256) internal override {
        require(false, "ParisVanJava_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() public override {
        require(false, "ParisVanJava_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main ParisVanJava contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 3600 && newClaimWait <= 86400, "ParisVanJava_Dividend_Tracker: claimWait must be updated to between 1 and 24 hours");
        require(newClaimWait != claimWait, "ParisVanJava_Dividend_Tracker: Cannot update claimWait to same value");
