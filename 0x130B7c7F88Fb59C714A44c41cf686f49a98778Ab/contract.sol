...
@@@@@@@@@@@&&&&&&&#(((((((#%&&&&&&&@@@@@@@@@@
     ...
     ApeTogetherStrong (ATS) a fork of Reflect Finance (RFI) Prophet (PROPHET). ATS also has a deflationary supply 
...
contract ATS is Context, IBEP20, Ownable {
    ...
    string private _name = 'ApeTogetherStrong';
