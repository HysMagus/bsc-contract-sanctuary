...
contract Share is ERC20, ERC20Burnable, AdminRole {
    ...
    constructor() public ERC20('GoCash Share', 'GOS') {
        // Mints 1 GoCash Share to contract creator for initial oracle deployment.
        _mint(msg.sender, 1 * 10**18);
    }

    /**
     * @notice GoCash Share代币的铸造方法
    ...
    /**
     * @notice GoCash Share代币的销毁方法，Admin有权限销毁
     */
    ...
    /**
     * @notice GoCash Share代币的销毁方法，Admin有权限销毁，配合approve使用
     */
