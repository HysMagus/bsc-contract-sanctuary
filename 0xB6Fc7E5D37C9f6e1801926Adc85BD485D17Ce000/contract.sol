...
/*
     Debris (DEB) is a soft fork of Reflect (RFI) that incorporates adjustable
     yield rates (so early early buyers can continue to earn reasonable yields as
     more holders enter the ecosystem). Debris (DEB) also has a deflationary supply 
     via a burn mechanism.
 */
...
contract Debris is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1 * 10**5 * 10**9;
