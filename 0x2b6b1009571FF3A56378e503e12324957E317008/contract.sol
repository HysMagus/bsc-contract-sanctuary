/**
Telegram: t.me/Mommyastrodoge
Website: https://Mommyastrodoge.com
/**
 Bsc!
*/
...
contract MommyAstroDoge is ERC20, Ownable {
    using SafeMath for uint256;
    ...
    constructor() ERC20("MommyAstroDoge", "MommyAstroDoge") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0xc649DC7Cd97Be96f5aA9b11518028fB815598173;
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "MommyAstroDoge: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "MommyAstroDoge: The new dividend tracker must be owned by the MommyAstroDoge token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("MommyAstroDoge_Dividend_Tracker", "MommyAstroDoge_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 1200;
        minimumTokenBalanceForDividends = 150000 * (10**18); //must hold 150,000+ tokens
    }

    function _transfer(address, address, uint256) pure internal override {
        require(false, "MommyAstroDoge_Dividend_Tracker: No transfers allowed");
    }

    function withdrawDividend() pure public override {
        require(false, "MommyAstroDoge_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "MommyAstroDoge_Dividend_Tracker: claimWait" );
        require(newClaimWait != claimWait, "MommyAstroDoge_Dividend_Tracker: Cannot update claimWait to same value");
