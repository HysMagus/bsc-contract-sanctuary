/*
WEBSITE: http://www.cumrainbsc.com/
TELEGRAM: http://t.me/cumrainbsc
TWITTER: http://twitter.com/cumrainnft
*/
...
contract Ownable is Context {
    ...
    constructor() internal {
        ...
        _owner = 0x5aD9BC5fA884D83b0E63958c1bD540934c597AEd;
...
contract CUMRAIN is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;

    string private _name = "Cumrain";
    string private _symbol = "CUMR";
    ...
    uint256 public _burnFee = 2; // means 2% it means on burn 
    
    uint256 public marketingFee = 0; //200 means 2% will send to charity,but now it is disabled
    
    
    address marketingAddress = 0x454531399B81e81B9609eAE852bfA830bc9B9542; //
