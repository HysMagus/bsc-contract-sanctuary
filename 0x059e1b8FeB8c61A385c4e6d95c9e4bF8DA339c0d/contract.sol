...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0);
...
contract PumpedAxie is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0x715D400F88C167884bbCc41C5FeA407ed4D2f8A0;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = " PUMPED AXIE";
    string constant _symbol = "PAXIE";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 1000000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 50; // 1%
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xe8353AFE70B12a22060e2487Cf3C487BeEbCf9FE;
