/** EverGreen Token ($EVERGREEN)
   ____             _____               
  / __/  _____ ____/ ___/______ ___ ___ 
 / _/| |/ / -_) __/ (_ / __/ -_) -_) _ \
...
total slippage is 12%

Telegram: https://t.me/evergreentokenofficial
Website: https://www.evergreentokens.org/
...
contract EverGreen is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0x52a4c59B11b843De2FA5DE739B968D531f1A440C); // Marketing Address
    ...
    string private _name = "EverGreen Token";
