...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isCAKEStaking= true; // only for staking CAKE using pancakeswap's native CAKE staking contract.
    ...
    uint256 public constant pid = 20; // pid of pool in farmContractAddress
    address public constant wantAddress = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;//EGG-BUSD LP
