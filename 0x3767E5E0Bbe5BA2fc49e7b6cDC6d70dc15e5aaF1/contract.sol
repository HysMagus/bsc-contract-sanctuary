...
contract FeeApprover is OwnableUpgradeSafe {
    ...
    function initialize(
        ...
        tokenPancakePair = IPancakeFactory(address(0xBCfCcbde45cE874adCB698cC183deBcF17952812)).getPair(WBNBAddress,bscTokenAddress);
        bscVaultAddress = _bscVaultAddress;
        feePercentX100 = 20;
        paused = false; // We start paused until sync post LGE happens.
    }

    address tokenPancakePair;
    ...
    function sync() public {
        uint256 _LPSupplyOfPairTotal = IERC20(tokenPancakePair).totalSupply();
        ...
        )
    {
        ...
        if(sender == bscVaultAddress || sender == tokenPancakePair ) {
