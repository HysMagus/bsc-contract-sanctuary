    ...
    function transferToken(
        ...
        assembly {
            ...
            switch returndatasize()
                ...
                case 0x20 {
                    transferred := iszero(
                        or(iszero(success), iszero(mload(ptr)))
                    )
                }
                default {
                    transferred := 0
...
contract ModuleManager is SelfAuthorized, Executor {
    ...
    function isModuleEnabled(Module module) public view returns (bool) {
        return
            SENTINEL_MODULES != address(module) &&
            modules[address(module)] != address(0);
    }
    ...
    FallbackManager
{
    ...
    function handlePayment(
        ...
        address payable receiver =
            refundReceiver == address(0) ? tx.origin : refundReceiver;
