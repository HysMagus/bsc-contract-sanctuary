...
contract NarwhalRewardMediumV2 is LPTokenWrapper{
    ...
    uint256 public _initReward = 175000 * 1e18;
    ...
    uint256 public _minRate = 1000 * 1e18;
    uint256 public _maxRate = 10000 * 1e18;
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(balanceOf(msg.sender).sub(amount) >= _minRate , "balance < minrate");
