/**
FOMODAOS
Use FFI for community governance
Comming Soon...

 What is a rebase token?
A rebase token experiences “rebases” where the system automatically updates and adjusts the tokens’ 
supply to equal the demand. Rebase tokens are different from traditional 
tokens in the marketplace as they do not have a fixed supply and usually have a specific target price.
An advantage of this system is that it protects consumers from deflation or inflation, depending on the balance 
of market supply and demand — the supply is expanded or contracted in response to the increase or decrease in price.
...
contract  FOMODAOS is IBEP20 {
    ...
    string public override name = "FOMODAOS";
    string public override symbol = "FOMODAOS";
    ...
    constructor(uint totalSupplyValue, address developmentAddress, address foundersAddress, address RebaseAddress) {
        ...
        balances[Rebase] = totalSupply * 7 / 100;
