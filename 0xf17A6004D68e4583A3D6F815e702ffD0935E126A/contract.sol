...
contract Presale is Ownable {
    ...
    constructor() {
        // dexf = BEP20Interface(0xe5E4EF7AD63f92B6fa1409debD529827816B84fe); // maint token
        dexf = BEP20Interface(0x1EB16466B845fc23D231Be012db0EED39C716233); // maint token
        usdc = BEP20Interface(0x8AC76a51cc950d9822D68b83fE1Ad97B32Cd580d);
        reservior = 0x35a5290EfDE8bE00d5a9A8CB9bE30A74731425f4;

        presaleCost = 9E16; // 0.09 DEXF per 1 USDC
        depositMaxAmount = 500E18; // 500 USDC = 45 DEXF

        addOneToWhiteList(0x711a04f1E4d394E4E77c01A64E6B5fC673872Ad3);
    }
    ...
    // fall back function to receive BNB
