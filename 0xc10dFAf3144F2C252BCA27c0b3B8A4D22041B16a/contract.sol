...
contract Buffalo is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string constant _name = "Buffalo";
    string constant _symbol = "Buffalo";
    ...
    uint256 public _maxWallet = 7 * (10**10) * (10 ** _decimals);
