...
// Eleven.finance experimental flexible vault
 ...
 */
contract FlexibleStrategy is Ownable, Pausable {
    ...
    function setNewStrat(address _address, uint8 _pid, address _vAddress) public onlyOwner{
        lpPair = _address;
