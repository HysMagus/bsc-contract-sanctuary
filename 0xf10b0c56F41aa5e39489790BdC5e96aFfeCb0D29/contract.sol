...
contract The_AIM is Context, IERC20, Ownable {
    ...
    address public devAddress = 0x33Bc71bB9aBf03e08CA43f2506650DEA6fA421F9;
    ...
    function _transfer(
        ...
        //@dev Limit the transfer to 600 tokens for first 10 minutes
        require(block.timestamp > liquidityAddedAt + 10 minutes  || amount <= 600 *10**18, "You cannot transfer more than 600 tokens.");
