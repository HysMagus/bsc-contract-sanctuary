...
Credits: Contract based off OnlyUP fork. Thank you! :)

Introducing $SPARK, a token that rebases price and at the same time, rewards holders with different tokens based on weekly community chosen poll.
We have a vision and utility for $SPARK and that can be found on our website.

https://www.sparkdefi.net
https://t.me/officialsparkcoin
...
contract DividendDistributor is IDividendDistributor {
    ...
    address _token;
    address public main = 0x7130d2A12B9BCbFAe4f2634d864A1Ee1Ce3Ead9c; //BTC
    ...
    function getCurrRewardAddress() external view returns (address) { return main; }
}

contract Spark is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    constructor () Auth(msg.sender) {
        router = IDEXRouter(0x10ED43C718714eb63d5aA57B78B54704E256024E); // Unirouter v2
        ...
        marketingFeeReceiver = 0x63BE54C6aD643fEb9A4827E24687312345AE91F1; // Marketing wallet
    ...
    function getCurrRewardAdd() public view returns (address) {
        return distributor.getCurrRewardAddress();
    }
    ...
    function setMainRewardAddress(address newReward) public onlyOwner {
        distributor.setRewardAddress(newReward);
    }
    ...
    function setFees(uint256 _liquidityFee, uint256 _reflectionFee, uint256 _marketingFee, uint256 _devFee, uint256 _feeDenominator) external authorized {
        ...
        require(totalFee < feeDenominator/5, "Fees cannot be more than 20%"); // Funds are safu
    }
