...
contract bCORGIFarm is Ownable {
    using SafeMath for uint;
    using EnumerableSet for EnumerableSet.AddressSet;
    
    event RewardsTransferred(address holder, uint amount);
    
    address public constant tokenAddress = 0xBF746586E1758E4a3038768144b4DA8f09022f77; //BSC CORGI
    address public constant devWallet = 0x95169A0eda681C4505A86DC5AB781B73F249eB89; //CORGI deployer
    
    // reward rate 420.00% //SWE
    uint public constant rewardRate = 42000;
    ...
    uint public constant cliffTime = 1 minutes; //kCORGI change for mainnet deploy 24 hours
    ...
    function withdraw(uint amountToWithdraw) public {
        ...
        require(Token(tokenAddress).transfer(devWallet, fee), "Could not transfer dev tokens.");
    ...
    // 420k Tokens to Farm
    uint private constant stakingTokens = 420000e9;
