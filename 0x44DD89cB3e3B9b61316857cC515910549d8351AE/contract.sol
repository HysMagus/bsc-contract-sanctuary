...
//Just launched in $ShinobiKishu. We have created a token so rewarding for everyone.
//ShinobiKishu Hold we will Tothemoon
//Tg : t.me/ShinobiKishu
...
contract ShinobiKishu is Context, IERC20, Ownable {
    ...
    string private _name = "SHINOBI KISHU";
    string private _symbol = "ShinobiKishu";
