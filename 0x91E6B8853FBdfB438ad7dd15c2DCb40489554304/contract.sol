/**
 ...
 UPTOBER ☎️ - NEW REBASE TOKEN - DESIGNED TO ONLY GO UP ☎️

Still very early, just stealth launched and market cap still extremely small! Could be another chance to get in on the next Forever Fomo!

Building on the Q4 hype pump, UPTOBER is aiming to be a more stable coin due to its redesigned rebase functionality and tokenomics. 

Join us and let the rebase fomo kick in!
...
✅ Low tax (12%)
✅ BuyBack (4% of each transaction will go to BuyBack) 🤑
✅ Liquidity provider (4% of each transaction will go to LP, so we will have a more stable price)💰
✅ Marketing (4% of each transaction will go to Marketing and promos) 🤑
✅ 100& SAFU: BscScan verified contract copied directly from ForeverFOMO and LP locked for 7 days 🥳

🚀 Massive marketing campaign planned featuring defiapecalls, Cryptic_Maestro and Travladd !
 and more to come 🚀
🔥 Huge 100x potential! 🔥

🟦🟨🟦🟨🟦🟨🟦🟨🟦🟨🟦🟨🟦

🔹 𝗧𝗚 𝗴𝗿𝗼𝘂𝗽: https://t.me/Uptober
...
contract Uptober is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("Uptober", "UPTOBER", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x66fa01984B24B73401486501E238982844691C0D;
