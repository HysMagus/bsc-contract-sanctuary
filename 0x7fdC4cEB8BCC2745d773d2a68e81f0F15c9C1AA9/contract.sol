 ...
 * GameZone is on a mission to support the next generation of creators and innovators in the blockchain-based gaming space.
*/
...
contract GAMEZONE is IERC20 {
    ...
    string constant _name = "GAME ZONE";
    string constant _symbol = "GZONE";
    ...
    uint256 public maxReflectionFee = 0;
    uint256 public maxLiquidityFee = 0;
    uint256 public maxMarketingFee = 0;
    ...
    address payable private _marketingWallet = payable(0x2413c361Fc310B4B750c3766D589975b029b0306);

    // Max Buy TX amount is 1% of the total supply.
    uint256 private buyMaxTxPercent = 100; // Less fields to edit
    uint256 private buyMaxTxDivisor = 10000;
    ...
    uint256 private sellMaxTxDivisor = 100000;
    ...
    uint256 private maxWalletPercent = 1000; // Less fields to edit
    ...
    constructor (uint _snipeBlockAmt, uint256 _gasPriceLimit, address cInitializer) payable {
        ...
        _isSniper[0xE4882975f933A199C92b5A925C9A8fE65d599Aa8] = false;
...
function setTaxesBuy(uint256 liquidityFee, uint256 reflectionFee, uint256 marketingFee) external onlyOwner {
    ...
    function setMaxTxPercents(uint256 buyPercent, uint256 buyDivisor, uint256 sellPercent, uint256 sellDivisor) external onlyOwner() {
        require(buyPercent >= 1 && sellPercent >= 1 && buyDivisor <= 100000 && sellDivisor <= 100000); // Cannot set lower than 0.0001%
