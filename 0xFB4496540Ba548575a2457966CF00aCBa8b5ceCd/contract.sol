...
// File: contracts/NEOImplementation.sol
...
/**
 * @title NEOImplementation
 * @dev this contract is a Pausable BSC20 token with Burn and Mint
 * controlled by a central SupplyController. By implementing NEOImplementation
...
contract NEOImplementation {
    ...
    string public constant name = "NEO LOGIC"; // solium-disable-line
    string public constant symbol = "NEO"; // solium-disable-line uppercase
    ...
    */
    ...
    /**
     * @dev Reclaim all NEO at the contract address.
     * This sends the NEO tokens that this contract add holding to the owner.
     * Note: this is not affected by freeze constraints.
     */
    function reclaimNEO() external onlyOwner {
