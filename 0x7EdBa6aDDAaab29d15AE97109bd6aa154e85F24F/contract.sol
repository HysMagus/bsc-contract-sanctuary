...
contract Strategy is BaseStrategy {
    ...
    address token0;
    address token1;
    address reward                  = 0x9066e87Bac891409D690cfEfA41379b34af06391;
    IERC20 public rewardToken       = IERC20(reward);
    IPancakeFarm public farmer      = IPancakeFarm(0x36f44a1C8e973739D0034FF1B9B9f6c4c7085625);
    ...
    function pendingReward() public view returns (uint256) {
        return reward_to_want(farmer.pendingTaco(pid,address(this)));
    }
   ...
   function reward_to_want(uint256 _earned) internal view returns (uint256) {
        ...
        )
    {
        ...
        if(pendingReward() > 0) {
            ...
            _earned = rewardToken.balanceOf(address(this));
            if(_earned > 0)
    ...
    function prepareMigration(address _newStrategy) internal override {
        ...
        if(pendingReward() > 0) {
            farmer.deposit(pid,0);
            compoundRewardsToLP(rewardToken.balanceOf(address(this)));
        }
    ...
    function protectedTokens() internal override view returns (address[] memory) {
        ...
        protected[0] = address(rewardToken); // rewards
        return protected;
    }
}