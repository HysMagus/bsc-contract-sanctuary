...
contract tekel2001 is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 7 * 10**8 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private _name = 'TEKEL2001';
    string private _symbol = 'TEKEL2001';
    uint8 private _decimals = 8;

    uint256 private _taxFee = 0;
    uint256 private _burnFee = 0;
    uint256 private _maxTxAmount = 1500e8;
