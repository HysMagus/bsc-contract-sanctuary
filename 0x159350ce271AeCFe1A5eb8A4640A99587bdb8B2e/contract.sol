// $MiniFlokiCake proposes an innovative feature in its contract.
//
// DIVIDEND YIELD PAID IN Cake! With the auto-claim feature,
// simply hold $MiniFlokiCake and you'll receive cake automatically in your wallet.
// 
// https://t.me/MiniFlokiCake
//
...
contract MiniFlokiCake is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "MiniFlokiCake";
    string constant _symbol = "MiniFlokiC";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x4e008C77F933ad95b05ee031F540626749c9140B;
