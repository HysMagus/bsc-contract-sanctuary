...
contract Order {
    address public constant BNB_ADDRESS = address(0x00eeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeeee);
}
...
contract LimitOrders is IModule, Order {
    ...
    function execute(
        ...
        uint256 inputAmount = LimitOrderUtils.balanceOf(_inputToken, address(this));
        ...
        bought = LimitOrderUtils.balanceOf(outputToken, address(this));
