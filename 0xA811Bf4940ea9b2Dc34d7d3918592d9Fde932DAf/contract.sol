...
*                                                                                                         
* Supply       : 100000000000
* Max TX       : 500000000 SAF (0.5%)
* Max Wallet   : 3000000000 SAF (3%)
* Buyback      : 5%
* Marketing    : 3%
* Liquidity    : 3%
*
...
/* Token contract */
contract StonkAF is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    // Name and symbol
    string constant _name = "StonkAF";
    string constant _symbol = "SAF";
    ...
    // Max wallet and TX
    uint256 public _maxBuyTxAmount = _totalSupply * 50 / 10000; // 0.5%
    ...
    uint8 public cooldownTimerInterval = 7;
