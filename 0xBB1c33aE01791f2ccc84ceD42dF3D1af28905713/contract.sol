...
/*
    ______                            _____                     _     
    |  ___|                          /  ___|                   | |    
    | |_ ___  _ __ _____   _____ _ __\ `--. _ __ ___   __ _ ___| |__  
    |  _/ _ \| '__/ _ \ \ / / _ \ '__|`--. \ '_ ` _ \ / _` / __| '_ \ 
    | || (_) | | |  __/\ V /  __/ |  /\__/ / | | | | | (_| \__ \ | | |
    \_| \___/|_|  \___| \_/ \___|_|  \____/|_| |_| |_|\__,_|___/_| |_|
                                                                  
                                                                  
    
    ForeverSmash - A rebase token which aims to keep on smashing the upper resistance levels forever! Our unique rebase protocol will ensure that we keep on smashing. Are you ready to smash with us?
    Telegram: https://t.me/ForeverSmash
    Twitter: https://twitter.com/ForeverSmashBSC
    Website: http://ForeverSmash.space
*/
...
contract ForeverSmash is ERC20Detailed, Ownable {
    ...
    constructor() ERC20Detailed("ForeverSmash", "SMASH", uint8(DECIMALS)) {
        ...
        autoLiquidityReceiver = 0x875618914Aacb6Fb3368D0D04ca84cB71e70674f;
        marketingFeeReceiver = 0xDeBEe19c8C055721968380f183945a8E45fD3499;
        ecosystemFeeReceiver = 0x3aa357fd0a62a90E28441E322107183e71203fbb;
        buyBackFeeReceiver = 0xAea317D2F938651D7b727B87Cff4a96281Bc041F;
