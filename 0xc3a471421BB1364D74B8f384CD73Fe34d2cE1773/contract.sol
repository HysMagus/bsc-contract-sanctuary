...
// File: contracts/NarwhalRewardSmallV2.sol
...
contract NarwhalRewardSmallV2 is LPTokenWrapper{
    using SafeERC20 for IERC20;
    ...
    uint256 public _maxRate = 9999 * 1e18;
    ...
    function setMinRate(uint256 maxRate) public onlyGovernance{
         _maxRate = maxRate;
    }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(balanceOf(msg.sender).add(amount) <= _maxRate , "Balance < maxRate");
