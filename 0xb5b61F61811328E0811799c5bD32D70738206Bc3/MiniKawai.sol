...
import "./MiniKawai-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `MiniKawai` at the very bottom **and** the `environment` into which
 * you are deploying the contract `MiniKawai(Env.Testnet)` or `MiniKawai(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "MiniKawai";
    string internal constant SYMBOL = "MKAWAI";
     ...
     */
    address internal tipToTheDev =0x70B3E2C20323d28170426B707dd7aDC0ea2CE29e;
...
contract MiniKawai is SafeToken{
