...
contract RobustReferralTest is IRobustReferral, Ownable {
	...
	/**
     * @dev onlyOperator functions can be called by an operator
	 * Owner can add or remove an address as an operator using updateOperator
     */
    ...
    /**
     * @dev Set the referrer of a user
	 * Only a user without a referrer can be set
    ...
    /**
     * @dev Update referral commission received by address
     * Can only be called by an operator
     */	
    ...
    /**
     * @dev Get the address that referred the user
     */	
    ...
    /**
     * @dev Update the status of the operator address
    ...
    /**
     * @dev Withdraw other tokens sent to the contract
