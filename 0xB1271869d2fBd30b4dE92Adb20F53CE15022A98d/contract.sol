...
contract DefiHero is ERC20 {
    constructor() public ERC20("DEFIHERO", "DFH") {
        _mint(msg.sender, 50000000 ether); // Mint fixed supply of 50 Million DEFIHERO
    }
}