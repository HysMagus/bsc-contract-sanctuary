...
/**
 * 
The contract will be published on the day of the start of sales!

Dear community!❤️

💎 Welcome to NFT.Circle 💎

Join the community of Game Artists, Developers and Gamers

Developing games based on NFT assets can generate huge revenue opportunities. Same NFT game assets should not be used in multiple games to maintain scarcity and protect the Artist’s and Game Developers’ works. By HODLing our $CIRCLE tokens you gain both FREE tokens and also support Game Artists and Developers.

💎Public Sale - PancakeSwap Listing on 22th September💎

✅ TECHRATE SECURITY AUDIT
https://www.nftcircle.net/team
...
Tokenomics that rewards $CIRCLE Holders

We believe that a strong community should be rewarded, as such we dedicate 30% of ALL platform fees to Buyback & Burn. It not only incentivizes the community to hold $CIRCLE tokens, but also provides a way to stabilize the token price. 
*/
