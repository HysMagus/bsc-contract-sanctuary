...
MiniKishuForever | Fairlaunch 50-100 members joined

We are launching a strong memecoin called MiniKishuForever. Here is our Tokenomics : 
🏅 5% ETH Redistribution 
🚀 5% Marketing
🌊 5% Liquidity

https://t.me/MiniKishuForever
...
contract MKF is IBEP20, Auth {
    ...
    string constant _name = "MiniKishuForever";
    string constant _symbol = "MKF";
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xEe6DCdE67721984d1431cc14bFa84b3B80dE73FF;
    ...
    function setTxLimit(uint256 amount) external authorized {
        require(amount >= _totalSupply / 100000000000000);
        _maxTxAmount = amount;
    }
