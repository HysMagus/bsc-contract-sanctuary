...
// File: contracts/uniswapv2/interfaces/IThugswapBEP20.sol
...
// File: contracts/uniswapv2/interfaces/IThugswapPair.sol
...
contract ThugCollecter {
    ...
    IThugswapFactory public constant factory = IThugswapFactory(0xaC653cE27E04C6ac565FD87F18128aD33ca03Ba2);
    address public constant street = 0x571D0B55fe30eb1F6E68e8799F181c46De6B0059;
    address public constant thugs = 0xE10e9822A5de22F8761919310DDA35CD997d63c0;
    ...
    function _toWBNB(address token, uint amountIn) internal returns (uint256) {
        if (token == thugs) {
            _safeTransfer(token, street, amountIn);
            return 0;
        }
        if (token == wbnb) {
            _safeTransfer(token, factory.getPair(wbnb, thugs), amountIn);
            return amountIn;
        }
