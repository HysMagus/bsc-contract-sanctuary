...
contract HelmetTimelock is TokenTimelockUpgradeSafe {

    function __HelmetTimelock_init(IERC20 token, address beneficiary, uint256 releaseTime) public initializer {
        __TokenTimelock_init_unchained(token, beneficiary, releaseTime);
    }
