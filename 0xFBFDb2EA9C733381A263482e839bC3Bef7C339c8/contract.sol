...
contract Dao888Vault is Context, Ownable {
    ...
    constructor(
        ...
        _firstRewardPeriod = 63360; // around 11 days, could be changed by governance
        _secondRewardPeriod = 443520; // around 77 days, could be changed by governance
        ...
        _claimPeriodFor888Reward = 80640; // around 14 days, could be changed by governance
        _claimPeriodForSwapReward = 518400; // around 90 days, could be changed by governance
    ...
    function change888ETHPair(address dao888ETHPair) external onlyOwner {
    ...
    function swapAndLiquifyFor888(uint256 amount) private returns (bool) {
        ...
        uint256 otherHalfFor888 = amount.sub(halfForEth);
        ...
        emit SwapAndLiquifyFor888(_msgSender(), amount, halfForEth, newBalance);
