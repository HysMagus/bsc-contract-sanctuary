...
NOTES: 
 ,_, _ In order to "claim tokens" you must first add our token contract address "0x76beed9649c0c297cb6de10d07efd66db38e3c47"
[0,0] 
|)__)       
-”-”-

  ,_, _ Did you hear FREE Zina!
[0,0] 
|)__)       
-”-”- 1) Opposed to setting max number of airdrop winners I changed it to just give out the default airdrop reward to any
added address to the airdrop list. When the tokens run out then the contract will not honor any
airdrop awards but can still be run and tokens added to continue using the contract for other giveaways.


[0,0] 
|)__)       
-”-”- 2) Added functions to allow adding address(es) with a different token reward than the standard 5,000 for those cases 
...
contract AirDrop is AirDropWinners {
  using SafeMath for uint256;

  address initTokenContractAddress = 0x76BeeD9649c0C297cB6De10d07eFd66Db38e3C47;
