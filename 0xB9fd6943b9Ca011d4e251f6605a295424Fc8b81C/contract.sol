...
contract BugladyFinance is ERC20 {
    ...
    string public constant name = "BugladyFinance";
    ...
    constructor() public {
        uint256 companyFund = 35000e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 100 BNB or more and get 2% more BLF of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 100 BNB or more and get 1% more BLF of round 2
