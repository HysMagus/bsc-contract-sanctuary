...
//Just launched in $OnlyUpWHALE. We have created a token so rewarding for everyone.
//OnlyUpWHALE Hold we will Tothemoon
//Tg : t.me/OnlyUpWHALE
...
contract OnlyUpWHALE is Context, IERC20, Ownable {
    ...
    string private _name = "ONLYUP WHALE";
    string private _symbol = "OnlyUpWHALE";
