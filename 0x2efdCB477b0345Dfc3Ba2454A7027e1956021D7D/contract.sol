...
contract Endav_Public_Sale is Ownable {
    
  using SafeMath for uint256;
  IERC20 token;
  string public constant Info = "Set Gas Limits 200,000";
  uint256 public constant RATE = 975; //number of tokens per BNB
  uint256 public constant CAP = 3700;  //Number of BNB accepted until the sale ends
