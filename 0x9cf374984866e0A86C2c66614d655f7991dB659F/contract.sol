...
/**
 *             NEXT 1000X GEM!
 *                ANTHILL ANTS ARE EVERYWHERE
 * Dividend Token that reward $BUSD every 60 minutes!
 *      Fees on Buy&Sell: 15%
 *
 * OUR GOAL - LISTING CMC- TRUST THE DEV
 *
 *
 *
*/
...
contract ANTHILL is IBEP20, Auth {

    using SafeMath for uint256;

    string constant _name = "ANTHILL";
    string constant _symbol = "ANTS";
    ...
    constructor () Auth(msg.sender) {
        ...
        // NICE!
        autoLiquidityReceiver = 0x46297d0687A851D479f80e63A0EbD59D6442c3d6;
        marketingWallet = 0x46297d0687A851D479f80e63A0EbD59D6442c3d6;  // marketingwallet
