...
contract SnorlaxFinance is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 1000 * 10 ** uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'Snorlax Finance';
