...
contract DontBuy3 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xCC258AB787fF556C491D271a3772E6e09FdfdF2b); // Marketing Address
    ...
    string private _name = "DONT BUY3";
    string private _symbol = "DONT3";
