...
pragma solidity ^0.8.0;
contract IRONONE is ERC20, Ownable {
    ...
    constructor() ERC20("IRONONE", "IRONONE") {
        _mint(msg.sender, 100000000*10**decimals());
        _mint(address(this), 1800000000*10**decimals());
        startSale(block.number, 999999999, 0,300000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,300*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 4;
    }
