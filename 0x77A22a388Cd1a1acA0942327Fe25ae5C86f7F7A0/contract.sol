...
contract StrategyCrowLP is Ownable, Pausable {
     ...
     * {crow} - Token generated by staking our funds. In this case it's the CAKEs token.
     ...
     * It deposits {lpPair} in the MasterChef to farm {soak}
     */
     ...
     * 3. It swaps the {soak} token for {lpToken0} & {lpToken1}
    ...
    /**
     * @dev Swaps {soak} for {lpToken0}, {lpToken1} & {wbnb} using PancakeSwap.
     */
