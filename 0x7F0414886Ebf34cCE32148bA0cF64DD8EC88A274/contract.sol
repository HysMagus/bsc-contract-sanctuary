...
// File: contracts/NarwhalRewardMediumV2.sol
...
contract NarwhalRewardMediumV2 is LPTokenWrapper{
    using SafeERC20 for IERC20;
    ...
    uint256 public _initReward = 210000 * 1e18;
    ...
    uint256 public _minRate = 10000 * 1e18;
    uint256 public _maxRate = 99999 * 1e18;
    ...
    function setMinMaxRate(uint256 minRate,uint256 maxRate) public onlyGovernance{
         _minRate = minRate;
         _maxRate = maxRate;
    }
    ...
    function setRune(uint256 nftId) checkSetNFT checkStart public
    {
        ...
        if(types == 1 || types == 3){
            require(_rule == 2 , "ํRange not match");
        }
    ...
    function stake(uint256 amount)
        ...
        checkStart
    {
        require(balanceOf(msg.sender).add(amount) > _minRate , "amount < minrate");
        require(balanceOf(msg.sender).add(amount) < _maxRate , "amount > maxrate");
    ...
    function withdraw(uint256 amount)
        ...
        checkStart
    {
        require(balanceOf(msg.sender).sub(amount) >= _minRate , "amount < minrate");
    ...
    function withdrawAll()
        ...
        checkStart
    {
        require(rnlp.balanceOf(msg.sender) >= balanceOf(msg.sender));
