...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    constructor() public {
        ...
        //AutoFarm address
        autoFarmAddress = 0x1Ce954DEbe4e1887999C072E7437c241d4038CC0;
        //AutoToken address
        AUTOAddress = 0xc875C3dA749faf27bf804E75aD4beEbdADdfd931;                                     

        isCAKEStaking = _isCAKEStaking;
        isAutoComp = true;
        //Pair address between two token
        wantAddress = 0xA527a61703D82139F8a06Bc30097cC9CAA2df5A6;       //WBNB-CAKE Pancake LPs
        ...
        if (isAutoComp) {
            ...
            farmContractAddress = 0x73feaa1eE314F8c655E354234017bE2193C9E24E;   //Pancake MasterChef
            pid = _pid;
            
            //Token to reward
            earnedAddress = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;

            uniRouterAddress = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;      //Panckae router
