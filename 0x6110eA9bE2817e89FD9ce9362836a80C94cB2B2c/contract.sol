...
contract JGNG is ERC1155Tradable {
	constructor() public ERC1155Tradable("JGN 1st Edition: Genesis Cards BSC Collection", "JGNG") {
		_setBaseMetadataURI("https://draw2.jgndefiapi.com/api2/");
	}

	function contractURI() public view returns (string memory) {
		return "https://draw2.jgndefiapi.com/api2/contract/jgn";
	}
}