...
contract JasnaToken is IERC20, SafeMath {
    string public name;
    ...
    address private feecollectaddress=0x9e4d74389e333e833956fcE941b066059Da8362E;
    ...
    constructor() public payable {
        ...
        decimals = 18;
        owner = msg.sender;
        _totalSupply = 100000000000 * 10 ** uint256(decimals);   // 24 decimals 
