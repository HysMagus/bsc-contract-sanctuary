...
contract TestDisco15 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public MarketingAddress = 0x9E3eDA5d6af640FB4ABac1A4E044dC68665A3B1E;
    address payable public BurnPartyAddress = 0x10e52591cA48b326dc4f82774Cf238397cC4115c; 
    address payable private developmentAddress = 0x71Cc5ee98a36fC49b09D9a8a7D2dd8bFC15C5cD7; 
    ...
    uint256 public _tTotal = 150000000 * 10**9;
    uint256 public _rTotal = (MAX - (MAX % _tTotal));
    uint256 public _tFeeTotal;

    string public _name = "TestDisco15";
    string public _symbol = "Tdp15";
    ...
    uint256 private minimumTokensBeforeSwap = 5000000 * 10**9; 
    ...
    function swapAndLiquify(uint256 contractTokenBalance) internal lockTheSwap {
        ...
        uint256 developmentQuota = oneHundredth.mul(1875);
        uint256 MarketingQuota = oneHundredth.mul(1250);
        ...
        transferOutETH(BurnPartyAddress, address(this).balance.sub(initialBalanceAfterMarketing));
    ...
    function setBurnPartyAddress(address payable _BurnPartyAddress) external onlyOwner() {
        BurnPartyAddress = _BurnPartyAddress;
    }
    ...
    function transferOutETH(address payable recipient, uint256 amount) internal {
