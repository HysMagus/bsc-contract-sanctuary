...
contract TEST is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 8 * 10**6 * 10**9;
    ...
    function test(uint256 tAmount) public {
    ...
    function _testFee(uint256 rFee, uint256 tFee) private {
