...
// File: contracts/JETFUEL/interfaces/jetfuel/IVenusStrategy.sol
...
// File: contracts/JETFUEL/vaults/JetfuelVenusVaultv2.sol
 ...
 */
contract JetfuelVenusVaultv2 is ERC20, Ownable {
    ...
    constructor(
        ...
        IERC20(xrp).safeApprove(unirouter, uint256(-1));
    ...
    function balance() public view returns (uint256) {
        return
            token.balanceOf(address(this)).add(
                IVenusStrategy(strategy).balanceOf()
            );
    }
    ...
    /**
     * @dev The entrypoint of BNB funds into the system. People deposit with this function
     * into the vault. BNB is swapped for Cake and then in charge of sending funds into the strategy.
     */
    ...
    /**
     * @dev Function to exit the system. The vault will withdraw the required tokens
     * from the strategy and swap for BNB and pay up the token holder. A proportional number of IOU
     * tokens are burned in the process.
     */
