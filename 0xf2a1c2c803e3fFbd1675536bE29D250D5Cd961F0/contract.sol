...
Completely unbottable, so no one ruins your fun. Socialism for whales, 
capitalism for normal folks like you. Automatic buybacks so we never dip longer than we need to. 
Communal buyback because you should tell us what you want to do. A marketing strategy 
literally never even attempted in the history of shitcoins.
...
contract AuntieTOKEN is Context, IERC20, Ownable {
    ...
    address private _charityWalletAddress = 0x417429ef44439425e025F4220c67b7e5237769FF;
    address private _devWalletAddress = 0xc81Badd7284e0F1c9DD14CAE40ddd1b40BE0B0DD;
    ...
    string private _name = "AuntieTOKEN";
    string private _symbol = "Auntie";
