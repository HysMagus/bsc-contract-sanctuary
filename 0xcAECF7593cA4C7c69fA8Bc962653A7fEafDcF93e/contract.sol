...
/// For more information about this token please visit https://FenixFinance.net
/// @author reedhong

contract FenixToken is ERC20, ERC20Detailed, Pausable, Ownable  {
     ...
     * CONSTRUCTOR
     *
     * @dev Initialize the Fenix Token
     */

    constructor () public ERC20Detailed("FENIX SWAP", "FXF", DECIMALS) {
        pause();
   ...
   function transfer(address _to, uint256 _value) public returns (bool)  {
    ...
    // people will transfer Fenix to contract, fix it
