...
contract BABYSOLADITY is Context, IERC20, Ownable {
    ...
    string private _name   = "BABYSOLADITY";
    string private _symbol = "BS";
    uint8 private _decimals = 9;
    
    uint256 public _holder       = 1;
    ...
    uint256 public _ecosystem   = 5;
    address public ecosystemwallet = 0xfe61bf91aE6fb1d394A622C34701797dF0D1398B;
    ...
    function addLiquidity(uint256 tokenAmount, uint256 ethAmount) private {
        ...
        uniswapV2Router.addLiquidityETH{value: ethAmount}(
            address(this),
            tokenAmount,
            0, // slippage tidak dapat dihindari
            0, // slippage tidak dapat dihindari
            owner(),
            block.timestamp
        );
