...
contract FomoChain is Context, IERC20, Ownable {
    ...
    address payable public marketingAddress = payable(0xe2675Ec7F8Fca7C72fa933Ff96580705051D4ee5); // Marketing Address
	...
	uint256 public BurnUpperLimit = 1 * 10**18;
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        uint256 tFee = calculateTreasuryFee(tAmount);
