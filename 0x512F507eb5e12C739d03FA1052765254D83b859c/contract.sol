...
contract Evolution is Ownable, ERC721Holder {
    ...
    mapping (address => uint) public depositBlock; // NFT deposited block
    ...
    function joinEvolution(uint amount) public {
        ...
        genx.transferFrom(msg.sender, address(this), amount * 1e18);
    ...
    function claimEvolution(uint eIndex) internal {
        ...
        if (win) {
            genx.safeTransfer(msg.sender, 75 * 1e18 * prices[nftTypId] / winChances[nftTypId]);
    ...
    function withdrawNFT() public {
        ...
        require(block.number > depositBlock[msg.sender] + 28800, "please wait 24 hours");
        ...
        uint amount = evolutions[eIndex][msg.sender];
        if (amount > 0) {
            genx.safeTransfer(msg.sender, amount * 1e18);
            evolutions[eIndex][msg.sender] = 0;
        }
