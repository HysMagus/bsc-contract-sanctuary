...
contract LBC is ERC20("LBC", "LBC"), Ownable {
    ...
    */
    ...
    // In some circumstance, we should not burn LBC on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
