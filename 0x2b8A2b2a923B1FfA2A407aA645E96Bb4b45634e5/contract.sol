...
PearSwap - 25,000 totalSupply
Symbol: PSWAP
Twitter: https://twitter.com/SwapPear
No Presale No Airdrop!
Website: PearSwap.finance
...
contract PearSwap is Context, IERC20, Ownable {
    ...
    uint256 private constant _tTotal = 25000 * 10**9;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;

    string private _name = 'PearSwap';
    string private _symbol = 'PSWAP';
