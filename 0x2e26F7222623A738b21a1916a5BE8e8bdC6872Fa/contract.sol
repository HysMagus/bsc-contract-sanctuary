...
contract FarOutCollection is ERC1155Tradable {
	constructor() public ERC1155Tradable("FarOutCollection", "FarOutCollection") {
		_setBaseMetadataURI("https://draw2.jgndefiapi.com/api7/");
	}

	function contractURI() public view returns (string memory) {
		return "https://draw2.jgndefiapi.com/api7/contract/jgn";
	}
}