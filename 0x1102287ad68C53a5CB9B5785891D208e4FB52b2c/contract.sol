...
// File: contracts\FerreroToken.sol
...
// File: contracts\FerreroMaster.sol
...
contract FerreroMaster is Ownable {
    ...
    function changeRewardParams(uint256 _FerreroPerBlock, uint256 _startBlock, uint256 _bonusEndBlock) public onlyOwner {
        FerreroPerBlock = _FerreroPerBlock;
        bonusEndBlock = _bonusEndBlock;
        startBlock = _startBlock;
    }
