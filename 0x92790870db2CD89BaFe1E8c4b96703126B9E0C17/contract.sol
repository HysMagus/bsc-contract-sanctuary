//telegram: https://t.me/newethtoken
//website: https://newethbsc.com/
//twitter: https://twitter.com/newethtoken
//SPDX-License-Identifier: MIT

pragma solidity ^0.8.6;

/**
 * Standard NewETH, stripped down to just add/sub/mul/div
 */
library NewETH {
    function add(uint256 a, uint256 b) internal pure returns (uint256) {
        uint256 c = a + b;
        require(c >= a, "NewETH: addition overflow");

        return c;
    }

    function sub(uint256 a, uint256 b) internal pure returns (uint256) {
        return sub(a, b, "NewETH: subtraction overflow");
    }
    ...
    function mul(uint256 a, uint256 b) internal pure returns (uint256) {
        ...
        uint256 c = a * b;
        require(c / a == b, "NewETH: multiplication overflow");

        return c;
    }

    function div(uint256 a, uint256 b) internal pure returns (uint256) {
        return div(a, b, "tokencoin: division by zero");
    }
    ...
    function div(
        ...
        uint256 c = a / b;
        // assert(a == b * c + a % b); // There is no case in which this doesn't hol
...
contract tokencoin is
    BASEToken("tokencoin", "NETH", 2100000 * (10**9), 9),
    SafeToken,
    LockToken
{
    using NewETH for uint256;
    ...
    constructor() {
        ...
        marketing = 0x67d47f39bd5269AB6Eb1F1AF7e031aaf8347D4ab;
