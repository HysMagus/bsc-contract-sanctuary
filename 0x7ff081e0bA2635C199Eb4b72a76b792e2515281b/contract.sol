...
contract Locker {
    ...
    address tokenAddress = 0x567e2B16f8Ef147ae62F5d958397eB08974680C1; // PancakeSwap Liquidity Provider (LP) token represents the bUNDB and BNB pairing
    ...
    //Control
    function getLockAmount() public returns (uint256) {
