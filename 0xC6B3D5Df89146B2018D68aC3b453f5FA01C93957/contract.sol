...
contract GUDETAMA is Context, IERC20, Ownable {
    ...
    uint private startingSupply = 500_000_000; //500 Million, underscores aid readability
    ...
    string private _name = "Gudetama";
    string private _symbol = "#gudetama";
    
    uint256 public _reflectFee = 400; // All taxes are divided by 100 for more accuracy.
    uint256 private _previousReflectFee = _reflectFee;
    uint256 public _boostedReflectFee = 400;
    ...
    uint256 public _boostedMarketingFee = 300;
    ...
    address payable private _marketingWallet = payable(0xF5a05D0cEF4E690E2B74e04DDb6FC6c61C41E3E1);
    address payable private _devWallet = payable(0xaD02947Ed6a4320A761DFB6668630acC1Ab7D0eb);
    ...
    constructor () {
        ...
        _isExcludedFromFee[0xD4f69312f1aCf7BD0B1Fffbcb3d38A4Fdec3aB6C] = true;
        _isExcluded[0xD4f69312f1aCf7BD0B1Fffbcb3d38A4Fdec3aB6C] = true;
        _excluded.push(0xD4f69312f1aCf7BD0B1Fffbcb3d38A4Fdec3aB6C);
