...
contract rgftoken is Context, IERC20, Ownable {
	...
	string private _name = "Retro Games Token";
	string private _symbol = "$RGF";

// >> Symbols after dot (.) in token:
	uint8 private _decimals = 9;

// >> Redistribution fee of any transaction: 4%
	uint256 public _taxFee = 4;
	uint256 private _previousTaxFee = _taxFee;

// >> Liquidity fee of any transaction: 4%
