...
* Stealth launching anytime soon
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BUSD = IBEP20 (0x3EE2200Efb3400fAbB9AacF31297cBdD1d435D47);
...
contract BabyFomo is IBEP20, Auth {
    ...
    string constant _symbol = "BabyFomo";
    uint8 constant _decimals = 4;

    uint256 _totalSupply =  100000000000 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply / 25; // 4%
    ...
    address public marketingFeeReceiver = 0x48275Fe5e4a04b244078Dc14ec7c6e0485172F84;
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x89da039f7C3a5A2209C686e852492187f06f1828;
