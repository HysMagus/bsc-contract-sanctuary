...
contract TimelockController is AccessControl {
    ...
    uint256 public minDelay = 40; // seconds - to be increased after final production testing
    uint256 public minDelayReduced = 20; // seconds - to be increased after final production testing
