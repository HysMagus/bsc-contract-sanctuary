...
contract StratX2 is Ownable, ReentrancyGuard, Pausable {
    ...
    constructor(
        address[] memory _addresses, //_gov_autofarm_AUTO_want_token0_token1_earned_uniRouter_farmContract_buyback_rewards,
        uint256 _pid,
        bool _isCAKEStaking,
        bool _isAutoComp,
        ...
        autoFarmAddress = _addresses[1];
        AUTOAddress = _addresses[2];
