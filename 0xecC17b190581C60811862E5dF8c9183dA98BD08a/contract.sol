...
contract ShareRewardPool {
    ...
    constructor(address _mds, uint256 _startBlock) public {
    ...
    function add(
        ...
        poolInfo.push(PoolInfo({lpToken: _lpToken, allocPoint: _allocPoint, lastRewardBlock: _lastRewardBlock, accMdsPerShare: 0, isStarted: _isStarted}));
        if (_isStarted) {
