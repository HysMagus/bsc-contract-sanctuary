...
contract RUGPULL is Context, IERC20, Ownable {
    ...
    uint256 private _tTotal = 25000000 * 10 ** uint256(_decimals);
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    uint256 private _tFeeTotal;
    uint256 private _tBurnTotal;

    string private constant _name = 'https://t.me/rugpullponzischeme';
    string private constant _symbol = 'PONZI';
    
    uint256 private _taxFee = 100;
    uint256 private _burnFee = 100;
    uint private _max_tx_size = 250000 * 10 ** uint256(_decimals);
