...
// File: contracts\KitKatToken.sol
...
// File: contracts\KitKatMaster.sol
...
contract KitKatMaster is Ownable {
    ...
    function changeRewardParams(uint256 _KitKatPerBlock, uint256 _startBlock, uint256 _bonusEndBlock) public onlyOwner {
        KitKatPerBlock = _KitKatPerBlock;
        bonusEndBlock = _bonusEndBlock;
        startBlock = _startBlock;
    }
