...
contract TrigFinance is Context, IERC20, Ownable {
    
    using SafeMath for uint256;
    using Address for address;
    
    string private _name = "TrigFinance";
    string private _symbol = "TRIG";
    uint8 private _decimals = 9;

    address payable public marketingWalletAddress = payable(0xc5C450deF0B2F8Ad17e5A3a70d54fc1b32eC87ec); // Marketing Address
    address payable public buyBackWalletAddress = payable(0xA99117f4E4b9879AE35371f0e93d7AB7Ce52a3f2); // buyback Address
