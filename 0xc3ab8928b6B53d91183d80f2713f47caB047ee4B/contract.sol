...
// File: contracts/BIFI/strategies/Kebab/StrategyKebabLP.sol
...
contract StrategyKebabLP is Ownable, Pausable {
    ...
    address constant public kebab = address(0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82);
    ...
    function chargeFees() internal {
        ...
        IPancakeRouter(unirouter).swapExactTokensForTokens(toWbnb, 0, kebabToWbnbRoute, address(this), now.add(600));
    ...
    function addLiquidity() internal {
        ...
        if (lpToken1 != kebab) {
            IPancakeRouter(unirouter).swapExactTokensForTokens(kebabHalf, 0, kebabToLp1Route, address(this), now.add(600));
        }
