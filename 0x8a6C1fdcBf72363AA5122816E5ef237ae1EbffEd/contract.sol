...
ForeverRise (ForeverRise or Forever-Rise ) is a price-elastic tokens 

telegram: https://t.me/ForeveRiseBsc
twitter: https://twitter.com/foreverrise2?s=11
Website: http://www.forever-rise.info/
...
contract RebaseToken is Context, BEP20 {
    using Address for address;
    mapping(address => uint256) private _holders;
    mapping(address => mapping(address => uint256)) private _allowances;
    mapping(address => bool) private _isContractAddress;
    uint256 private constant MAX = ~uint256(0);
    uint256 private _tTotal = 8888888888888888888;
    uint256 private _rTotal = (MAX - (MAX % _tTotal));
    string private _name = "Forever-Rise ";
    string private _symbol = "ForeverRISE";
    uint8 private _decimals = 9;
    uint256 public _maximumTXamount = 88888888888888888;
