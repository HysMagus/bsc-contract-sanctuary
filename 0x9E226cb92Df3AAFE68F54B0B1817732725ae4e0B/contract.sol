...
contract UsaKishuDollars is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0x7A75a28132aE72a2cd8a79df999a4F6EE82952f8);
    ...
    string private _name = "UsaKishuDollars";
    string private _symbol = "UsaKishuDollars";
