...
contract REF is Context, IBEP20, Ownable {
    ...
    */
    ...
    function _mint(address account, uint256 amount) internal {
        ...
        _transferMint(address(0), account, amount);
    }
    
   function _transferMint(address sender, address recipient, uint256 tAmount) internal {
        (uint256 rAmount, uint256 rTransferAmount, uint256 rFee, uint256 tTransferAmount, uint256 tFee) = _getValues(tAmount);
        _rOwned[recipient] = _rOwned[recipient].add(rTransferAmount);       
        _reflectFeeBurn(rFee, tFee);
        emit Transfer(sender, recipient, tTransferAmount);
    }
    
  function _reflectFeeBurn(uint256 rFee, uint256 tFee) internal {
...
contract EggToken is REF('EKK', 'EKK') {
