...
contract StrategyCFIBNBLP is Ownable, Pausable {
    ...
    address constant public cfi = address(0xc2e1acef50aE55661855E8dcB72adB182A3cC259); // CFI
    address constant public butter = address(0xCa3F508B8e4Dd382eE878A314789373D80A5190A); // BUTTER
    ...
    address constant public shareRewardPool = address(0x746274c5944008F96315D35e7381507b0C82A23C); // Shares BUTTER
    uint8 public poolId;
    ...
    constructor() public {
        ...
        poolId = 0;
        vault = address(0x0397117e28090394ed9F05B68d2089b685f7d3C0);
