...
$UGLYFLOKI RISE token is based on an Elon Musk tweet with incredible growth potential. UGLYLOKIRISE is a community driven token on Binance Smart Chain.

UglyFlokirise token holders are not only benefited through static rewards but also by the Buy-Back process of the contract. As part of Buy-Back process, contract takes care of buying back some of the tokens and burn them whenever a sell happens. In a nutshell, 98% of the time, you will not see 2 sell transactions at any time and there will never be three sell transactions continuously at any time. 

if you are the firt to ape in built this a telegram community on this userlink:@UglyFlokiRise 

Tokenomic
50% of total tokens will be burn7% will be used for marketing3% of total tokens will be stored in developmental wallet
40% will be used for pancakeswap

Token Distribution
Redistribution5%Auto Liquidity Pool3%Sell Fee
1%Marketing Fee2%
...
contract Honeycomb is Context, BEP20 {
    ...
    string private _name = "Ugly Floki Rise";
    string private _symbol = "UFLOKI";
    uint8 private _decimals = 9;
    uint256 public _maximumTXamount = 800000000000000000000;
