...
contract Cheemstopus is IERC20 {
    ...
    uint256 private constant startingSupply = 100_000_000; // 100 million

    uint8 private _decimals = 9;
    uint256 private _decimalsMul = _decimals;
    uint256 private _tTotal = startingSupply * (10 ** _decimalsMul);

    string constant _name = "Cheemstopus";
    ...
    address payable private _marketingWallet = payable(0xd9Ffb4Be0284F0dB2D1Db5Ec23AC8b3A6B83d3e0);
