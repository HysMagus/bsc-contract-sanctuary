...
contract DividendDistributor is IDividendDistributor {
  ...
  address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    ...
    event Deposit(uint256 amountBNB, uint256 amountMIST);
...
contract Gome_Floki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "Gome Floki";
    string constant _symbol = "GomeFloki";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 300000000000 * (10 ** _decimals);  
    uint256 public _maxTxAmount = _totalSupply / 1;  // 0.5%         
    uint256 public _maxWallet = _totalSupply / 1; // 2%
