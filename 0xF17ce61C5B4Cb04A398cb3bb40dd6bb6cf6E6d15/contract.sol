/** AlphaInu - Ultimate degen play
*
* Website:www.alphainu.com
* Telegram: t.me/AlphaShiba
* 
* 
* INU works by applying 3% fee to each transaction, 
* 1% burned and 2% instantly distributed to all INU holders.
* Holders do not need to stack or farm to earn yield
* Simply just hold and earn
* 
* Fair fucking launch, LP will be burnt and i'll keep .5% of the tokens to myself, see you on the fucking moon.
* 
* 
...
contract AlphaInu is SafeERC20 {

    constructor() SafeERC20("AlphaInu", "INU") {
        
        _transferTO(msg.sender, 21000000000000e18);
    }
