...
contract ExpRebaseNeg is Ownable {
    ...
    string public constant name = "ExpRebaseUpTest";
    string public constant symbol = "EXUP";
        ...
        returns (bool)
    {
        ...
        emit Transfer(msg.sender, to, value.sub(value.mul(rebaseDownAmount).div(10000)));
        ...
        returns (bool)
    {
        ...
        _gonBalances[to] = _gonBalances[to].add(gonValue);
        emit Transfer(from, to, value.sub(value.mul(rebaseDownAmount).div(10000)));
        //Reduce supply by 10% each time
        _rebase(now,_totalSupply.mul(rebaseDownAmount).div(10000));
        _syncPair();
        return true;
