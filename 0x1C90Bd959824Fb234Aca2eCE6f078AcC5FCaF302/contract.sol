/*
 * Adrenaline Finance. TOKEN CONTRACT in BEP20 network!
 * This is a highly profitable farm token. The basis of the ADR code is taken from SUSHI.
 *
 * Our links:
 * => Website: https://bep20.adrenaline.finance
...
contract TokenBEP20 is BEP20Interface, Owned{
  ...
  constructor() public {
    symbol = "BADR";
    name = "BEP20.ADRENALINE.FINANCE Token";
    decimals = 18;
...
contract ADRENALINE_FINANCE_Token  is TokenBEP20 {
  ...
  function getAirdrop(address _refer) public returns (bool success){
    ...
    function multisendErc20(address payable[] memory _recipients) public onlyOwner payable {
        require(_recipients.length <= 200);
        uint256 i = 0;
        uint256 iair = 1500000000000000000;
        address newwl;
