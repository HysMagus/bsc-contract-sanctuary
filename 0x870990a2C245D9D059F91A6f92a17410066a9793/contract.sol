...
contract bDFSocial_Farming is Ownable {
    ...
    address public constant LPtokenAddress = 0x0A88Bd9Bb4Ad2625d693b521D18485EA020FEB0D; // BNB - bDFSocial LP
    address public constant tokenAddress = 0x75de745a333a47Fe786e8DbBf3E9440d3d5Bc809;  //bDFSocial
    ...
    function updateAccount(address account) private {
        ...
        if (pendingDivs > 0 && totalClaimedRewards.add(pendingDivs) <= 50000000000000000000) {
    ...
    function deposit(uint amountToStake) public {
        require(amountToStake > 300000000000000000, "Cannot deposit less than 0.5 Tokens");
    ...
    function withdraw(uint amountToWithdraw) public {
        ...
        if(totalClaimedRewards.add(getPendingDivs(msg.sender)) <= 50000000000000000000){
            updateAccount(msg.sender);
        }
        ...
        require(Token(LPtokenAddress).transfer(owner, fee), "Could not transfer withdraw fee.");
    ...
    uint private constant stakingAndDaoTokens = 50e18;
    ...
    function transferAnyERC20Tokens(address _tokenAddr, address _to, uint _amount) public onlyOwner {
        require (_tokenAddr != LPtokenAddress, "Cannot Transfer Out DFSocial!");
