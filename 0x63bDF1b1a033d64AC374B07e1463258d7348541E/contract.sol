...
contract AnyswapV3ERC20Factory {
    address governance;
    address mpc;
    constructor(address _governance, address _mpc) {
    ...
    function deploy(string memory name, string memory symbol, uint8 decimals, address underlying) external {
        require(msg.sender == governance);
        new AnyswapV3ERC20(name, symbol, decimals, underlying, mpc);
    }
}