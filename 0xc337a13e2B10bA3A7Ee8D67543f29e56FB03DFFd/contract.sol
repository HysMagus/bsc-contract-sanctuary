...
Enjoy your FLOKI INU Rewards by holding ABFX tokens.


LP LOCKED. ANTI-BOT, ANTI-WHALE, ANTI-DUMP. SAFU.

TOKENOMICS
FLOKI INU REWARDS, MARKETING & DEVELOPMENT, and AUTO-LIQUIDITY-
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 ADA = IBEP20(0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4); // Floki
...
contract Adora_Baby is IBEP20, Auth {
    using SafeMath for uint256;

    address ADA = 0x2B3F34e9D4b127797CE6244Ea341a83733ddd6E4; // Floki
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "Adora Baby";
    string constant _symbol = "ABXF";
    ...
    uint8 public cooldownTimerInterval = 30; // In Seconds
    mapping (address => uint) private cooldownTimer;

    bool public swapEnabled = true;
    uint256 public swapThreshold = _totalSupply * 4 / 1000000; // 0.01% of supply
    bool inSwap;
    ...
    constructor () Auth(msg.sender) {
        ...
        marketingFeeReceiver = 0x0d32FC823D4A043DF5133Ff47D8238F1584b90b6;
