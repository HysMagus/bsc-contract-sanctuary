...
// ChickenEggFarm.fun \\    CHICKEN EGG FARM IDLE GAME V2

// NEW! 0% dev fee change!! :D 

// The contract without the "WithdrawnAdminMoney" function does not work, but I have lowered the% fee to 0%. I cannot have commission on this contract.

// 1º Idle Game 100% decentralized \\

// Referrals dropped to 5% to avoid abuse \\

contract ChickenEggFarmV2 {
    
    uint256 public CEO_FEE = 0;
