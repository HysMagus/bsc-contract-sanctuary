...
address public constant wantAddress = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82 ;
...
//------------== 
    ...
    address public constant receiveFee =
        address(0xA9B643B2fD2883AdEe7fdDE59bb477110328d224); //
        ...
        returns (uint256)
    {
        ...
        IERC20(wantAddress).safeTransfer(afiFarmAddress, _wantAmt.sub(withdrawalFee));
