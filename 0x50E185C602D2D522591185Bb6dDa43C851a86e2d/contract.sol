...
// NydroToken with Governance.
contract NydroToken is ERC20("NYDRO", "NYD"), Ownable {
    uint256 private _cap = 60000000e18;
    uint256 private _initial_supply = 15000000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "NYDRO::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "NYDRO::delegateBySig: invalid nonce");
        require(now <= expiry, "NYDRO::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "NYDRO::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "NYDRO::_writeCheckpoint: block number exceeds 32 bits");
    ...
    // In some circumstance, we should not burn NYDRO on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
