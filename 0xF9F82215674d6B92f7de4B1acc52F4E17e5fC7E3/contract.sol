...
contract Caboel is Pausable, ERC777 {
  using SafeMath for uint256;
  // Token constants

  // uint32 constant public decimals = 18;
  // string constant public name = "Caboel People";
  // string public symbol = "Caboel";
  uint256 constant public maxSupply = 6969690000000000000000000; // 
  uint256 constant public preAssigned = 4664690000000000000000000; // 
