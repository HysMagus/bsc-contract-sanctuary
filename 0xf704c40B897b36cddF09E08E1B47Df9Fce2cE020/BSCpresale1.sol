...
contract presale is Context, ReentrancyGuard {
    ...
    function buyTokens() public payable nonReentrant {
        ...
        require(msg.value <= 3 ether, "You sent more than 17.5 BNB");

        //EARTH: 2500 BNB presale cap
        require(ethSent < 25 ether, "Hard cap reached");
        require (msg.value.add(ethSent) <= 25 ether, "Hardcap reached");

        //EARTH: 50 BNB limit
        require(ethSpent[msg.sender].add(msg.value) <=3 ether, "You cannot buy more than 17.5 BNB");
