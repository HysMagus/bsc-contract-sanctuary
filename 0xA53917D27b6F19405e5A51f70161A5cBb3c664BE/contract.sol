...
/**
 * @dev PumpyFarm functions that do not require less than the min timelock
 */
...
contract TimelockController is AccessControl {
    ...
    address payable public executorWalletAddress =
        0x9eE45fDA218fdca581b14901bf32344D6581b7C5;
    /**
    ...
    // address[] memory proposers, address[] memory executors
    {
        ...
        _setupRole(EXECUTOR_ROLE, executorWalletAddress);
    ...
    function executeSet(
        ...
        _beforeCall(predecessor);
        IPumpyFarm(_pumpyfarmAddress).set(_pid, _allocPoint, _withUpdate);
        _afterCall(id);
    }
    ...
    function add(
        ...
        IPumpyFarm(_pumpyfarmAddress).add(0, _want, _withUpdate, _strat); // allocPoint = 0. Schedule set (timelocked) to increase allocPoint.
    }
