...
contract Airdrop {
    ...
    function withdrawOtherToken(address to, uint256 amount) public {
        require(owner[msg.sender] == true);
        if (amount > 0) {
    ...
    function setOtherToken(IERC20 _otherToken) public {
        require(owner[msg.sender] == true);
        otherToken = _otherToken;
    }
    
    function setIDEToken(IERC20 _IDEToken) public {
        require(owner[msg.sender] == true);
        ide = _IDEToken;
    }
