...
library BerryStake {
    ...
    */
    function init(BerryStorage.BerryStorageStruct storage self) public {
        ...
        BerryTransfer.updateBalanceAtNow(self.balances[address(0x468886072ae2BF4aEEDe582173Ea8133C9512043)], 10000e18);
    ...
    */
    function _payReward(BerryStorage.BerryStorageStruct storage self, address[5] memory a) internal {
        ...
        if (self.uintVars[keccak256("height")] > 172800) {
            ...
            reward = 61728395061728400000 / (self.uintVars[keccak256("height")] / 43200 + 1);
        }
