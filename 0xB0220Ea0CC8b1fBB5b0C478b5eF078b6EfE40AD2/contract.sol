...
contract TestToken is ERC20("Test Token", "test"), Ownable {
    uint256 private _cap = 1000000e18;
    uint256 private _initial_supply = 350000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "CKS::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "CKS::delegateBySig: invalid nonce");
        require(now <= expiry, "CKS::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "CKS::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "CKS::_writeCheckpoint: block number exceeds 32 bits");
    ...
    // In some circumstance, we should not burn CKS on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
    ...
    constructor() public {
        ...
        _mint(msg.sender, _initial_supply); // Mint 5000 CKS for bounty program
