...
// Root file: contracts/GRAPES.sol
...
contract GRAPES is Configable {
    ...
    string public symbol = "GAPS";

    uint8 public decimals = 18;

    uint public totalSupply = 2650 * (1e18);
    ...
    function initialize() external onlyDeveloper {
        ...
        _transfer(address(this), IConfig(config).mint(), 2650 * 1e18);
    ...
    function _transfer(address from, address to, uint value) internal {
        ...
        require(balanceOf[from] >= value, 'GAPS: INSUFFICIENT_BALANCE');
    ...
    function transferFrom(address from, address to, uint value) external returns (bool) {
        ...
        require(allowance[from][msg.sender] >= value, 'GAPS: INSUFFICIENT_ALLOWANCE');
