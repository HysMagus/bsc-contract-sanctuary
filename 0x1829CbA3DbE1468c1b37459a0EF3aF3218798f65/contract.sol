 ...
 */
contract Dao219Token is Context, IERC20, Ownable {
        ...
        returns (bool)
    {
        if (_checkWithoutFee()) {
            ...
            I219Vault(_vault).addTaxFee(taxAmount);
        }
    ...
    function transferFrom(
        ...
        if (_checkWithoutFee()) {
            ...
            I219Vault(_vault).addTaxFee(feeAmount);
        }
        _approve(
            sender,
            _msgSender(),
            ...
            if (
                ...
                if (_initialMaxTransfers != 0) {
                    require(
                        ...
                        "Can't transfer more than 2 219 for initial 50 times."
                    );
