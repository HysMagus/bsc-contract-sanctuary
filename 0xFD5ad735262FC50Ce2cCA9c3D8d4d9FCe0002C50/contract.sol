/**
Taurus is a 100% community-driven token. 
Taurus uses the most advanced marking technology, including anti-whale, anti-robot, anti-sniper and anti-dumping mechanisms to protect our safe supply.

Large-scale international project, Binance Chain Universe's major coin: [Taurus] Taurus is ready to open a public private sale! ! !
The original intention of TUS Taurus was very pure. It pays tribute to the well-known constellation [Taurus] who is hardworking, brave, firm-willed, and not afraid of difficulties, and strives to become a Taurus with a larger pattern than a golden dog.

The Taurus with a halo will become another legend on Binance Chain after Sagittarius.

Total circulation: 1 billion
🕳The black hole has been destroyed: 50%
Flow cell: 30%
️Community airdrop: 5%
🛒Private equity share: 15%
Liquidity lock
Anti-whale mechanics
🤖️Anti-scientist
   Dividend mechanism
15% is automatically deducted for each transaction 
(5% is automatically allocated to holders, 5% is added to the liquidity pool, 3% is automatically destroyed, and 2% is marketing)
*/
...
contract Taurus is Context, IERC20, Ownable {
    ...
    string private _name = "Taurus";
    string private _symbol = "TUS";
    ...
    uint256 public _MarketingFee = 2; //hardcoded and unchangeable 
    uint256 private _previousMarketingFee = _MarketingFee;
    
    uint256 public _maxTxAmount = 1000 * 10**6 * 10**9;
    uint256 private minimumTokensBeforeSwap = 1000 * 10**3 * 10**9; 
    
    address payable public marketingAddress = 0x2F3E167dA0BbB674D1e2002A38C7D1DfC8098B23; //Marketing
    ...
    function swapAndLiquify(uint256 contractTokenBalance) private lockTheSwap {
        ...
        TransferMarketingBNB(marketingAddress, marketingBalance);
    ...
    function setNumTokensSellToAddToLiquidity(uint256 _minimumTokensBeforeSwap) public {
