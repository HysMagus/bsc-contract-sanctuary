...
// MuffinToken with Governance.
contract MuffToken is BEP20("Muffin Finance", "MUFF"), Ownable {
    uint256 private _cap = 1000000e18;
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "MUFF::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "MUFF::delegateBySig: invalid nonce");
        require(now <= expiry, "MUFF::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "MUFF::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "MUFF::_writeCheckpoint: block number exceeds 32 bits");
    ...
    // In some circumstance, we should not burn MUFF on transfer, eg: Transfer from owner to distribute bounty, from depositing to swap for liquidity
