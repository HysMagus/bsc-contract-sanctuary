...
contract EthereumForeverDividendTracker is IDividendDistributor {
    ...
    IBEP20 Ethereum = IBEP20(0x1D2F0da169ceB9fC7B3144628dB156f3F6c60dBE);
    ...
    uint256 public minDistribution = 1; // minimum auto send  
    uint256 public minimumTokenBalanceForDividends = 1000000 * (10**9); // Must hold 1,000,000 token to receive Etheruem
...
contract ForeverSpaceXRP is Ownable, IBEP20, SafeToken, LockToken {
    using SafeMath for uint256;
    ...
    string _name = "ForeverSpaceXRP";
    string _symbol = "ForeverSpaceXRP";
    ...
    constructor() {
        ...
        ecosystemFeeReceiver = 0xeb745f8Ca9c5004cAce018E72dFE3cA8359489e5;
        buyBackFeeReceiver = 0xeb745f8Ca9c5004cAce018E72dFE3cA8359489e5;
