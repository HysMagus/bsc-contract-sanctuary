...
<Welcome to     Floki Frunkpuppy 

 FlokiFrunkpuppy is Comunity drive token, low-tax coin that is commemorating the historic event for ElonMusk & cryptocurrency.
...
contract FlokiFrunkpuppy is Context, IERC20, Ownable {
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            uint256 burnAmount = amount.mul(_ElonRewadrs).div(100);
