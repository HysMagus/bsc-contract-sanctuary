...
contract BerryMinter is Ownable {
    using SafeMath for uint256;
    ...
    function transferOwnerBerry(address newOwner) public onlyOwner {
        berry.transferOwnership(newOwner);
    }
    function recoverBerry(address tokenAddress) public onlyOwner {
