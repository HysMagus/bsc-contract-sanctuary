/**
    Name =  Floki FrunkPuppy
    Symbol = $Floki FrunkPuppy
    Total Supply = 10,000,000,000
    Decimal = 18
    2% of each transaction to the liquidity pool
    8% of each transaction to the dev wallet(in BNB)
 */
...
contract FrunkPuppy is Context, IBEP20, Ownable {
    ...
    string private _name     = "FrunkFloki";
    string private _symbol   = "FrunkFloki";
    uint8 private  _decimals = 18;
    
    uint256 public _taxFee       = 3; 
    uint256 public _liquidityFee = 10; 
    uint256 public _percentageOfLiquidityForDev = 80; 
