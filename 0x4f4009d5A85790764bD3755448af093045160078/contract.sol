...
contract FlokiFrunkPuppy is IBEP20, Auth {
    ...
    string constant _symbol = "FFPuppy";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**9 * (10 ** _decimals);
    uint256 public _maxTxAmount = _totalSupply * 1 / 10000;

    //max wallet holding of 1%
    uint256 public _maxWalletToken = ( _totalSupply * 3 ) / 10000;
