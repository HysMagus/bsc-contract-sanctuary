...
contract NanoDogeX is ERC20, Ownable {
    ...
    constructor() ERC20("NanoDogeX", "NDX") {
    	cakeDividendTracker = new CakeDividendTracker();


    	marketingWallet = 0xfa322099a1eB2Ff5813E3414A22dC0342e6c75dF;
    ...
    function tradeStart() external onlyOwner {
        ...
        maxSellTransactionAmount = 7500000 * (10**18);
        maxWalletToken = 20000000 * (10**18);
    }
    ...
    function updateCakeDividendTracker(address newAddress) external onlyOwner {
        require(newAddress != address(cakeDividendTracker), "NanoDogeX: The dividend tracker already has that address");

        CakeDividendTracker newCakeDividendTracker = CakeDividendTracker(payable(newAddress));

        require(newCakeDividendTracker.owner() == address(this), "NanoDogeX: The new dividend tracker must be owned by the NanoDogeX token contract");
...
contract CakeDividendTracker is DividendPayingToken, Ownable {
    ...
    constructor() DividendPayingToken("NanoDogeX_Dividend_Tracker", "NanoDogeX_Dividend_Tracker", 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82) {
    	claimWait = 1200;
    ...
    function withdrawDividend() pure public override {
        require(false, "NanoDogeX_Dividend_Tracker: withdrawDividend disabled. Use the 'claim' function on the main EtherBack contract.");
    }
    ...
    function updateClaimWait(uint256 newClaimWait) external onlyOwner {
        require(newClaimWait >= 1200 && newClaimWait <= 86400, "NanoDogeX_Dividend_Tracker: claimWait" );
