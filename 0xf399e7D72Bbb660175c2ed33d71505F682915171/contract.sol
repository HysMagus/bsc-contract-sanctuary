...
contract Hyra_Presale is Context, ReentrancyGuard {
    ...
    uint totalNumberForPresale = 19300; 
    uint maxEthHardCap = 380; 
    ...
    function buyTokens() public payable nonReentrant {
        ...
        require(msg.value >= 0.2 ether, "You sent less than 0.2 BNB");
        
        //HYRA: 10 BNB limit
        require(msg.value <= 10 ether, "You sent more than 10 BNB");

        //HYRA: 380 BNB presale cap
        require(ethSent < 380 ether, "Hard cap reached");
        require (msg.value.add(ethSent) <= 380 ether, "Hardcap reached");

        //HYRA: 10 BNB limit
        require(ethSpent[msg.sender].add(msg.value) <= 10 ether, "You cannot buy more than 10 BNB");
