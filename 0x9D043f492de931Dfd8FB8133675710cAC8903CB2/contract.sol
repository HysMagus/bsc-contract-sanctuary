...
// File: contracts/libs/ITokenConverter.sol
...
// File: contracts/HKSToken.sol

pragma solidity 0.6.12;


// HKSToken with Governance.
contract HKSToken is BEP20('HKSwap Token', 'HKS') {
    ...
    function burnFrom(address _account, uint256 _amount) public {
        require( _account != address(0), 'HKSToken: burn amount exceeds allowance');
        require( allowance(_account, _msgSender()) >= _amount, 'HKSToken: burn amount exceeds allowance');
    ...
    */
        ...
        external
    {
        ...
        require(signatory != address(0), "HKS::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "HKS::delegateBySig: invalid nonce");
        require(now <= expiry, "HKS::delegateBySig: signature expired");
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "HKS::getPriorVotes: not yet determined");
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying HKSs (not scaled);
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "HKS::_writeCheckpoint: block number exceeds 32 bits");
