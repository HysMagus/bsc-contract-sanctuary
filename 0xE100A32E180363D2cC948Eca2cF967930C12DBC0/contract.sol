...
contract Strategy is BaseStrategy {
    ...
    address internal AccToken       = 0x481AC3E7FB8169cE245c824c9Dba47258d0Cf2b8;
    IERC20 internal smokeToken      = IERC20(0x5239fE1A8c0b6ece6AD6009D15315e02B1E7c4Ea);
    IPancakeFarm public farmer      = IPancakeFarm(0xb4Fa8846ce2739CEB728D49282A24890057D7110);

    constructor(address _vault) public BaseStrategy(_vault) {
        require(address(want) == address(smokeToken),"wrong want token");
        smokeToken.safeApprove(address(farmer),type(uint256).max);
    }

    function name() external override view returns (string memory) {
        return "StrategySmokeStaking";
    }

    // returns balance of brew
    ...
    function pendingReward() public view returns (uint256) {
        return farmer.pendingSmoke(0,address(this));
    }

    function estimatedTotalAssets() public override view returns (uint256) {
        //Add the vault tokens + staked tokens from brew  contract
    ...
    function protectedTokens() internal override view returns (address[] memory) {
        ...
        protected[0] = AccToken; // Staked brew tokens from governance contract
        return protected;
    }
}