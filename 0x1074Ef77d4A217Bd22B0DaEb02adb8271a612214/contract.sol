/**
 *Submitted for verification at BscScan.com on 2020-12-09
*/
...
contract StableXMigrator is Ownable {
    address public chef;
    IStableXFactory public oldFactory;
    IStableXFactory public factory;
    uint256 public notBeforeBlock;
    uint256 public desiredLiquidity = uint256(-1);

    constructor(
        address _chef,
        IStableXFactory _oldFactory,
        IStableXFactory _factory,
    ...
    function migrate(IPancakePair orig) public returns (IStableXPair) {
        ...
        // This section checks if this pair exists in the new factory
        // We will create a new one from scratch if it doesn't exist, and we won't have pricing issues
        if (pair == IStableXPair(address(0))) {
            pair = IStableXPair(factory.createPair(token0, token1));
        }
        ...
        // This step clears out any excess tokens to the owner address (hardcoded for now)
