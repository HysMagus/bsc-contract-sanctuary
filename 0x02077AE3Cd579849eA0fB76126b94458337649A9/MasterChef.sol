...
contract MasterChefV2 is Ownable, ReentrancyGuard {
    ...
    function deposit(uint256 _pid, uint256 _amount) public nonReentrant { massUpdatePools();
        PoolInfo storage pool = poolInfo[_pid];
    ...
    function withdraw(uint256 _pid, uint256 _amount) public nonReentrant { massUpdatePools();
        PoolInfo storage pool = poolInfo[_pid];
        UserInfo storage user = userInfo[_pid][msg.sender];
    ...
    function safeEggTransfer(address _to, uint256 _amount) internal { massUpdatePools();
    ...
    function setFeeAddress(address _feeAddress) public { massUpdatePools();
