...
contract FarmingV0 is Ownable {
    ...
    function setTokenPerBlock(uint256 _tokenPerBlock) public onlyOwner {
        require(tokenPerBlock == 0, 'Farming: amount of tokens per block already set!');
    ...
    function withdrawRemaining() public onlyOwner {
        ...
        uint256 reservedAmount = closeBlock.sub(startBlock).mul(tokenPerBlock).sub(tokenClaimed);
