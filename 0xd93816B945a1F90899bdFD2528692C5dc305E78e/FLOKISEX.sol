...
import "./FLOKISEX-imports.sol";


/**
 * @dev If I did a good job you should not need to change anything apart from the values in the `Tokenomics`,
 * the actual name of the contract `FLOKISEX` at the very bottom **and** the `environment` into which
 * you are deploying the contract `FLOKISEX(Env.Testnet)` or `FLOKISEX(Env.MainnetV2)` etc.
 * 
...
abstract contract Tokenomics {
    ...
    string internal constant NAME = "FLOKISEX";
    string internal constant SYMBOL = "FLOKISEX";
     ...
     */
    address internal tipToTheDev =0x6D7FFEacEbAb45E6a6D3800256003f810dDe6a35;
...
contract FLOKISEX is SafeToken{
