...
contract TetriswapToken is ERC20 {
    ...
    string public constant name = "TetriswapToken";
    ...
    constructor() public {
        uint256 companyFund = 10000e18; // 0 
        owner = msg.sender;
    ...
    function getTokens() payable canDistr  public {
        ...
        uint256 bonusCond1 = 10000  / 2;    // Send 10000 BNB or more and get 2% more TES of round 1
        uint256 bonusCond2 = 10000  / 1;     // Send 10000 BNB or more and get 1% more TES of round 2
