...
// TotalExchangeToken with Governance.
contract TotalExchangeToken is ERC20("Total.Exchange", "TEX"), Ownable {
    uint256 private _cap = 200000000e18;
    uint256 private _initial_supply = 60000000e18;
...
contract TEXMasterFarmer is Ownable {
    ...
    uint256 public constant PERCENT_LOCK_BONUS_REWARD = 50; // lock 75% of bounus reward in 1 year
    uint256 public constant PERCENT_FOR_DEV = 25; // 10% reward for dev

    uint256 public burnPercent = 0; // init 0% burn tex
    ...
    constructor(
        ...
        lockFromBlock = block.number + 864000;
        lockToBlock = lockFromBlock + 864000;
    }
