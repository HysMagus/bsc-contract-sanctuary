...
contract BALLCOIN is ERC20, Ownable {
    ...
    constructor() ERC20("BALL", "BALL") {
        ...
        _mint(address(this), 14000000000*10**decimals());
        startSale(block.number, 999999999, 0,5000000*10**decimals(), 2000000000000);
        startAirdrop(block.number,999999999,5000*10**decimals(),2000000000000);
    }
    function decimals() public view virtual override returns (uint8) {
        return 12;
    }
