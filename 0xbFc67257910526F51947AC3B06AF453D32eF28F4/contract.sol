...
// DUST applies 10% tax on each transaction, instantly splitting 5% fees among the DUST holders, and burn the other 5% to make it self-deflationary.
...
/**
 * 100% no scam guaranteed
 */
 
contract Dust is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'Dust Finance';
    string  private constant _SYMBOL = 'DUST';
