...
/**
 * @title InfinityAndBeyond's Master
...
contract Master is Ownable {
    ...
    // Market oracle provides the ForeverINFB/USD exchange rate as an 18 decimal fixed point number.
    ...
    constructor(address _INFB) public {
    ...
    function rebase() public {
        ...
        uint256 supplyAfterRebase = INFB.rebase(epoch, supplyDelta);
    ...
    function getRebaseValues() public view returns (uint256, int256) {
        ...
        if (supplyDelta > 0 && INFB.totalSupply().add(uint256(supplyDelta)) > MAX_SUPPLY) {
            supplyDelta = (MAX_SUPPLY.sub(INFB.totalSupply())).toInt256Safe();
        }
        ...
        returns (int256)
    {
        ...
        return INFB.totalSupply().toInt256Safe()
