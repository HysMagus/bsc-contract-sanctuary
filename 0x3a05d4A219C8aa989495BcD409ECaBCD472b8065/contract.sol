...
New Binance Crunch V2.0 - Better Dividend + 3% BITCOIN, 3% ETH, 3% BNB

Total Tax: 14%
- 8% Reward Tax (3% BITCOIN, 3% ETH, 3% BNB)
- 3% Marketing
- 3% Liquidity

Telegam: t.me/NewBinanceCrunch
...
contract NewBinanceCrunch is Ownable, IBEP20 {
    ...
    string _name = "NewBinanceCrunch"; 
    string _symbol = "NewCrunch"; 
    ...
    NewBinanceCrunchDividendTracker public rewardTracker;
    ...
    constructor () {
        ...
        rewardTracker = new NewBinanceCrunchDividendTracker();
...
contract NewBinanceCrunchDividendTracker is IDividendDistributor {
    using SafeMath for uint256;
