...
FortInu   
Community Token
No Buy Back | 7% Liquidity | 5% Marketing
2% Max Tx | 4% Max Wallet
 
TG: https://t.me/fortinu
...
contract FortInu is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "FortInu";
    string constant _symbol = "FORT";
    ...
    uint256 liquidityFee = 700; // 700
    uint256 buybackFee = 0; // 0
    uint256 reflectionFee = 0; // 0
    uint256 marketingFee = 500; // 500
    uint256 totalFee = 1200; // 1200
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x0ce36e3E8b37f090f920cDE088EE139d0Fd74631;
