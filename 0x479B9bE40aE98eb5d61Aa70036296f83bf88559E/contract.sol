...
GucciFloki   
Community Token
No Buy Back | 8% Liquidity | 6% Marketing
2% Max Tx | 4% Max Wallet
 
TG: https://t.me/guccifloki
...
contract GucciFloki is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "GucciFloki";
    ...
    uint256 liquidityFee = 800; // 800
    uint256 buybackFee = 0; // 0
    uint256 reflectionFee = 0; // 0
    uint256 marketingFee = 600; // 600
    uint256 totalFee = 1400; // 1400
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0xc6F975cE940a02d5C1794d69Bc3ee6F4e05DDb9A;
