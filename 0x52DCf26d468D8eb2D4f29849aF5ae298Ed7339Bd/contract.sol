//DON"T BUY - TEST COIN LP Will be removed.
...
contract NoBuy is Context, IBEP20, Ownable {
    ...
    string  private constant _NAME = 'NoBuy';
    ...
    uint256 private _tTotal = 1000 * _DECIMALFACTOR;
    ...
    uint256 private constant    _BURN_FEE = 950;
    uint256 private constant _MAX_TX_SIZE = 1000 * _DECIMALFACTOR;
