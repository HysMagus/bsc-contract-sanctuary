...
// Degenerates with Governance.
contract Degenerates is ERC20, ERC20Burnable {
    constructor() public ERC20("NUM", "NUM") {
        // Mint the total supply of the token to the deployer of the contract
        _mint(msg.sender, 14400000000000000000000);
    }
    ...
    */
        ...
        internal
    {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying DEGENs (not scaled);
