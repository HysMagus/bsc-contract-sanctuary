...
contract DontBuy2 is Context, IERC20, Ownable {
    using SafeMath for uint256;
    using Address for address;
    
    address payable public marketingAddress = payable(0xD31b6B9aFe0F58C975357b89c11A0DeB81e6cA66); // Marketing Address
    ...
    string private _name = "DONT BUY2";
    string private _symbol = "DONT2";
