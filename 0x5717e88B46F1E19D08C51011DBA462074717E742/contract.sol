...
/*
🍐 SHIBADRINK One of the first unique rebase contracts with only 10% tax
. 3% goes straight to liquidity for a healthy liquidity pool, 4% goes to marketing,
2% buyback and 1 goes to ecosystem development.🍐

🌎Website   https://SHIBADRINK.CC
🐦Twitter      https://twitter.com/SHIBADRINK
 💌 Telegram     :https://t.me/SHIBADRINK
▶️ Youtube https://www.youtube.com/SHIBADRINK
 🔥WHITEPAPER🔥     https://SHIBADRINK.CC/SHIBADRINK.pdf 
...
contract SHIBADRINK is IBEP20 {
    ...
    string public override name = "SHIBA DRINK";
    string public override symbol = "SHIBADRINK";
