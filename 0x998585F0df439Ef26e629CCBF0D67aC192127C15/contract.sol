...
contract StratX is Ownable, ReentrancyGuard, Pausable {
    ...
    bool public isAfiComp; // this vault is purely for staking. eg. WBNB-AFI staking vault.
    ...
    constructor(
        ...
        address _govAddress = 0x13A08dDcD940b8602f147FF228f4c08720456aA3;
        address _afiFarmAddress = 0x94Ed0cd7A6458229b087C4CA0D76cDCAA495Be1B;
        address _AFIAddress = 0x6C77dF12c39CAE90C4c46E5C19177679b7235CFa;
        address _farmContractAddress = 0x73feaa1eE314F8c655E354234017bE2193C9E24E;
        address _wantAddress = 0xA527a61703D82139F8a06Bc30097cC9CAA2df5A6;//WBNB-CAKE LP
        ...
        uint256 _pid = 10;
        address _earnedAddress = 0x0E09FaBB73Bd3Ade0a17ECC321fD13a19e81cE82;
        address _uniRouterAddress = 0x05fF2B0DB69458A0750badebc4f9e13aDd608C7F;
        bool _isCAKEStaking= false;
        bool _isAfiComp =false;
        
        govAddress = _govAddress;
        afiFarmAddress = _afiFarmAddress;
        AFIAddress = _AFIAddress;
        isCAKEStaking = _isCAKEStaking;
        isAfiComp = _isAfiComp;
