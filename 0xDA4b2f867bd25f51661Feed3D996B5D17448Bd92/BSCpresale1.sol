...
contract presale is Context, ReentrancyGuard {
    ...
    uint totalNumberForPresale = 2500; 
    uint maxEthHardCap = 175; 
    ...
    function buyTokens() public payable nonReentrant {
        ...
        // like 
        //require (ethSpent[msg.sender] <= 5 ether);
        require(msg.value >= 0.1 ether, "You sent less than 1.75 BNB");
        
        //EARTH: 50 BNB limit
        //require(msg.value <= 50 ether, "You sent more than 50 BNB");
        require(msg.value <= 17.5 ether, "You sent more than 17.5 BNB");

        //EARTH: 2500 BNB presale cap
        require(ethSent < 175 ether, "Hard cap reached");
        require (msg.value.add(ethSent) <= 175 ether, "Hardcap reached");
