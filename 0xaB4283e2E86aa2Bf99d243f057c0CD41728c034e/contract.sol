...
contract DividendSafeHaven is IDividendSafeHaven {
    ...
    uint256 public minPeriod = 720 minutes; // min 12 hours delay
    uint256 public minDistribution = 30 / 1000000 * (10 ** 18); // 1 USD of BETH minimum auto send
...
contract HAVEN is IBEP20, HAVENAuth {
    using SafeMath for uint256;
    ...
    string constant _name = "Haven SafeHaven DeFi";
    string constant _symbol = "HAVEN";
    uint8 constant _decimals = 9;

    uint256 _totalSupply = 21 * 10 ** 6 * (10 ** _decimals); // 21 million
