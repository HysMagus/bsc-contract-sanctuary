...
/*
    Copyright 2019 dYdX Trading Inc.
    Copyright 2020 DSDProtocol Devs 
...
library Constants {
    ...
    /* DAO */
    uint256 private constant ADVANCE_INCENTIVE_BELOW_ONE_DOLLAR = 100e18; // 100 DSD for reward if price <=1 BUSD
    uint256 private constant ADVANCE_INCENTIVE_ABOVE_ONE_DOLLAR = 100e6; // 100 BUSD convert from DSD price for reward
    ...
    /* Assets */
    address private constant TREASURY_ADDRESS = address(0xC5e537f2902FdE89e62f31377398FE4F1EAe61a6);
