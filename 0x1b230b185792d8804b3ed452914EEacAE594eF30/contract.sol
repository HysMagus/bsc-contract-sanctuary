...
//  with Governance.
contract SOAP is BEP20('Soap Token', 'SOAP') {
    ...
    */
        ...
        external
    {
        ...
        address signatory = ecrecover(digest, v, r, s);
        require(signatory != address(0), "SOAP::delegateBySig: invalid signature");
        require(nonce == nonces[signatory]++, "SOAP::delegateBySig: invalid nonce");
        require(now <= expiry, "SOAP::delegateBySig: signature expired");
        return _delegate(signatory, delegatee);
    }
    ...
    function getPriorVotes(address account, uint blockNumber)
        ...
        returns (uint256)
    {
        require(blockNumber < block.number, "SOAP::getPriorVotes: not yet determined");
    ...
    function _writeCheckpoint(
        ...
        internal
    {
        uint32 blockNumber = safe32(block.number, "SOAP::_writeCheckpoint: block number exceeds 32 bits");
