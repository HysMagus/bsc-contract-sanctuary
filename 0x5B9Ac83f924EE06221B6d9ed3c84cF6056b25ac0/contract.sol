/**
 *TG: https://t.me/DiamondDickedDegen69
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 MATIC = IBEP20(0x0Eb3a705fc54725037CC9e008bDede697f62F335); //the reward token you want distributed 
...
contract DiamondDickedDegen is IBEP20, Auth {
    using SafeMath for uint256;

    address MATIC = 0x95637d4FbE7153dCc3E26E71bdE7a2D82621F083; //Input the token address of whatever your reward is. leave 431,432,433 as is. 
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c; 
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "DiamondDickedDegen";    //name of your token here. 436 is symbol, leave decimals as is. if you want to change decimals, then you need to make sure the math works out with the rest of the code since everywhere else the code is written with assumption of 4 decimals
    string constant _symbol = "DDD";
