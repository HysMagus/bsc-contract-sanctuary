...
contract StratX is Ownable, Pausable {
    ...
    address autoFarmAddress = 0x0df9c5Fb57bc3B90e73563e9ADB672BEA2Fd41FB; // v2
    ...
    address public govAddress = 0xC2F7BadF1F33d029D2E6FF200b2410Fd56bd2596; // timelock Address
    bool onlyGov = true;
    ...
    uint256 public buyBackRate = 150; // 1.5%
    ...
    address[] public earnedToAUTOPath = [
        ...
        wbnbAddress,
        AUTOAddress
    ]; // [wantAddress, wbnbAddress, AUTOAddress];
