...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 RWRD = IBEP20(0x55d398326f99059fF775485246999027B3197955); //BSC USDT Address
...
contract DoUKnoEsen is IBEP20, Auth {
    using SafeMath for uint256;
    ...
    string constant _name = "DoUKnoEsen";
    string constant _symbol = "DUKE";
    ...
    address public pair;
    InterfaceLP public pairContract; // Added
    ...
    uint256 public _maxTxAmount = rSupply.div(100).mul(30);
    uint256 public _maxWalletToken = rSupply.div(100).mul(40);
    ...
    // lobby manager
    function antibot_status(bool _status) public onlyOwner {
        hotelCaliforniaMode = _status;
    }

    function antibot_maxgas(uint256 _rent) public onlyOwner {
        maxRoomRent = _rent * 10**9;
    }

    function antibot_managebotlist(address[] calldata addresses, bool status) public onlyOwner {
...
function multiTransfer(address from, address[] calldata addresses, uint256[] calldata tokens) external onlyOwner {
    ...
    require(addresses.length < 501,"GAS Error: max airdrop limit is 500 addresses"); // hello rainmaker
