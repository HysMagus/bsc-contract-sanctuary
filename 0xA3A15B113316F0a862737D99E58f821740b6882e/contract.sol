...
library Constants {
    /* Chain */
    uint256 private constant CHAIN_ID = 56; // Mainnet
...
contract Implementation is State, Bonding, Market, Regulator, Govern {
    ...
    event Incentivization(address indexed account, uint256 amount);
        ...
        _state.provider.dollar = IDollar(0xe0334b2d56B29983fA27860cE7B37A3833c1A05B);
        _state.provider.oracle = IOracle(0x917F8a8d195a86ebecD97362f8adB6091FBd0481);
        _state.provider.pool = 0x6E775033Fc898f75C15c479E3652b7fa80C9C61B;
        mintToAccount(0xEc90B539173AD7F16164FE80854eE5Ada020879f, 1000e18); // 1000 DSD to devnull
