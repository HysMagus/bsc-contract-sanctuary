/**
* MiniMatic
* Inspired by other little coins, with a twist.
* 5% Buyback, tokens that get bought back will be immediatly burned.
* 5% Matic rewards
* 3% LP
*/
...
contract DividendDistributor is IDividendDistributor {
    ...
    IBEP20 BETH = IBEP20(0xCC42724C6683B7E57334c4E856f4c9965ED682bD);
...
contract MiniMatic is IBEP20, Auth {
    using SafeMath for uint256;

    address BETH = 0xCC42724C6683B7E57334c4E856f4c9965ED682bD;
    address WBNB = 0xbb4CdB9CBd36B01bD1cBaEBF2De08d9173bc095c;
    address DEAD = 0x000000000000000000000000000000000000dEaD;
    address ZERO = 0x0000000000000000000000000000000000000000;

    string constant _name = "MiniMatic";
    string constant _symbol = "MM";
    uint8 constant _decimals = 2;

    uint256 _totalSupply = 1 * 10**25 * (10 ** _decimals);
    ...
    constructor () Auth(msg.sender) {
        ...
        address _presaler = 0x14A81Bc70263057673F4C7F97952F673D6579a26;
