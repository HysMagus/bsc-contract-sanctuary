...
contract BusdVaultTimely is Ownable {
    ...
    IPancakeRouter02 router = IPancakeRouter02(uniswapV2router);
    
    // trusted deposit token contract address
    address public constant trustedDepositTokenAddress = 0xe9e7CEA3DedcA5984780Bafc599bD69ADd087D56;
    // trusted reward token contract address
    address public constant trustedRewardTokenAddress = 0xA7877B1C6ec8De34707e5B947386cC094d7a0354;
    // reward rate
