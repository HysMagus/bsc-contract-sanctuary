...
contract HoneyBee is Context, IERC20, Ownable {
    ...
    string private constant _name = 'honey-bee.finance';
    string private constant _symbol = 'HoneyBee';
    
    uint256 private _taxFee = 180;
    uint256 private _burnFee = 180;
    uint private _max_tx_size = 350000 * 10 ** uint256(_decimals);
