...
// File: contracts/SousGenerator.sol
...
// SousGenerator is the robot of new tokens.
contract SousGenerator {
    using SafeMath for uint256;
    using SafeBEP20 for IBEP20;

    // Info of each user.
    struct UserInfo {
        uint256 amount;   // How many GENERATEENERGY tokens the user has provided.
        ...
        //
        // Whenever a user deposits or withdraws GENERATEENERGY tokens to a pool. Here's what happens:
    ...
    // Info of each user that stakes GenerateEnergy tokens.
    ...
    constructor(
        IBEP20 _generateEnergy,
        uint256 _rewardPerBlock,
        uint256 _startBlock,
        uint256 _endBlock
    ) public {
        syrup = _generateEnergy;
    ...
    // Deposit Generate tokens to SousGenerator for Reward allocation.
    ...
    // Withdraw GenerateEnergy tokens from SousGenerator.
