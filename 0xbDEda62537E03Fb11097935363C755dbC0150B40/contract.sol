...
contract TST is Context, IERC20, Ownable {
    ...
    address public Devaddress = 0xf3cb3550E14fFF78aD6C581035F781E06315C4bf;
    ...
    constructor () public 
      
      {
        ...
        _isExcludedFromFee[address(this)] = true;
         ...
         // exclude Dev from fee
        _isExcludedFromFee[Devaddress] = true;

        
        // exclude Dev from standard 4% reflection distribution reward
        _isExcluded[Devaddress] = true;
        _excluded.push(Devaddress);
    ...
    function _getTValues(uint256 tAmount) private view returns (uint256, uint256, uint256) {
        ...
        uint256 extrafee = tburnFee + tDevFee;
    ...
    function _getRValues(uint256 tAmount, uint256 tFee, uint256 tLiquidity, uint256 currentRate) private view returns (uint256, uint256, uint256) {
        ...
        uint256 rTransferAmount = rAmount.sub(rFee).sub(rLiquidity).sub(rburnfee).sub(rDevfee);
