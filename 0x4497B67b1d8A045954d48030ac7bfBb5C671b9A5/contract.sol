...
contract GoldYield is StakePool {
    ...
    constructor(address _depositToken, address _goldenToken, uint256 _totalreward, uint256 _starttime, uint256 _stakingtime) public {
        super.initialize(_depositToken);
        goldenToken = IERC20(_goldenToken);
    ...
    function getReward() public updateReward(msg.sender) checkhalve checkStart stakingTime{
        ...
        if (reward > 0) {
            ...
            goldenToken.safeTransfer(msg.sender, reward);
