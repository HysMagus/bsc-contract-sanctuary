...
contract BEP20 is Context, IBEP20, Ownable {
     ...
     */
     function burntBean() public view returns (uint256) {
       return _burntSupply;
     }
...
contract BeanToken is BEP20('Bean Token', 'BeanToken') {
    ...
    //@dev overrides transfer function to meet tokenomics of BEAN - burn rate + bean for hanger
    ...
    function _delegate(address delegator, address delegatee) internal {
        ...
        uint256 delegatorBalance = balanceOf(delegator); // balance of underlying BEAN (not scaled);
